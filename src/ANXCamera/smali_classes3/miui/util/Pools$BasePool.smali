...
.field private final JL:Lmiui/util/Pools$Manager;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private JN:Lmiui/util/Pools$IInstanceHolder;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lmiui/util/Pools$Manager;I)V
    ...
    iput-object v0, p0, Lmiui/util/Pools$BasePool;->zW:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lmiui/util/Pools$BasePool;->JL:Lmiui/util/Pools$Manager;

    iput p2, p0, Lmiui/util/Pools$BasePool;->Hr:I

    iget-object p1, p0, Lmiui/util/Pools$BasePool;->JL:Lmiui/util/Pools$Manager;
    ...
    iput-object p2, p0, Lmiui/util/Pools$BasePool;->JN:Lmiui/util/Pools$IInstanceHolder;
    ...
    :cond_31
    iget-object p1, p0, Lmiui/util/Pools$BasePool;->zW:Ljava/lang/Object;

    invoke-virtual {p1}, Ljava/lang/Object;->hashCode()I

    move-result p1

    iput p1, p0, Lmiui/util/Pools$BasePool;->Hr:I
...
.method public close()V
    ...
    iget-object v0, p0, Lmiui/util/Pools$BasePool;->JN:Lmiui/util/Pools$IInstanceHolder;

    if-eqz v0, :cond_e

    iget-object v0, p0, Lmiui/util/Pools$BasePool;->JN:Lmiui/util/Pools$IInstanceHolder;

    iget v1, p0, Lmiui/util/Pools$BasePool;->Hr:I

    invoke-virtual {p0, v0, v1}, Lmiui/util/Pools$BasePool;->a(Lmiui/util/Pools$IInstanceHolder;I)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmiui/util/Pools$BasePool;->JN:Lmiui/util/Pools$IInstanceHolder;
...
.method protected final doAcquire()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lmiui/util/Pools$BasePool;->JL:Lmiui/util/Pools$Manager;
    ...
    :cond_1d
    :goto_1d
    iget-object v1, p0, Lmiui/util/Pools$BasePool;->JL:Lmiui/util/Pools$Manager;
...
.method public getSize()I
    ...
    :cond_6
    iget v0, p0, Lmiui/util/Pools$BasePool;->Hr:I
