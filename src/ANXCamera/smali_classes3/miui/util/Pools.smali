...
# static fields
.field private static final JI:Ljava/util/HashMap;
...
.field private static final JJ:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/Class<",
...
.field private static final JK:Lmiui/util/Pools$Pool;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lmiui/util/Pools$Pool<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/Pools;->JI:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lmiui/util/Pools;->JJ:Ljava/util/HashMap;
    ...
    sput-object v0, Lmiui/util/Pools;->JK:Lmiui/util/Pools$Pool;
...
.method static a(Lmiui/util/Pools$InstanceHolder;I)V
    ...
    sget-object v0, Lmiui/util/Pools;->JI:Ljava/util/HashMap;
...
.method static a(Lmiui/util/Pools$SoftReferenceInstanceHolder;I)V
    ...
    sget-object v0, Lmiui/util/Pools;->JJ:Ljava/util/HashMap;
...
.method static b(Ljava/lang/Class;I)Lmiui/util/Pools$InstanceHolder;
    ...
    :try_start_3
    sget-object v1, Lmiui/util/Pools;->JI:Ljava/util/HashMap;
    ...
    sget-object p1, Lmiui/util/Pools;->JI:Ljava/util/HashMap;
...
.method static c(Ljava/lang/Class;I)Lmiui/util/Pools$SoftReferenceInstanceHolder;
    ...
    :try_start_3
    sget-object v1, Lmiui/util/Pools;->JJ:Ljava/util/HashMap;
    ...
    sget-object p1, Lmiui/util/Pools;->JJ:Ljava/util/HashMap;
...
.method public static getStringBuilderPool()Lmiui/util/Pools$Pool;
    ...
    sget-object v0, Lmiui/util/Pools;->JK:Lmiui/util/Pools$Pool;
