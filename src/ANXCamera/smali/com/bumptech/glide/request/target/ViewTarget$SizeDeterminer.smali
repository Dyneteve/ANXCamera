...
.field private qx:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field
...
.method constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->hx:Ljava/util/List;
...
.method private b(III)I
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->qw:Z
...
.method private r(II)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->hx:Ljava/util/List;
    ...
    invoke-interface {v1, p1, p2}, Lcom/bumptech/glide/request/target/m;->q(II)V
...
.method a(Lcom/bumptech/glide/request/target/m;)V
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->fe()I

    move-result v0

    invoke-direct {p0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->fd()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->hx:Ljava/util/List;
    ...
    :cond_1
    iget-object p1, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->qx:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->qx:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;

    iget-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->qx:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
...
.method fb()V
    ...
    :cond_1
    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->r(II)V

    invoke-virtual {p0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->fc()V
...
.method fc()V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->qx:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
