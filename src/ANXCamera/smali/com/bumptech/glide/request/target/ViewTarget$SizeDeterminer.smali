...
.field private pw:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field
...
.method constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->gx:Ljava/util/List;
...
.method private b(III)I
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->pv:Z
...
.method private q(II)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->gx:Ljava/util/List;
    ...
    invoke-interface {v1, p1, p2}, Lcom/bumptech/glide/request/target/m;->p(II)V
...
.method private r(II)Z
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->V(I)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->V(I)Z
...
.method a(Lcom/bumptech/glide/request/target/m;)V
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->eC()I

    move-result v0

    invoke-direct {p0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->eB()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->gx:Ljava/util/List;
    ...
    :cond_1
    iget-object p1, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->pw:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->pw:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;

    iget-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->pw:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
...
.method eA()V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->pw:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$a;
...
.method ez()V
    ...
    :cond_1
    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->q(II)V

    invoke-virtual {p0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->eA()V
