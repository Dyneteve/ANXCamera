...
# instance fields
.field private final la:Lcom/bumptech/glide/load/model/q;

.field private final lb:Lcom/bumptech/glide/load/model/o$a;
...
.method private constructor <init>(Lcom/bumptech/glide/load/model/q;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/model/o;->lb:Lcom/bumptech/glide/load/model/o$a;

    iput-object p1, p0, Lcom/bumptech/glide/load/model/o;->la:Lcom/bumptech/glide/load/model/q;
...
.method private d(Ljava/util/List;)V
    ...
    invoke-interface {v0}, Lcom/bumptech/glide/load/model/n;->cA()V
...
.method private j(Ljava/lang/Class;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/model/o;->lb:Lcom/bumptech/glide/load/model/o$a;

    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/model/o$a;->k(Ljava/lang/Class;)Ljava/util/List;

    move-result-object v0

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/bumptech/glide/load/model/o;->la:Lcom/bumptech/glide/load/model/q;

    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/model/q;->l(Ljava/lang/Class;)Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/model/o;->lb:Lcom/bumptech/glide/load/model/o$a;
...
.method public declared-synchronized a(Ljava/lang/Class;Ljava/lang/Class;)V
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/model/o;->lb:Lcom/bumptech/glide/load/model/o$a;
...
.method public declared-synchronized i(Ljava/lang/Class;)Ljava/util/List;
    .locals 1
    .param p1    # Ljava/lang/Class;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/model/q;->i(Ljava/lang/Class;)Ljava/util/List;
...
.method public declared-synchronized i(Ljava/lang/Object;)Ljava/util/List;
    .locals 6
    ...
    :try_start_0
    invoke-static {p1}, Lcom/bumptech/glide/load/model/o;->v(Ljava/lang/Object;)Ljava/lang/Class;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/bumptech/glide/load/model/o;->j(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-interface {v4, p1}, Lcom/bumptech/glide/load/model/m;->t(Ljava/lang/Object;)Z
