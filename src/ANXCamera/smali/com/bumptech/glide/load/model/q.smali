...
# static fields
.field private static final li:Lcom/bumptech/glide/load/model/q$c;

.field private static final lj:Lcom/bumptech/glide/load/model/m;
...
.field private final ll:Lcom/bumptech/glide/load/model/q$c;

.field private final lm:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/bumptech/glide/load/model/q$b<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/model/q;->li:Lcom/bumptech/glide/load/model/q$c;

    new-instance v0, Lcom/bumptech/glide/load/model/q$a;

    invoke-direct {v0}, Lcom/bumptech/glide/load/model/q$a;-><init>()V

    sput-object v0, Lcom/bumptech/glide/load/model/q;->lj:Lcom/bumptech/glide/load/model/m;
...
.method public constructor <init>(Landroid/support/v4/util/Pools$Pool;)V
    ...
    sget-object v0, Lcom/bumptech/glide/load/model/q;->li:Lcom/bumptech/glide/load/model/q$c;
...
.method constructor <init>(Landroid/support/v4/util/Pools$Pool;Lcom/bumptech/glide/load/model/q$c;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/model/q;->lk:Ljava/util/List;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/bumptech/glide/load/model/q;->lm:Ljava/util/Set;

    iput-object p1, p0, Lcom/bumptech/glide/load/model/q;->ct:Landroid/support/v4/util/Pools$Pool;

    iput-object p2, p0, Lcom/bumptech/glide/load/model/q;->ll:Lcom/bumptech/glide/load/model/q$c;
...
.method private a(Lcom/bumptech/glide/load/model/q$b;)Lcom/bumptech/glide/load/model/n;
    ...
    iget-object p1, p1, Lcom/bumptech/glide/load/model/q$b;->lo:Lcom/bumptech/glide/load/model/n;
...
.method private a(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/n;Z)V
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/model/q;->lk:Ljava/util/List;

    if-eqz p4, :cond_0

    iget-object p2, p0, Lcom/bumptech/glide/load/model/q;->lk:Ljava/util/List;
...
.method private static cL()Lcom/bumptech/glide/load/model/m;
    .locals 1
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
    ...
    sget-object v0, Lcom/bumptech/glide/load/model/q;->lj:Lcom/bumptech/glide/load/model/m;
...
.method public declared-synchronized b(Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/load/model/m;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/model/q;->lk:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/bumptech/glide/load/model/q;->lm:Ljava/util/Set;
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/model/q;->ll:Lcom/bumptech/glide/load/model/q$c;

    iget-object p2, p0, Lcom/bumptech/glide/load/model/q;->ct:Landroid/support/v4/util/Pools$Pool;
    ...
    :try_start_2
    invoke-static {}, Lcom/bumptech/glide/load/model/q;->cL()Lcom/bumptech/glide/load/model/m;
    ...
    :try_start_4
    iget-object p2, p0, Lcom/bumptech/glide/load/model/q;->lm:Ljava/util/Set;
...
.method declared-synchronized i(Ljava/lang/Class;)Ljava/util/List;
    .locals 4
    .param p1    # Ljava/lang/Class;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v2, p1}, Lcom/bumptech/glide/load/model/q$b;->m(Ljava/lang/Class;)Z
...
.method declared-synchronized l(Ljava/lang/Class;)Ljava/util/List;
    .locals 4
    .param p1    # Ljava/lang/Class;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/model/q;->lm:Ljava/util/Set;
    ...
    :try_start_1
    iget-object v0, p0, Lcom/bumptech/glide/load/model/q;->lm:Ljava/util/Set;
