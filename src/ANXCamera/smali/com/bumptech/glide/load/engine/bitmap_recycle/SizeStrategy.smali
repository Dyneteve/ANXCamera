...
# instance fields
.field private final iV:Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$KeyPool;

.field private final iW:Ljava/util/NavigableMap;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iV:Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$KeyPool;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->ii:Lcom/bumptech/glide/load/engine/bitmap_recycle/g;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iW:Ljava/util/NavigableMap;
...
.method private c(Ljava/lang/Integer;)V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iW:Ljava/util/NavigableMap;
    ...
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iW:Ljava/util/NavigableMap;
...
.method private static g(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->y(I)Ljava/lang/String;
...
.method public b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iV:Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$KeyPool;

    invoke-virtual {v1, v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$KeyPool;->z(I)Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$Key;

    move-result-object v1

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iW:Ljava/util/NavigableMap;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iV:Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$KeyPool;
    ...
    invoke-virtual {v0, v1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$KeyPool;->z(I)Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy$Key;

    move-result-object v1

    :cond_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->ii:Lcom/bumptech/glide/load/engine/bitmap_recycle/g;
...
.method public c(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->y(I)Ljava/lang/String;
...
.method public d(Landroid/graphics/Bitmap;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->ii:Lcom/bumptech/glide/load/engine/bitmap_recycle/g;
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeStrategy;->iW:Ljava/util/NavigableMap;
