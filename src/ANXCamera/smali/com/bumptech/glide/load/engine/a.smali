...
.method constructor <init>(Lcom/bumptech/glide/load/engine/e;Lcom/bumptech/glide/load/engine/d$a;)V
    ...
    invoke-virtual {p1}, Lcom/bumptech/glide/load/engine/e;->bg()Ljava/util/List;
...
.method constructor <init>(Ljava/util/List;Lcom/bumptech/glide/load/engine/e;Lcom/bumptech/glide/load/engine/d$a;)V
    ...
    iput v0, p0, Lcom/bumptech/glide/load/engine/a;->fJ:I

    iput-object p1, p0, Lcom/bumptech/glide/load/engine/a;->fG:Ljava/util/List;

    iput-object p2, p0, Lcom/bumptech/glide/load/engine/a;->fH:Lcom/bumptech/glide/load/engine/e;

    iput-object p3, p0, Lcom/bumptech/glide/load/engine/a;->fI:Lcom/bumptech/glide/load/engine/d$a;
...
.method private aT()Z
    ...
    iget v0, p0, Lcom/bumptech/glide/load/engine/a;->fM:I

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/a;->fL:Ljava/util/List;
...
.method public aS()Z
    ...
    :goto_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fL:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fN:Lcom/bumptech/glide/load/model/m$a;
    ...
    iget v3, p0, Lcom/bumptech/glide/load/engine/a;->fM:I

    add-int/lit8 v4, v3, 0x1

    iput v4, p0, Lcom/bumptech/glide/load/engine/a;->fM:I
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/a;->fO:Ljava/io/File;

    iget-object v4, p0, Lcom/bumptech/glide/load/engine/a;->fH:Lcom/bumptech/glide/load/engine/e;

    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/e;->getWidth()I

    move-result v4

    iget-object v5, p0, Lcom/bumptech/glide/load/engine/a;->fH:Lcom/bumptech/glide/load/engine/e;

    invoke-virtual {v5}, Lcom/bumptech/glide/load/engine/e;->getHeight()I

    move-result v5

    iget-object v6, p0, Lcom/bumptech/glide/load/engine/a;->fH:Lcom/bumptech/glide/load/engine/e;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fN:Lcom/bumptech/glide/load/model/m$a;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fH:Lcom/bumptech/glide/load/engine/e;

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/a;->fN:Lcom/bumptech/glide/load/model/m$a;
    ...
    invoke-virtual {v0, v3}, Lcom/bumptech/glide/load/engine/e;->d(Ljava/lang/Class;)Z
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/a;->fH:Lcom/bumptech/glide/load/engine/e;
    ...
    :cond_3
    :goto_2
    iget v0, p0, Lcom/bumptech/glide/load/engine/a;->fJ:I
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/a;->fG:Ljava/util/List;
    ...
    :cond_4
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fG:Ljava/util/List;

    iget v1, p0, Lcom/bumptech/glide/load/engine/a;->fJ:I
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/a;->fH:Lcom/bumptech/glide/load/engine/e;

    invoke-virtual {v3}, Lcom/bumptech/glide/load/engine/e;->ba()Lcom/bumptech/glide/load/c;
    ...
    iput-object v1, p0, Lcom/bumptech/glide/load/engine/a;->fO:Ljava/io/File;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/a;->fO:Ljava/io/File;

    if-eqz v1, :cond_5

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fK:Lcom/bumptech/glide/load/c;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fL:Ljava/util/List;

    iput v2, p0, Lcom/bumptech/glide/load/engine/a;->fM:I
...
.method public b(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/a;->fI:Lcom/bumptech/glide/load/engine/d$a;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/a;->fK:Lcom/bumptech/glide/load/c;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/a;->fN:Lcom/bumptech/glide/load/model/m$a;

    iget-object v2, v2, Lcom/bumptech/glide/load/model/m$a;->kZ:Lcom/bumptech/glide/load/a/d;

    sget-object v3, Lcom/bumptech/glide/load/DataSource;->ej:Lcom/bumptech/glide/load/DataSource;
...
.method public n(Ljava/lang/Object;)V
    ...
    sget-object v4, Lcom/bumptech/glide/load/DataSource;->ej:Lcom/bumptech/glide/load/DataSource;

    iget-object v5, p0, Lcom/bumptech/glide/load/engine/a;->fK:Lcom/bumptech/glide/load/c;
