...
# instance fields
.field private final iC:Lcom/bumptech/glide/load/engine/bitmap_recycle/k;
...
.field private final iF:Lcom/bumptech/glide/load/engine/bitmap_recycle/j$a;
...
.method public constructor <init>(J)V
    ...
    invoke-static {}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->bW()Lcom/bumptech/glide/load/engine/bitmap_recycle/k;

    move-result-object v0

    invoke-static {}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->bX()Ljava/util/Set;
...
.method constructor <init>(JLcom/bumptech/glide/load/engine/bitmap_recycle/k;Ljava/util/Set;)V
    ...
    iput-wide p1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iE:J

    iput-wide p1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->maxSize:J

    iput-object p3, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iC:Lcom/bumptech/glide/load/engine/bitmap_recycle/k;

    iput-object p4, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iD:Ljava/util/Set;
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iF:Lcom/bumptech/glide/load/engine/bitmap_recycle/j$a;
...
.method private declared-synchronized b(J)V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iC:Lcom/bumptech/glide/load/engine/bitmap_recycle/k;

    invoke-interface {v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->bM()Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->bV()V
    ...
    :cond_1
    :try_start_1
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iF:Lcom/bumptech/glide/load/engine/bitmap_recycle/j$a;
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iC:Lcom/bumptech/glide/load/engine/bitmap_recycle/k;
    ...
    iget v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iK:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iK:I
...
.method private bV()V
    ...
    iget v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iH:I
    ...
    iget v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iI:I
    ...
    iget v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iJ:I
    ...
    iget v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iK:I
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iC:Lcom/bumptech/glide/load/engine/bitmap_recycle/k;
...
.method private static bW()Lcom/bumptech/glide/load/engine/bitmap_recycle/k;
    .locals 2
...
.method private static bX()Ljava/util/Set;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
...
.method private declared-synchronized h(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    :cond_1
    iget v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iI:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iI:I

    goto :goto_1

    :cond_2
    iget v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iH:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iH:I
...
.method public declared-synchronized b(F)V
    ...
    :try_start_0
    iget-wide v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iE:J
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->bS()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized d(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iD:Ljava/util/Set;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iF:Lcom/bumptech/glide/load/engine/bitmap_recycle/j$a;
    ...
    iput v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iJ:I
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->iD:Ljava/util/Set;
