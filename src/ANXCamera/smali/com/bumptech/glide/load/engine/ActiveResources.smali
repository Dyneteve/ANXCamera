...
.field private fA:Ljava/lang/Thread;
...
.field private volatile fC:Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field
...
.field private fz:Ljava/lang/ref/ReferenceQueue;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
...
.method constructor <init>(Z)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->bF:Landroid/os/Handler;
    ...
    iput-boolean p1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->bE:Z
...
.method private aP()Ljava/lang/ref/ReferenceQueue;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fz:Ljava/lang/ref/ReferenceQueue;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fz:Ljava/lang/ref/ReferenceQueue;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fA:Ljava/lang/Thread;

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fA:Ljava/lang/Thread;
...
.method a(Lcom/bumptech/glide/load/c;Lcom/bumptech/glide/load/engine/k;)V
    ...
    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->bE:Z
...
.method a(Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;)V
    ...
    iget-boolean v0, p1, Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;->fE:Z

    if-eqz v0, :cond_1

    iget-object v0, p1, Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;->fF:Lcom/bumptech/glide/load/engine/p;
    ...
    iget-object v1, p1, Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;->fF:Lcom/bumptech/glide/load/engine/p;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fy:Lcom/bumptech/glide/load/engine/k$a;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fy:Lcom/bumptech/glide/load/engine/k$a;
...
.method a(Lcom/bumptech/glide/load/engine/k$a;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fy:Lcom/bumptech/glide/load/engine/k$a;
...
.method aQ()V
    ...
    :goto_0
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fB:Z
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->bF:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fC:Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;
...
.method setDequeuedResourceCallback(Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fC:Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;
...
.method shutdown()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->fB:Z
