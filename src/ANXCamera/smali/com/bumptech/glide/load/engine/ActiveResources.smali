...
.field private eA:Ljava/lang/Thread;
...
.field private volatile eC:Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field

.field private ey:Lcom/bumptech/glide/load/engine/k$a;

.field private ez:Ljava/lang/ref/ReferenceQueue;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
...
.method constructor <init>(Z)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->aF:Landroid/os/Handler;
    ...
    iput-boolean p1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->aE:Z
...
.method private ap()Ljava/lang/ref/ReferenceQueue;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->ez:Ljava/lang/ref/ReferenceQueue;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->ez:Ljava/lang/ref/ReferenceQueue;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->eA:Ljava/lang/Thread;

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->eA:Ljava/lang/Thread;
...
.method a(Lcom/bumptech/glide/load/c;Lcom/bumptech/glide/load/engine/k;)V
    ...
    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->aE:Z
...
.method a(Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;)V
    ...
    iget-boolean v0, p1, Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;->eE:Z

    if-eqz v0, :cond_1

    iget-object v0, p1, Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;->eF:Lcom/bumptech/glide/load/engine/p;
    ...
    iget-object v1, p1, Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;->eF:Lcom/bumptech/glide/load/engine/p;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->ey:Lcom/bumptech/glide/load/engine/k$a;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->ey:Lcom/bumptech/glide/load/engine/k$a;
...
.method a(Lcom/bumptech/glide/load/engine/k$a;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->ey:Lcom/bumptech/glide/load/engine/k$a;
...
.method aq()V
    ...
    :goto_0
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->eB:Z
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->aF:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->eC:Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;
...
.method setDequeuedResourceCallback(Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->eC:Lcom/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback;
...
.method shutdown()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/ActiveResources;->eB:Z
