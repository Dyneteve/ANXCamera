...
.field private final gP:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lcom/bumptech/glide/load/c;",
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/m;->gO:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/m;->gP:Ljava/util/Map;
...
.method private g(Z)Ljava/util/Map;
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/m;->gP:Ljava/util/Map;

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/m;->gO:Ljava/util/Map;
...
.method a(Lcom/bumptech/glide/load/c;Lcom/bumptech/glide/load/engine/EngineJob;)V
    ...
    invoke-virtual {p2}, Lcom/bumptech/glide/load/engine/EngineJob;->aY()Z
...
.method getAll()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/m;->gO:Ljava/util/Map;
