...
.field public static final lM:I = 0x6

.field private static final lN:Landroid/graphics/Paint;

.field private static final lO:I = 0x7

.field private static final lP:Landroid/graphics/Paint;

.field private static final lQ:Landroid/graphics/Paint;
...
.field private static final lS:Ljava/util/concurrent/locks/Lock;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->lR:Ljava/util/Set;

    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->lR:Ljava/util/Set;
    ...
    :goto_0
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->lS:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->lQ:Landroid/graphics/Paint;

    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->lQ:Landroid/graphics/Paint;
...
.method public static a(Lcom/bumptech/glide/load/engine/bitmap_recycle/d;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p2}, Lcom/bumptech/glide/load/resource/bitmap/w;->F(I)Z
...
.method private static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->lS:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lcom/bumptech/glide/load/resource/bitmap/w;->lN:Landroid/graphics/Paint;
    ...
    sget-object p0, Lcom/bumptech/glide/load/resource/bitmap/w;->lS:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lcom/bumptech/glide/load/resource/bitmap/w;->lS:Ljava/util/concurrent/locks/Lock;
...
.method public static b(Lcom/bumptech/glide/load/engine/bitmap_recycle/d;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    sget-object v4, Lcom/bumptech/glide/load/resource/bitmap/w;->lS:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p2, Lcom/bumptech/glide/load/resource/bitmap/w;->lS:Ljava/util/concurrent/locks/Lock;
...
.method public static d(Lcom/bumptech/glide/load/engine/bitmap_recycle/d;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    sget-object v2, Lcom/bumptech/glide/load/resource/bitmap/w;->lS:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object v3, Lcom/bumptech/glide/load/resource/bitmap/w;->lQ:Landroid/graphics/Paint;
