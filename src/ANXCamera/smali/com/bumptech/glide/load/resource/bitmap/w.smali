...
.field public static final mN:I = 0x6

.field private static final mO:Landroid/graphics/Paint;

.field private static final mP:I = 0x7

.field private static final mQ:Landroid/graphics/Paint;

.field private static final mR:Landroid/graphics/Paint;

.field private static final mS:Ljava/util/Set;
...
.field private static final mT:Ljava/util/concurrent/locks/Lock;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mO:Landroid/graphics/Paint;
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mQ:Landroid/graphics/Paint;
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mS:Ljava/util/Set;

    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mS:Ljava/util/Set;
    ...
    :goto_0
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mT:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mR:Landroid/graphics/Paint;

    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mR:Landroid/graphics/Paint;
...
.method private static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/w;->mT:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lcom/bumptech/glide/load/resource/bitmap/w;->mO:Landroid/graphics/Paint;
    ...
    sget-object p0, Lcom/bumptech/glide/load/resource/bitmap/w;->mT:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lcom/bumptech/glide/load/resource/bitmap/w;->mT:Ljava/util/concurrent/locks/Lock;
...
.method public static b(Lcom/bumptech/glide/load/engine/bitmap_recycle/d;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    sget-object v4, Lcom/bumptech/glide/load/resource/bitmap/w;->mT:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p2, Lcom/bumptech/glide/load/resource/bitmap/w;->mT:Ljava/util/concurrent/locks/Lock;
...
.method public static d(Lcom/bumptech/glide/load/engine/bitmap_recycle/d;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    sget-object v2, Lcom/bumptech/glide/load/resource/bitmap/w;->mT:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object v3, Lcom/bumptech/glide/load/resource/bitmap/w;->mQ:Landroid/graphics/Paint;

    invoke-virtual {v2, v1, v1, v1, v3}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    const/4 v1, 0x0

    sget-object v3, Lcom/bumptech/glide/load/resource/bitmap/w;->mR:Landroid/graphics/Paint;
...
.method public static dc()Ljava/util/concurrent/locks/Lock;
    .locals 1
