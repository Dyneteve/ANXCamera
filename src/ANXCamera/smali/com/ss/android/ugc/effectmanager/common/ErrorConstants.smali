...
.method public static APIErrorHandle(I)Ljava/lang/String;
    ...
    :pswitch_3
    const-string/jumbo p0, "\u6ca1\u6709\u672c\u5730 TAG \u7f13\u5b58"
    ...
    :pswitch_b
    const-string/jumbo p0, "\u9700\u8981\u66f4\u65b0app"

    goto :goto_0

    :pswitch_c
    const-string/jumbo p0, "\u4e0d\u5728\u767d\u540d\u5355"

    goto :goto_0

    :pswitch_d
    const-string/jumbo p0, "\u5f53\u524d\u7279\u6548id\u4e0d\u5b58\u5728"

    goto :goto_0

    :pswitch_e
    const-string/jumbo p0, "\u4e0d\u652f\u6301\u5f53\u524d\u8bbe\u5907"
    ...
    :pswitch_10
    const-string/jumbo p0, "\u5185\u5bb9\u6ca1\u6709\u53d1\u751f\u53d8\u5316"
    ...
    :pswitch_12
    const-string/jumbo p0, "\u5f53\u524d\u5e94\u7528\u4e0d\u662f\u6d4b\u8bd5\u5e94\u7528"
    ...
    :pswitch_1b
    const-string/jumbo p0, "\u53c2\u6570\u4e0d\u5408\u6cd5\uff08\u53c2\u6570\u7f3a\u5931\u6216\u8005\u9519\u8bef\uff09"

    goto :goto_0

    :cond_0
    const-string/jumbo p0, "\u65e0\u6548\u7684effect id"
