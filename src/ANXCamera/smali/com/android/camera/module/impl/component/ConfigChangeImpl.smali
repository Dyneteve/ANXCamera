...
.method private configMacroMode()V
    ...
    invoke-virtual {v3, v6}, Lcom/android/camera/data/data/global/DataItemGlobal;->setCurrentMode(I)V
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->hu()Z
    ...
    check-cast v6, Lcom/android/camera/protocol/ModeProtocol$OnOpticalZoomRatioChangeProtocol;
    ...
    invoke-interface {v6, v3}, Lcom/android/camera/protocol/ModeProtocol$OnOpticalZoomRatioChangeProtocol;->onOpticalZoomRatioUpdate(Z)V
    ...
    check-cast v3, Lcom/android/camera/protocol/ModeProtocol$StandaloneMacroProtocol;

    if-eqz v3, :cond_5

    invoke-interface {v3, v1}, Lcom/android/camera/protocol/ModeProtocol$StandaloneMacroProtocol;->onSwitchStandaloneMacro(Z)V
    ...
    invoke-interface {v1, v2}, Lcom/android/camera/protocol/ModeProtocol$UltraWideProtocol;->onSwitchUltraWide(Z)V
...
.method private configMoon(Z)V
    ...
    const-string v3, "(moon_mode) config moon:"
...
.method private configMoonNight()V
    ...
    const-string v2, "(moon_mode) config moon night"
...
.method public configLiveShotSwitch(I)V
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->gq()Z
...
.method public configRatio(Z)V
    ...
    invoke-virtual {p0, v0, v3}, Lcom/android/camera/module/impl/component/ConfigChangeImpl;->closeMutexElement(Ljava/lang/String;[I)V
    ...
    :cond_b
    invoke-virtual {v1, v4, v2}, Lcom/android/camera/data/data/config/ComponentConfigRatio;->setComponentValue(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v5}, Lcom/android/camera/module/loader/StartControl;->setViewConfigType(I)Lcom/android/camera/module/loader/StartControl;
    ...
    :goto_5
    invoke-virtual {v1, v5}, Lcom/android/camera/module/loader/StartControl;->setResetType(I)Lcom/android/camera/module/loader/StartControl;

    move-result-object p1

    invoke-virtual {p1, v6}, Lcom/android/camera/module/loader/StartControl;->setNeedReConfigureData(Z)Lcom/android/camera/module/loader/StartControl;
...
.method public showOrHideShine()V
    ...
    invoke-interface {v2}, Lcom/android/camera/protocol/ModeProtocol$BottomPopupTips;->directHideLyingDirectHint()V
