...
.method private filterSupportedSize4WideSelfie(Ljava/util/List;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v0, Lcom/android/camera/module/-$$Lambda$WideSelfieModule$0LvAwVrD9Fit3bOxPQNPpuUzaKU;->INSTANCE:Lcom/android/camera/module/-$$Lambda$WideSelfieModule$0LvAwVrD9Fit3bOxPQNPpuUzaKU;
...
.method static synthetic lambda$filterSupportedSize4WideSelfie$0(Lcom/android/camera/CameraSize;Lcom/android/camera/CameraSize;)I
    .locals 0
...
.method private onSaveFinish()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/module/WideSelfieModule;->enableCameraControls(Z)V

    iget-boolean v0, p0, Lcom/android/camera/module/WideSelfieModule;->mAeLockSupported:Z
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/android/camera/module/WideSelfieModule;->mAwbLockSupported:Z
    ...
    const-string v1, "onSaveFinish X"
...
.method private startSaveTask([BIII)V
    ...
    iget-object p4, p0, Lcom/android/camera/module/WideSelfieModule;->mDeviceLock:Ljava/lang/Object;
    ...
    iget-boolean p4, p0, Lcom/android/camera/module/WideSelfieModule;->mShowWarningToast:Z
    ...
    iget-object p1, p0, Lcom/android/camera/module/WideSelfieModule;->mFileNameTemplate:Ljava/lang/String;
    ...
    iget v7, p0, Lcom/android/camera/module/WideSelfieModule;->mTriggerMode:I

    iget-object v8, p0, Lcom/android/camera/module/WideSelfieModule;->mStopCaptureMode:Ljava/lang/String;

    new-instance v9, Lcom/android/camera/module/WideSelfieModule$4;

    invoke-direct {v9, p0}, Lcom/android/camera/module/WideSelfieModule$4;-><init>(Lcom/android/camera/module/WideSelfieModule;)V

    move-object v0, p1

    invoke-direct/range {v0 .. v9}, Lcom/android/camera/module/WideSelfieModule$SaveOutputImageTask;-><init>(Lcom/android/camera/Camera;Ljava/lang/String;[BIIIILjava/lang/String;Lcom/android/camera/module/WideSelfieModule$SaveStateCallback;)V
    ...
    iput-boolean p2, p0, Lcom/android/camera/module/WideSelfieModule;->mIsPrepareSaveTask:Z
...
.method private stopWideSelfieShooting(ZZLjava/lang/String;)V
    ...
    const-string p2, "stopWideSelfieShooting return, is not shooting"
    ...
    const-string v1, "stopWideSelfieShooting"
...
.method private updateBeauty()V
    ...
    iget v1, p0, Lcom/android/camera/module/WideSelfieModule;->mModuleIndex:I
...
.method private updatePictureAndPreviewSize()V
    ...
    sget-boolean v2, Lcom/mi/config/b;->sM:Z
    ...
    invoke-direct {p0, v0}, Lcom/android/camera/module/WideSelfieModule;->filterSupportedSize4WideSelfie(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera2/CameraCapabilities;->getSupportedOutputSize(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {v2, v3, v0, v4, v5}, Lcom/android/camera/Util;->getOptimalPreviewSize(IILjava/util/List;D)Lcom/android/camera/CameraSize;

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera/module/WideSelfieModule;->mPreviewSize:Lcom/android/camera/CameraSize;

    iput-object v1, p0, Lcom/android/camera/module/WideSelfieModule;->mPictureSize:Lcom/android/camera/CameraSize;
...
.method public varargs consumePreference([I)V
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/camera/module/WideSelfieModule;->updateModuleRelated()V
    ...
    :cond_3
    invoke-virtual {p0}, Lcom/android/camera/module/WideSelfieModule;->applyZoomRatio()V
...
.method public onBackPressed()Z
    ...
    const-string/jumbo v0, "\u6309\u4e0bHome/Back\u952e"
...
.method public onCreate(II)V
    ...
    iput-object p1, p0, Lcom/android/camera/module/WideSelfieModule;->mHandler:Landroid/os/Handler;
...
.method public onFaceDetected([Lcom/android/camera2/CameraHardwareFace;Lcom/android/camera/effect/FaceAnalyzeInfo;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/module/WideSelfieModule;->getDeviceBasedZoomRatio()F
...
.method public onMove(IILandroid/graphics/Point;Landroid/graphics/Point;Z)V
    ...
    :cond_1a
    :goto_c
    const-string/jumbo p1, "\u56fe\u50cf\u5145\u6ee1\u9884\u89c8\u6846"

    if-eqz v1, :cond_1b

    const-string/jumbo p1, "\u8d8a\u8fc7\u5de6\u53f3\u4e34\u754c\u503c"
...
.method public onOrientationChanged(III)V
    ...
    const-string/jumbo p3, "\u65cb\u8f6c\u89d2\u5ea6\u8d85\u8fc7\u4e34\u754c\u503c"
...
.method public onPreviewSessionFailed(Landroid/hardware/camera2/CameraCaptureSession;)V
    ...
    iget-object p1, p0, Lcom/android/camera/module/WideSelfieModule;->mHandler:Landroid/os/Handler;
...
.method public onPreviewUpdate([BIILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-object p2, p0, Lcom/android/camera/module/WideSelfieModule;->mHandler:Landroid/os/Handler;
...
.method public startWideSelfieShooting()V
    ...
    invoke-virtual {v4}, Lcom/android/camera/wideselfie/WideSelfieEngineWrapper;->startCapture()I
