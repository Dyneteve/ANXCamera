...
.field private static final MSG_DRAW_REQUESTED:I = 0x10
...
.method static synthetic access$100(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->doDraw()V
...
.method private doDraw()V
    ...
    invoke-direct {p0}, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->drawThumbnail()V
...
.method private doReset()V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mCurrentConfigPath:Ljava/lang/String;
...
.method private doUpdate()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->draw()V
...
.method private drawThumbnail()V
    ...
    iput-boolean v0, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mIsRendering:Z
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mContext:Landroid/content/Context;

    invoke-virtual {v2, v3, v1}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getSubConfigList(Landroid/content/Context;I)Ljava/util/ArrayList;

    move-result-object v2

    sget-object v3, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->TAG:Ljava/lang/String;
    ...
    check-cast v8, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;

    iget-object v8, v8, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->configTypeName:Ljava/lang/String;
    ...
    iget-object v6, v6, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->thumnails:Ljava/util/ArrayList;
    ...
    check-cast v8, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;

    invoke-static {}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getInstance()Lcom/android/camera/fragment/mimoji/AvatarEngineManager;

    move-result-object v9

    invoke-virtual {v9, v1}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getInterruptIndex(I)I
    ...
    sget-object v8, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->TAG:Ljava/lang/String;

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "continue index = "

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v9, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v11, ", getInterruptIndex = "
    ...
    invoke-virtual {v11, v1}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getInterruptIndex(I)I
    ...
    iget-object v8, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mUpdateHandler:Landroid/os/Handler;
    ...
    iget-object v9, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mUpdateHandler:Landroid/os/Handler;
    ...
    iget-object v9, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mAvatar:Lcom/arcsoft/avatar/AvatarEngine;

    invoke-virtual {v9, v8}, Lcom/arcsoft/avatar/AvatarEngine;->setConfig(Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;)I

    iget-object v9, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mConfigInfoThumUtils:Lcom/android/camera/fragment/mimoji/ConfigInfoThumUtils;

    iget-object v11, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mAvatar:Lcom/arcsoft/avatar/AvatarEngine;

    invoke-static {}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getInstance()Lcom/android/camera/fragment/mimoji/AvatarEngineManager;

    move-result-object v12

    invoke-virtual {v12}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getASAvatarConfigValue()Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigValue;

    move-result-object v12

    iget v12, v12, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigValue;->gender:I

    sget-object v13, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->BACKGROUND_COLOR:[F

    invoke-virtual {v9, v11, v8, v12, v13}, Lcom/android/camera/fragment/mimoji/ConfigInfoThumUtils;->renderThumb(Lcom/arcsoft/avatar/AvatarEngine;Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;I[F)V
    ...
    iget-boolean v9, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mStopRenderThumbnail:Z

    if-eqz v9, :cond_2

    iput-boolean v3, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mStopRenderThumbnail:Z

    iput-boolean v3, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mIsRendering:Z

    invoke-direct {p0, v6}, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->resetConfig(Ljava/util/ArrayList;)V

    invoke-static {}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getInstance()Lcom/android/camera/fragment/mimoji/AvatarEngineManager;

    move-result-object v2

    invoke-virtual {v2, v1, v0}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->setTypeNeedUpdate(IZ)V

    invoke-static {}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getInstance()Lcom/android/camera/fragment/mimoji/AvatarEngineManager;

    move-result-object v0

    invoke-virtual {v0, v1, v7}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->setInterruptIndex(II)V

    const/4 v0, 0x6

    iput v0, v8, Landroid/os/Message;->what:I

    iget-object v0, p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;->mUpdateHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v0, v1, v5}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->setInterruptIndex(II)V

    invoke-static {}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getInstance()Lcom/android/camera/fragment/mimoji/AvatarEngineManager;

    move-result-object v0

    invoke-virtual {v0, v1, v3}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->setTypeNeedUpdate(IZ)V
