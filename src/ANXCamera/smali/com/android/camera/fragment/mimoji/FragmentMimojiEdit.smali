...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$5;

    invoke-direct {v0, p0}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$5;-><init>(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)V
...
.method static synthetic access$1500(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)Landroid/support/v7/widget/RecyclerView;
    .locals 0
...
.method private goBack(ZZ)V
    ...
    new-instance p2, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$10;

    invoke-direct {p2, p0}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$10;-><init>(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)V

    invoke-virtual {p1, p2}, Lcom/android/camera/ui/MimojiEditGLTextureView;->queueEvent(Ljava/lang/Runnable;)V
...
.method private initConfigList()V
    ...
    new-instance v2, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$8;

    invoke-direct {v2, p0}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$8;-><init>(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)V
    ...
    invoke-direct {v0, v3}, Lcom/android/camera/fragment/mimoji/MimojiTypeAdapter;-><init>(Ljava/util/ArrayList;)V
    ...
    new-instance v3, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$9;

    invoke-direct {v3, p0}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$9;-><init>(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)V

    invoke-virtual {v0, v3}, Lcom/android/camera/fragment/mimoji/MimojiTypeAdapter;->setOnSelectListener(Lcom/android/camera/fragment/mimoji/MimojiTypeAdapter$OnSelectListener;)V
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->mMimojiTypeAdapter:Lcom/android/camera/fragment/mimoji/MimojiTypeAdapter;

    invoke-virtual {v0, v3}, Lcom/android/camera/ui/autoselectview/AutoSelectHorizontalView;->setAdapter(Landroid/support/v7/widget/RecyclerView$Adapter;)V
    ...
    check-cast v4, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;
    ...
    iget v6, v4, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;->configType:I
    ...
    iget-object v8, v4, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;->configTypeDesc:Ljava/lang/String;
    ...
    iget v8, v4, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;->configType:I
    ...
    iget v7, v4, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;->configType:I

    invoke-virtual {v6, v7, v5}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->putConfigList(ILjava/util/ArrayList;)V

    iget v5, v4, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;->configType:I
    ...
    invoke-virtual {v5, v2}, Lcom/android/camera/fragment/mimoji/MimojiTypeBean;->setAlpha(I)V

    invoke-virtual {v5, v4}, Lcom/android/camera/fragment/mimoji/MimojiTypeBean;->setASAvatarConfigType(Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/fragment/mimoji/MimojiTypeAdapter;->getDataList()Ljava/util/ArrayList;
    ...
    check-cast v4, Lcom/android/camera/fragment/mimoji/MimojiTypeBean;

    invoke-virtual {v4}, Lcom/android/camera/fragment/mimoji/MimojiTypeBean;->getAlpha()I

    move-result v5

    if-ne v5, v1, :cond_7

    invoke-virtual {v4, v2}, Lcom/android/camera/fragment/mimoji/MimojiTypeBean;->setAlpha(I)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/camera/fragment/mimoji/MimojiTypeAdapter;->setDataList(Ljava/util/ArrayList;)V
...
.method private initMimojiEdit(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera/ui/autoselectview/AutoSelectHorizontalView;->setItemViewCacheSize(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera/ui/autoselectview/AutoSelectHorizontalView;->setItemPageCount(I)V
...
.method private showAlertDialog(I)V
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$6;-><init>(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;I)V

    invoke-virtual {v0, v1, v2}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    const p1, 0x7f09035e

    new-instance v1, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$7;

    invoke-direct {v1, p0}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$7;-><init>(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-boolean p1, p0, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->mEnterFromMimoji:Z

    if-eqz p1, :cond_0

    const-string p1, "\u840c\u62cd\u7f16\u8f91\u518d\u6b21\u4fdd\u5b58"
    ...
    .sparse-switch
        ...
        0x7f0d00af -> :sswitch_2
        0x7f0d00b0 -> :sswitch_1
        0x7f0d00b6 -> :sswitch_0
