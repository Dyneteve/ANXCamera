...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->setInterruptIndex(II)V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$2;->this$0:Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;

    invoke-static {v1}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->access$400(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1, p1}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getSubConfigList(Landroid/content/Context;I)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->isNeedUpdate(I)Z

    move-result p1

    iget-object v1, p0, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$2;->this$0:Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;

    invoke-static {v1}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->access$300(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;

    move-result-object v1

    xor-int/lit8 v2, p1, 0x1

    invoke-virtual {v1, v0, v2}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->refreshData(Ljava/util/List;Z)V

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$2;->this$0:Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;

    invoke-static {p1}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->access$500(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit$2;->this$0:Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;

    invoke-static {v2}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->access$300(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;
    ...
    invoke-static {p1}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->access$100(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;)Lcom/arcsoft/avatar/AvatarEngine;
    ...
    invoke-virtual {v0, v3}, Lcom/arcsoft/avatar/AvatarEngine;->loadConfig(Ljava/lang/String;)V
    ...
    invoke-static {p1, v1, v0}, Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;->access$200(Lcom/android/camera/fragment/mimoji/FragmentMimojiEdit;ZZ)V
