...
.method private consumeResult(IZ)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/camera/ui/LightingView;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {p2, p1}, Lcom/android/camera/ui/LightingView;->post(Ljava/lang/Runnable;)Z
...
.method public static synthetic lambda$updateMimojiFaceDetectResultTip$0(Lcom/android/camera/fragment/FragmentMainContent;Z)V
    .locals 7
    ...
    :cond_2
    iget p1, p0, Lcom/android/camera/fragment/FragmentMainContent;->mMimojiFaceDetect:I

    invoke-static {p1}, Lcom/android/camera/fragment/mimoji/MimojiHelper;->getTipsResIdFace(I)I
    ...
    invoke-static {p1}, Lcom/android/camera/fragment/mimoji/MimojiHelper;->getTipsResId(I)I
    ...
    iget-boolean v2, p0, Lcom/android/camera/fragment/FragmentMainContent;->lastFaceSuccess:Z
    ...
    invoke-interface {v1, v2, v5, v6}, Lcom/android/camera/protocol/ModeProtocol$BottomPopupTips;->showTips(III)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/ui/LightingView;->triggerAnimateSuccess()V

    goto :goto_4

    :cond_8
    iget-boolean p1, p0, Lcom/android/camera/fragment/FragmentMainContent;->mMimojiLastFaceSuccess:Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/ui/LightingView;->triggerAnimateFocusing()V

    :goto_4
    iget-boolean p1, p0, Lcom/android/camera/fragment/FragmentMainContent;->lastFaceSuccess:Z
...
.method private mimojiFaceDetectSync(II)V
    .locals 3
    ...
    const-string v1, "mimojiFaceDetectSync Error 1, faceResult = "
    ...
    const-string v1, "mimojiFaceDetectSync, Error 2, faceResult = "
...
.method public directHideLyingDirectHint()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentMainContent;->mLyingDirectHint:Landroid/widget/TextView;
...
.method public provideAnimateElement(ILjava/util/List;I)V
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentMainContent;->isInModeChanging()Z
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/FragmentMainContent;->mLyingDirectHint:Landroid/widget/TextView;

    const/16 v4, 0x8

    invoke-virtual {v2, v4}, Landroid/widget/TextView;->setVisibility(I)V

    iput-boolean v3, p0, Lcom/android/camera/fragment/FragmentMainContent;->mIsShowMainLyingDirectHint:Z

    :cond_1
    invoke-virtual {p0, v3, p3}, Lcom/android/camera/fragment/FragmentMainContent;->setSnapNumVisible(ZZ)V
    ...
    invoke-virtual {v2}, Lcom/android/camera/ui/V6PreviewFrame;->hidePreviewGrid()V
...
.method public updateLyingDirectHint(ZZ)V
    ...
    invoke-static {p1}, Lcom/android/camera/statistic/CameraStatUtil;->trackLyingDirectShow(I)V
...
.method public updateMimojiFaceDetectResultTip(Z)V
    ...
    new-instance v1, Lcom/android/camera/fragment/-$$Lambda$FragmentMainContent$MunCOn-ykKm0Ze61N5Myi0fdjQA;

    invoke-direct {v1, p0, p1}, Lcom/android/camera/fragment/-$$Lambda$FragmentMainContent$MunCOn-ykKm0Ze61N5Myi0fdjQA;-><init>(Lcom/android/camera/fragment/FragmentMainContent;Z)V
