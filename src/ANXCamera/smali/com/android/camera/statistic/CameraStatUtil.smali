...
.method private static addUltraPixelParameter(ZLjava/util/Map;)V
    ...
    invoke-virtual {p0}, Lcom/mi/config/a;->gK()I
...
.method private static autoExposureToName(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "unexpected auto exposure "
...
.method public static cameraIdToName(Z)Ljava/lang/String;
    ...
    const-string/jumbo p0, "\u524d\u6444"

    goto :goto_0

    :cond_0
    const-string/jumbo p0, "\u540e\u6444"
...
.method public static slowMotionConfigToName(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo p0, "\u70b9\u51fb\u81f3240"

    return-object p0

    :cond_1
    const-string/jumbo p0, "\u70b9\u51fb\u81f3960"
...
.method public static trackConfigChange(Ljava/lang/String;Ljava/lang/String;ZZZ)V
    ...
    const-string/jumbo p4, "\u524d\u6444"

    goto :goto_0

    :cond_2
    const-string/jumbo p4, "\u540e\u6444"
...
.method public static trackDirectionChanged(I)V
    ...
    const-string/jumbo p0, "\u4ece\u5de6\u5f80\u53f3"

    goto :goto_0

    :cond_1
    const-string/jumbo p0, "\u4ece\u53f3\u5f80\u5de6"
...
.method public static trackFilterChanged(IIZ)V
    ...
    const-string/jumbo p0, "\u65b9\u5f0f"

    if-eqz p2, :cond_1

    const-string/jumbo p1, "\u70b9\u51fb"

    goto :goto_0

    :cond_1
    const-string/jumbo p1, "\u6ed1\u52a8"
...
.method public static trackGoogleLensPickerValue(Z)V
    ...
    const-string/jumbo v1, "\u957f\u6309\u9884\u89c8\u5f39\u7a97\u9009\u62e9"
...
.method public static trackLiveStickerMore(Z)V
    ...
    const-string/jumbo v1, "\u70b9\u51fb\u8df3\u8f6c"

    if-eqz p0, :cond_1

    const-string/jumbo p0, "\u5e94\u7528\u5546\u5e97"
...
.method public static trackLiveVideoParams(IFZZZ)V
    ...
    const-string/jumbo p0, "\u6296\u97f3\u89c6\u9891\u5f55\u5236\u65f6\u957f"
...
.method public static trackLostCount(I)V
    ...
    const-string/jumbo v1, "tracking_lost"
...
.method private static trackMacroModeTaken(I)V
    ...
    const-string/jumbo v3, "\u5bf9\u7126"

    invoke-interface {v1, v3, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    const-string/jumbo v0, "\u5fae\u8ddd\u6a21\u5f0f"
    ...
    :cond_2
    :pswitch_0
    const-string/jumbo v0, "video_taken"
...
.method public static trackMimojiCaptureOrRecord(Ljava/util/Map;Ljava/lang/String;ZZ)V
    ...
    const-string/jumbo p1, "\u524d\u540e\u6444"

    if-eqz p3, :cond_1

    const-string/jumbo p3, "\u524d\u6444"

    goto :goto_0

    :cond_1
    const-string/jumbo p3, "\u540e\u6444"
...
.method public static trackMimojiSavePara(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v0, p0, p1}, Lcom/android/camera/statistic/CameraStat;->recordCountEvent(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
...
.method public static trackMoonMode(ZZ)V
    ...
    const-string/jumbo v0, "\u6a21\u5f0f\u9009\u62e9"

    if-eqz p1, :cond_1

    const-string/jumbo p1, "\u6708\u4eae\u6a21\u5f0f"

    goto :goto_0

    :cond_1
    const-string/jumbo p1, "\u591c\u666f\u6a21\u5f0f"
...
.method public static trackNewSlowMotionVideoRecorded(Ljava/lang/String;IIIJ)V
    ...
    const-string/jumbo p1, "video_taken"
...
.method public static trackPauseVideoRecording(Z)V
    ...
    const-string/jumbo v1, "video_pause_recording"
...
.method public static trackPictureSize(ILjava/lang/String;)V
    ...
    const-string p1, "camera_picturesize"
...
.method public static trackPictureTaken(IZIZZLjava/lang/String;)V
    ...
    const-string/jumbo v1, "\u5730\u7406\u4f4d\u7f6e"

    if-eqz p4, :cond_5

    const-string/jumbo p4, "\u6709"
    ...
    const-string/jumbo p4, "\u65e0"

    goto :goto_5

    :cond_6
    const-string/jumbo p4, "\u5173"
...
.method public static trackPreferenceChange(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :pswitch_0
    const-string/jumbo p0, "ultra_wide_ldc"
    ...
    :sswitch_data_0
    .sparse-switch
        -0x7fd41d70 -> :sswitch_b
        -0x7daaeb87 -> :sswitch_a
...
.method public static trackSelectObject(Z)V
    ...
    const-string/jumbo v1, "\u9009\u53d6\u4e3b\u4f53\u7269"

    if-eqz p0, :cond_0

    const-string/jumbo p0, "\u5f55\u50cf\u4e2d"

    goto :goto_0

    :cond_0
    const-string/jumbo p0, "\u5f55\u50cf\u524d"
...
.method public static trackUserDefineWatermark()V
    ...
    const-string/jumbo v1, "userdefine_watermark"
...
.method public static trackVideoModeChanged(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "video_mode_changed"
...
.method public static trackVideoRecorded(ZIZZLjava/lang/String;IIIILcom/android/camera/fragment/beauty/BeautyValues;J)V
    ...
    const-string/jumbo p5, "\u95ea\u5149\u706f"

    const/4 v1, 0x2

    if-ne p6, v1, :cond_1

    const-string/jumbo p6, "torch"
    ...
    const-string/jumbo p0, "\u8fd0\u52a8\u8ddf\u62cd"

    if-eqz p3, :cond_2

    const-string/jumbo p2, "\u8d85\u5e7f\u89d2\u6a21\u5f0f\u4e0b\u8fd0\u52a8\u8ddf\u62cd"

    goto :goto_2

    :cond_2
    const-string/jumbo p2, "\u975e\u8d85\u5e7f\u89d2\u6a21\u5f0f\u4e0b\u8fd0\u52a8\u8ddf\u62cd"
    ...
    const-string/jumbo p2, "video_taken"
    ...
    const-string/jumbo p3, "video_time_lapse_interval"
...
.method public static trackVoiceControl(Landroid/content/Intent;)V
    ...
    const-string/jumbo v1, "voice_assist_call_event"
...
.method public static trackZoomAdjusted(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "zoom_adjusted"
