...
.method public matchCustomWatermarkVersion()Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->hn()Ljava/lang/String;
...
.method public parseIntent(Landroid/content/Intent;Ljava/lang/Boolean;ZZZ)Landroid/support/v4/util/Pair;
    ...
    invoke-interface {p5, p1, v3}, Lcom/android/camera/data/provider/DataProvider;->dataConfig(II)Lcom/android/camera/data/provider/DataProvider$ProviderEvent;

    move-result-object p5

    check-cast p5, Lcom/android/camera/data/data/config/DataItemConfig;

    invoke-virtual {p5}, Lcom/android/camera/data/data/config/DataItemConfig;->getComponentConfigRatio()Lcom/android/camera/data/data/config/ComponentConfigRatio;

    move-result-object p5

    invoke-virtual {p5}, Lcom/android/camera/data/data/config/ComponentConfigRatio;->isSquareModule()Z
    ...
    invoke-virtual {p0, p5}, Lcom/android/camera/data/data/global/DataItemGlobal;->setCurrentMode(I)V

    invoke-static {p5}, Lcom/android/camera/module/ModuleManager;->setActiveModuleIndex(I)V
    ...
    invoke-direct {p2, p1, p3}, Landroid/support/v4/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
