...
.method private blockSplitApplyEffect(Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;)[B
    ...
    iget-boolean v1, v11, Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;->mApplyWaterMark:Z

    iget-object v13, v11, Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;->mTimeWatermark:Ljava/lang/String;
    ...
    invoke-direct {v13, v1, v8, v9, v0}, Landroid/graphics/RectF;-><init>(FFFF)V
    ...
    invoke-virtual {v12, v4, v1}, Lcom/android/camera/effect/renders/PipeRender;->setFrameBufferSize(II)V

    :cond_5
    invoke-direct {v10, v4, v1}, Lcom/android/camera/effect/renders/SnapshotRender$EGLHandler;->checkFrameBuffer(II)V
    ...
    invoke-virtual {v13, v9, v4, v1}, Lcom/android/camera/effect/SnapshotCanvas;->beginBindFrameBuffer(III)V

    const/4 v9, 0x0

    invoke-static {v9, v9, v4, v1}, Landroid/opengl/GLES20;->glViewport(IIII)V
    ...
    iput v4, v11, Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;->mBlockWidth:I
    ...
    iget-object v3, v10, Lcom/android/camera/effect/renders/SnapshotRender$EGLHandler;->mGLCanvas:Lcom/android/camera/effect/SnapshotCanvas;

    iget-object v4, v10, Lcom/android/camera/effect/renders/SnapshotRender$EGLHandler;->mWatermarkFrameBuffer:Lcom/android/camera/effect/FrameBuffer;
    ...
    invoke-direct {v10, v3, v11}, Lcom/android/camera/effect/renders/SnapshotRender$EGLHandler;->updateRenderParameters(Lcom/android/camera/effect/renders/Render;Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;)V
    ...
    invoke-virtual/range {v39 .. v45}, Lcom/android/camera/effect/renders/RgbToYuvRender;->drawTexture(IFFFFZ)V
    ...
    invoke-static {v1, v2, v0, v4}, Lcom/android/camera/effect/ShaderNativeUtil;->mergeYUV(IIII)V
    ...
    invoke-static {v2}, Lcom/android/camera/effect/renders/SnapshotRender;->access$2000(Lcom/android/camera/effect/renders/SnapshotRender;)Lcom/android/camera/effect/framework/utils/CounterUtil;
...
.method private release()V
    ...
    invoke-static {v0}, Lcom/android/camera/effect/renders/SnapshotRender;->access$2100(Lcom/android/camera/effect/renders/SnapshotRender;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/camera/effect/SnapshotCanvas;->setSize(II)V
    ...
    invoke-static {v1, v2, v3}, Lcom/android/camera/effect/renders/SnapshotRender;->access$500(Lcom/android/camera/effect/renders/SnapshotRender;II)I
    ...
    invoke-static {v2, v3}, Lcom/android/camera/effect/renders/SnapshotRender;->access$602(Lcom/android/camera/effect/renders/SnapshotRender;I)I
    ...
    invoke-static {v2, v3}, Lcom/android/camera/effect/renders/SnapshotRender;->access$702(Lcom/android/camera/effect/renders/SnapshotRender;I)I
    ...
    :cond_1
    invoke-direct {p0, v0}, Lcom/android/camera/effect/renders/SnapshotRender$EGLHandler;->drawImage(Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;)Z
