...
.method private insertMimojiCaptureTask(Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    invoke-virtual {v15}, Lcom/xiaomi/camera/core/ParallelTaskDataParameter;->isUtralPixelWaterMark()Z
    ...
    :try_start_1
    invoke-direct/range {v1 .. v22}, Lcom/android/camera/storage/ImageSaver;->getDrawJPEGAttribute([BIIIZIILandroid/location/Location;Ljava/lang/String;IIFLjava/lang/String;ZZLjava/lang/String;Ljava/util/List;ZLcom/xiaomi/camera/core/PictureInfo;II)Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;
...
.method private insertNormalDualTask(Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    invoke-virtual {v3, v2}, Lcom/xiaomi/camera/core/ParallelTaskData;->refillJpegData([B)V

    invoke-direct/range {p0 .. p1}, Lcom/android/camera/storage/ImageSaver;->insertParallelDualTask(Lcom/xiaomi/camera/core/ParallelTaskData;)V
...
.method private insertParallelBurstTask(Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    invoke-static {v1, v2}, Lcom/android/camera/Util;->appendExif([BLcom/xiaomi/camera/core/ParallelTaskData;)[B
    ...
    invoke-virtual/range {v7 .. v27}, Lcom/android/camera/storage/ImageSaver;->addImage([BZLjava/lang/String;Ljava/lang/String;JLandroid/net/Uri;Landroid/location/Location;IILcom/android/gallery3d/exif/ExifInterface;IZZZZZLjava/lang/String;Lcom/xiaomi/camera/core/PictureInfo;I)V
...
.method private insertParallelDualTask(Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    invoke-static/range {v3 .. v13}, Lcom/android/camera/Util;->composeLiveShotPicture([BII[BJZZLjava/lang/String;[B[I)[B
    ...
    :cond_2
    invoke-static {v3, v12, v13}, Lcom/android/camera/Util;->composeMainSubPicture([B[B[I)[B
...
.method private insertSingleTask(Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    invoke-virtual {v14}, Lcom/xiaomi/camera/core/ParallelTaskDataParameter;->isHasWaterMark()Z

    move-result v19

    invoke-virtual {v14}, Lcom/xiaomi/camera/core/ParallelTaskDataParameter;->isUtralPixelWaterMark()Z
    ...
    invoke-virtual {v5}, Lcom/xiaomi/camera/core/ParallelTaskDataParameter;->isHasFrontWaterMark()Z
    ...
    invoke-static/range {v15 .. v25}, Lcom/android/camera/Util;->composeLiveShotPicture([BII[BJZZLjava/lang/String;[B[I)[B
...
.method private storeJpegData(Lcom/xiaomi/camera/core/ParallelTaskData;II)V
    ...
    :cond_0
    invoke-interface {v1}, Lcom/android/camera/storage/ImageSaver$ImageSaverCallback;->getDisplayRotation()I
    ...
    invoke-interface {v1}, Lcom/android/camera/storage/ImageSaver$ImageSaverCallback;->getCameraScreenNail()Lcom/android/camera/CameraScreenNail;
...
.method public declared-synchronized onParallelProcessFinish(Lcom/xiaomi/camera/core/ParallelTaskData;)Z
    ...
    invoke-direct {v1, v3, v4}, Lcom/android/camera/effect/renders/SnapshotEffectRender;-><init>(Lcom/android/camera/storage/ImageSaver$ImageSaverCallback;Z)V
