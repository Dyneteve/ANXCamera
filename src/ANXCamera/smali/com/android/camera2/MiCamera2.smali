...
.method public constructor <init>(Landroid/hardware/camera2/CameraDevice;ILcom/android/camera2/CameraCapabilities;Landroid/os/Handler;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    invoke-virtual {p2}, Lcom/mi/config/a;->gR()Z
...
.method static synthetic access$2400(Lcom/android/camera2/MiCamera2;Z)V
    .locals 0
...
.method static synthetic access$3000(Lcom/android/camera2/MiCamera2;)I
    .locals 0
...
.method static synthetic access$3100(Lcom/android/camera2/MiCamera2;)Z
    .locals 0
...
.method static synthetic access$3200(Lcom/android/camera2/MiCamera2;)V
    .locals 0
...
.method static synthetic access$3400(Lcom/android/camera2/MiCamera2;)Ljava/lang/Object;
    .locals 0
...
.method static synthetic access$3500(Lcom/android/camera2/MiCamera2;)Lcom/android/camera2/Camera2Proxy$VideoRecordStateCallback;
    .locals 0
...
.method static synthetic access$3502(Lcom/android/camera2/MiCamera2;Lcom/android/camera2/Camera2Proxy$VideoRecordStateCallback;)Lcom/android/camera2/Camera2Proxy$VideoRecordStateCallback;
    .locals 0
...
.method private applyFlashMode(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    new-instance p2, Lcom/android/camera2/-$$Lambda$MiCamera2$Lq6SUrqDkCzFiTu4kx-wLlVIlY4;

    invoke-direct {p2, v7}, Lcom/android/camera2/-$$Lambda$MiCamera2$Lq6SUrqDkCzFiTu4kx-wLlVIlY4;-><init>(Lcom/android/camera2/Camera2Proxy$ScreenLightCallback;)V
...
.method private captureStillPicture()V
    ...
    invoke-direct {v0, p0}, Lcom/android/camera2/MiCamera2ShotRawBurst;-><init>(Lcom/android/camera2/MiCamera2;)V
...
.method private getCaptureInterval()J
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->hc()J
...
.method public static synthetic lambda$preparePreviewImageReader$0(Lcom/android/camera2/MiCamera2;Landroid/media/ImageReader;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera2/MiCamera2;->getPreviewCallback()Lcom/android/camera2/Camera2Proxy$PreviewCallback;
    ...
    invoke-interface {v0, p1, p0, v1}, Lcom/android/camera2/Camera2Proxy$PreviewCallback;->onPreviewFrame(Landroid/media/Image;Lcom/android/camera2/Camera2Proxy;I)V
...
.method public static synthetic lambda$setCaptureEnable$1(Lcom/android/camera2/MiCamera2;Z)V
    .locals 4
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->hd()I
...
.method private preparePreviewImageReader(Lcom/android/camera/CameraSize;II)V
    ...
    new-instance p2, Lcom/android/camera2/-$$Lambda$MiCamera2$pzM6ixUFt4LjxBPA7MkKXJ8qu9Q;

    invoke-direct {p2, p0}, Lcom/android/camera2/-$$Lambda$MiCamera2$pzM6ixUFt4LjxBPA7MkKXJ8qu9Q;-><init>(Lcom/android/camera2/MiCamera2;)V
...
.method private prepareRemoteImageReader(Ljava/util/List;)Ljava/util/List;
    ...
    const-string v0, "The given \"params\" should be null or an empty list"
    ...
    sget v4, Lcom/android/camera2/MiCamera2;->MAX_IMAGE_BUFFER_SIZE:I

    const/4 v5, 0x0

    move-object v0, v6

    invoke-direct/range {v0 .. v5}, Lcom/xiaomi/protocol/IImageReaderParameterSets;-><init>(IIIII)V
    ...
    invoke-virtual {v1}, Lcom/android/camera2/CameraConfigs;->getSubPhotoSize()Lcom/android/camera/CameraSize;
    ...
    const-string v4, "[QCFA] prepareRemoteImageReader: "
    ...
    iget v1, v1, Lcom/xiaomi/protocol/IImageReaderParameterSets;->maxImages:I
    ...
    const-string v3, "prepareRemoteImageReader: to prepare remote surfaces with configurations:"
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera/LocalParallelService$LocalBinder;->configCaptureOutputBuffer(Ljava/util/List;)Ljava/util/List;
...
.method private triggerDeviceChecking(Z)V
    ...
    const-string/jumbo v1, "triggerDeviceChecking"
...
.method private triggerPrecapture()V
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->hp()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->ho()Z
...
.method private unlockFocus()V
    ...
    const-string/jumbo v1, "unlockFocus"
...
.method applySettingsForCapture(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    :cond_1
    invoke-static {p1, v2}, Lcom/android/camera/lib/compatibility/util/CompatibilityUtils;->setZsl(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-static {p1, v0, v3}, Lcom/android/camera2/vendortag/VendorTagHelper;->setValueQuietly(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/vendortag/VendorTag;Ljava/lang/Object;)V
    ...
    invoke-static {p1, v0, v3}, Lcom/android/camera2/CaptureRequestBuilder;->applyAntiShake(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/CameraCapabilities;Lcom/android/camera2/CameraConfigs;)V
...
.method public forceTurnFlashONAndPausePreview()V
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera2/CameraConfigs;->setFlashMode(I)Z
...
.method public releasePreview(I)V
    ...
    const-string v1, "releasePreview: null session"
...
.method public setCaptureEnable(Z)V
    ...
    new-instance v1, Lcom/android/camera2/-$$Lambda$MiCamera2$-GOgcdXV3OVs-ZdAOAwiwzy4u_M;

    invoke-direct {v1, p0, p1}, Lcom/android/camera2/-$$Lambda$MiCamera2$-GOgcdXV3OVs-ZdAOAwiwzy4u_M;-><init>(Lcom/android/camera2/MiCamera2;Z)V
...
.method public startHighSpeedRecordSession(Landroid/view/Surface;Landroid/view/Surface;Landroid/util/Range;Lcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    invoke-static {p2, p3, v0}, Lcom/android/camera2/vendortag/VendorTagHelper;->setValueQuietly(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/vendortag/VendorTag;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p1, p3, p4}, Landroid/hardware/camera2/CameraDevice;->createCaptureSession(Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/os/Handler;)V
    ...
    sget-object v0, Lcom/android/camera2/vendortag/CaptureRequestVendorTags;->VALUE_SMVR_MODE_480FPS:[I
    ...
    const-string p3, "Unsupported High Speed Recording: "
    ...
    invoke-virtual {p2}, Lcom/mi/config/a;->gC()Z
    ...
    invoke-virtual {p2}, Lcom/mi/config/a;->gQ()Z
...
.method public startHighSpeedRecording()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->gW()Z
...
.method public startPreviewSession(Landroid/view/Surface;ZZZIZLcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    const-string v5, "startPreviewSession"
    ...
    const-string v7, "startPreviewSession: opMode=0x%x previewCallback=%b rawCallback=%b"
    ...
    :try_start_0
    iput-boolean v4, v1, Lcom/android/camera2/MiCamera2;->mEnableParallelSession:Z

    move-object/from16 v6, p1

    iput-object v6, v1, Lcom/android/camera2/MiCamera2;->mPreviewSurface:Landroid/view/Surface;
    ...
    invoke-direct {v1, v4}, Lcom/android/camera2/MiCamera2;->prepareDepthImageReader(Lcom/android/camera/CameraSize;)V
    ...
    invoke-direct {v1, v4}, Lcom/android/camera2/MiCamera2;->preparePortraitRawImageReader(Lcom/android/camera/CameraSize;)V
    ...
    invoke-direct {v1, v4}, Lcom/android/camera2/MiCamera2;->prepareRemoteImageReader(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v7, v15}, Landroid/hardware/camera2/params/OutputConfiguration;-><init>(Landroid/view/Surface;)V
    ...
    invoke-virtual {v10}, Lcom/android/camera2/CameraConfigs;->getShotType()I
    ...
    invoke-static {v7, v15}, Lcom/android/camera/lib/compatibility/util/CompatibilityUtils;->setPhysicalCameraId(Landroid/hardware/camera2/params/OutputConfiguration;Ljava/lang/String;)V
    ...
    invoke-static {v7, v11}, Lcom/android/camera/lib/compatibility/util/CompatibilityUtils;->setPhysicalCameraId(Landroid/hardware/camera2/params/OutputConfiguration;Ljava/lang/String;)V
    ...
    const-string v12, "Binds sub output stream to camera "
    ...
    iput-object v4, v1, Lcom/android/camera2/MiCamera2;->mCaptureSession:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    invoke-direct {v1, v0, v7, v8}, Lcom/android/camera2/MiCamera2;->preparePreviewImageReader(Lcom/android/camera/CameraSize;II)V
    ...
    invoke-direct {v1, v0, v3}, Lcom/android/camera2/MiCamera2;->prepareRawImageReader(Lcom/android/camera/CameraSize;Z)V
    ...
    const-string v8, "startPreviewSession: needsRawStream = "
    ...
    invoke-virtual {v4}, Lcom/android/camera2/CameraConfigs;->getSensorRawImageSize()Lcom/android/camera/CameraSize;
    ...
    invoke-direct {v7, v0, v4, v8}, Landroid/hardware/camera2/params/InputConfiguration;-><init>(III)V
    ...
    const-string v11, "startPreviewSession: setup input configuration: w = "
    ...
    iget v4, v1, Lcom/android/camera2/MiCamera2;->mSessionId:I

    move-object/from16 v8, p7

    invoke-direct {v0, v1, v4, v8}, Lcom/android/camera2/MiCamera2$CaptureSessionStateCallback;-><init>(Lcom/android/camera2/MiCamera2;ILcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    invoke-direct {v4, v8}, Landroid/graphics/SurfaceTexture;-><init>(Z)V

    iput-object v4, v1, Lcom/android/camera2/MiCamera2;->mFakeOutputTexture:Landroid/graphics/SurfaceTexture;
    ...
    invoke-virtual {v4, v8, v0}, Landroid/graphics/SurfaceTexture;->setDefaultBufferSize(II)V
    ...
    invoke-direct {v8, v9, v0}, Landroid/util/Size;-><init>(II)V

    const-class v0, Landroid/view/SurfaceHolder;

    invoke-direct {v4, v8, v0}, Landroid/hardware/camera2/params/OutputConfiguration;-><init>(Landroid/util/Size;Ljava/lang/Class;)V
    ...
    invoke-interface {v6, v8, v4}, Ljava/util/List;->add(ILjava/lang/Object;)V
    ...
    sget-object v2, Lcom/android/camera2/vendortag/CaptureRequestVendorTags;->ZSL_CAPTURE_MODE:Lcom/android/camera2/vendortag/VendorTag;
    ...
    invoke-static {v0, v2, v3}, Lcom/android/camera2/vendortag/VendorTagHelper;->setValueQuietly(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/vendortag/VendorTag;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera2/MiCamera2;->notifyOnError(I)V
...
.method public startRecordSession(Landroid/view/Surface;Landroid/view/Surface;ZILcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    invoke-direct {v0, p3}, Landroid/hardware/camera2/params/OutputConfiguration;-><init>(Landroid/view/Surface;)V
    ...
    const-string v0, "startRecordSession: operatingMode is "
    ...
    invoke-static {p1, p3, v0}, Lcom/android/camera2/vendortag/VendorTagHelper;->setValueQuietly(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/vendortag/VendorTag;Ljava/lang/Object;)V

    sget-object p1, Lcom/android/camera2/MiCamera2;->TAG:Ljava/lang/String;

    const-string p3, "startRecordSession: turns hpfsmode on"
    ...
    iget-object v6, p0, Lcom/android/camera2/MiCamera2;->mPreviewRequest:Landroid/hardware/camera2/CaptureRequest;
...
.method public unRegisterCaptureCallback()V
    ...
    const-string/jumbo v1, "unRegisterCaptureCallback"
...
.method protected useLegacyFlashStrategy()Z
    .locals 1
