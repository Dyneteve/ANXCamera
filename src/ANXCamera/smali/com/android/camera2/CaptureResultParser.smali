...
.field private static final AEC_FRAME:Landroid/hardware/camera2/CaptureResult$Key;
...
.field private static final IS_SR_ENABLE:Landroid/hardware/camera2/CaptureResult$Key;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/hardware/camera2/CaptureResult$Key<",
            "Ljava/lang/Boolean;",
...
.field private static final MULTIFRAME_INPUTNUM:Landroid/hardware/camera2/CaptureResult$Key;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/hardware/camera2/CaptureResult$Key<",
            "Ljava/lang/Integer;",
...
.field public static final VENDOR_TAG_ASD_DETECTED_MODES:Ljava/lang/String; = "xiaomi.ai.asd.sceneDetected"

.field public static final VENDOR_TAG_ASD_ENABLE:Ljava/lang/String; = "xiaomi.ai.asd.enabled"

.field public static final VENDOR_TAG_AWB_FRAME_CONTROL:Ljava/lang/String; = "org.quic.camera2.statsconfigs.AWBFrameControl"

.field public static final VENDOR_TAG_BEAUTY_BODY_SLIM_COUNT:Ljava/lang/String; = "xiaomi.beauty.bodySlimCnt"
...
.field public static final VENDOR_TAG_HDR_DETECTED_MODES:Ljava/lang/String; = "xiaomi.hdr.hdrDetected"

.field public static final VENDOR_TAG_LENS_DIRTY_DETECTED:Ljava/lang/String; = "xiaomi.ai.add.lensDirtyDetected"

.field public static final VENDOR_TAG_MULTIFRAME_INPUTNUM:Ljava/lang/String; = "xiaomi.multiframe.inputNum"

.field public static final VENDOR_TAG_SUPER_RESOLUTION_ENABLED:Ljava/lang/String; = "xiaomi.superResolution.enabled"

.field public static final VENDOR_TAG_ULTRA_WIDE_RECOMMENDED:Ljava/lang/String; = "xiaomi.ai.misd.ultraWideRecommended"
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lcom/android/camera2/CaptureResultParser;->genByteRequestKey(Ljava/lang/String;)Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-static {v0}, Lcom/android/camera2/CaptureResultParser;->genIntegerResultKey(Ljava/lang/String;)Landroid/hardware/camera2/CaptureResult$Key;
    ...
    const-class v1, Lcom/android/camera2/AWBFrameControl;

    invoke-static {v0, v1}, Lcom/android/camera2/CaptureResultParser;->genResultKey(Ljava/lang/String;Ljava/lang/Class;)Landroid/hardware/camera2/CaptureResult$Key;
    ...
    const-class v1, Lcom/android/camera2/AECFrameControl;
    ...
    const-class v1, Lcom/android/camera2/AFFrameControl;
    ...
    sput-object v0, Lcom/android/camera2/CaptureResultParser;->MULTIFRAME_INPUTNUM:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sput-object v0, Lcom/android/camera2/CaptureResultParser;->IS_SR_ENABLE:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sput-object v0, Lcom/android/camera2/CaptureResultParser;->AEC_FRAME:Landroid/hardware/camera2/CaptureResult$Key;
...
.method static genByteRequestKey(Ljava/lang/String;)Landroid/hardware/camera2/CaptureResult$Key;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v0}, Lcom/android/camera2/CaptureResultParser;->genResultKey(Ljava/lang/String;Ljava/lang/Class;)Landroid/hardware/camera2/CaptureResult$Key;
...
.method static genIntegerResultKey(Ljava/lang/String;)Landroid/hardware/camera2/CaptureResult$Key;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static genResultKey(Ljava/lang/String;Ljava/lang/Class;)Landroid/hardware/camera2/CaptureResult$Key;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static isQuadCfaRunning(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    sget-object v0, Lcom/android/camera2/CaptureResultParser;->AEC_FRAME:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    const-string v2, "isQuadCfaRunning: gain="
...
.method public static isRemosaicDetected(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    sget-object v0, Lcom/android/camera/constant/MiCaptureResult;->REMOSAIC_DETECTED:Landroid/hardware/camera2/CaptureResult$Key;
...
.method public static isSREnable(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    sget-object v0, Lcom/android/camera2/CaptureResultParser;->IS_SR_ENABLE:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    const-string v1, "isSREnable: No CaptureResult key found:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-object v1, Lcom/android/camera2/CaptureResultParser;->IS_SR_ENABLE:Landroid/hardware/camera2/CaptureResult$Key;
