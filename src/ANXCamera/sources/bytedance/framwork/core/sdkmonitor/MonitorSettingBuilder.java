...
public class MonitorSettingBuilder {
    ...
    public MonitorSetting createMonitorSetting() {
        ...
        List<String> list = this.mReportUrlList;
        int i5 = this.mLogSendSwitch;
        long j3 = this.mStopMoreChannelInterval;
        boolean z = this.mLogRemoveSwitch;
        long j4 = j3;
        MonitorSetting monitorSetting = new MonitorSetting(j, j2, i, i2, i3, i4, jSONObject, jSONObject2, jSONObject3, list, i5, j4, z, this.mIsEncrypt, this.mMonitorMaxRowCount);
