...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    public void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult result) {
        ...
        if (this.mOrientation == 1) {
            ...
            top = getPaddingTop();
            int right3 = this.mOrientationHelper.getDecoratedMeasurementInOther(view) + top;
            if (layoutState2.mLayoutDirection == -1) {
                right2 = layoutState2.mOffset;
                left2 = layoutState2.mOffset - layoutChunkResult.mConsumed;
            } else {
                left2 = layoutState2.mOffset;
                right2 = layoutState2.mOffset + layoutChunkResult.mConsumed;
            }
            bottom = right3;
            right = right2;
        }
