...
class ViewBoundsCheck {
    ...
    static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((this.mBoundFlags & SuperNightProcess.ARC_SN_CAMERA_MODE_XIAOMI_SDM855_12MB_IMX586) == 0 || (this.mBoundFlags & (compare(this.mChildEnd, this.mRvStart) << 8)) != 0) {
                return (this.mBoundFlags & ResultCode.AWS_MERR_BASE) == 0 || (this.mBoundFlags & (compare(this.mChildEnd, this.mRvEnd) << 12)) != 0;
            }
            return false;
        }
