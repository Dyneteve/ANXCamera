        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    AnonymousClass3 r0 = new RecoverAnimation(prevSelected, animationType2, prevActionState2, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY) {
                        public void onAnimationEnd(ValueAnimatorCompat animation) {
                    ...
                    r0.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, animationType3, targetTranslateX - currentTranslateX, targetTranslateY - currentTranslateY));
