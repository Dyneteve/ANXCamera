...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private static class ItemHolderInfo {
        ...
        ItemHolderInfo(ViewHolder holder2, int left2, int top2, int right2, int bottom2) {
            this.holder = holder2;
            this.left = left2;
            this.top = top2;
            this.right = right2;
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    if (dx != 0) {
                        hresult2 = RecyclerView.this.mLayout.scrollHorizontallyBy(dx, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        overscrollX = dx - hresult2;
                    }
                    if (dy != 0) {
                        vresult2 = RecyclerView.this.mLayout.scrollVerticallyBy(dy, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        overscrollY = dy - vresult2;
                    }
                    TraceCompat.endSection();
                    if (RecyclerView.this.supportsChangeAnimations()) {
                        int count2 = RecyclerView.this.mChildHelper.getChildCount();
                        int i2 = 0;
                        while (i2 < count2) {
                ...
                if (!(overscrollX == 0 && overscrollY == 0)) {
                    ...
                    int velX = 0;
                    if (overscrollX != x) {
                        int i3 = overscrollX < 0 ? -vel : overscrollX > 0 ? vel : 0;
                        velX = i3;
                    }
                    int velY = 0;
                    if (overscrollY != y) {
                        int i4 = overscrollY < 0 ? -vel : overscrollY > 0 ? vel : 0;
                        velY = i4;
                    }
                    if (ViewCompat.getOverScrollMode(RecyclerView.this) != 2) {
                ...
                if (!(hresult2 == 0 && vresult2 == 0)) {
                    RecyclerView.this.dispatchOnScrolled(hresult2, vresult2);
                }
                if (!RecyclerView.this.awakenScrollBars()) {
                    RecyclerView.this.invalidate();
                }
                boolean fullyConsumedAny = true;
                boolean fullyConsumedVertical = dy != 0 && RecyclerView.this.mLayout.canScrollVertically() && vresult2 == dy;
        ...
        if (layout != this.mLayout) {
            ...
            if (layout != null) {
                if (layout.mRecyclerView == null) {
                    ...
                    sb.append(layout.mRecyclerView);
                    throw new IllegalArgumentException(sb.toString());
                }
            }
            requestLayout();
    ...
    public boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            ...
            if (i != 0) {
                consumedX2 = this.mLayout.scrollHorizontallyBy(i, this.mRecycler, this.mState);
                unconsumedX3 = i - consumedX2;
            }
            if (i2 != 0) {
                consumedY2 = this.mLayout.scrollVerticallyBy(i2, this.mRecycler, this.mState);
                unconsumedY3 = i2 - consumedY2;
            }
            TraceCompat.endSection();
            ...
            int unconsumedX4 = unconsumedX3;
            int unconsumedY4 = unconsumedY3;
        ...
        if (dispatchOnItemTouchIntercept(e)) {
            ...
            switch (action) {
                ...
                case 2:
                    ...
                    if (index >= 0) {
                        int x2 = (int) (MotionEventCompat.getX(motionEvent, index) + 0.5f);
                        int y2 = (int) (MotionEventCompat.getY(motionEvent, index) + 0.5f);
                ...
                case 2:
                    ...
                    if (index >= 0) {
                        ...
                        if (this.mScrollState == i2) {
                            ...
                            this.mLastTouchY = y2 - this.mScrollOffset[i2];
            ...
            if (this.mState.mRunSimpleAnimations) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (!holder.shouldIgnore() && (!holder.isInvalid() || this.mAdapter.hasStableIds())) {
                        ...
                        ItemHolderInfo itemHolderInfo = new ItemHolderInfo(holder, view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
                        arrayMap3.put(holder, itemHolderInfo);
                    }
                }
            }
            if (this.mState.mRunPredictiveAnimations) {
                    ...
                    if (!getChildViewHolderInt(child).shouldIgnore()) {
                        ...
                        while (true) {
                            if (j >= this.mState.mPreLayoutHolderMap.size()) {
                                break;
                            } else if (((ViewHolder) this.mState.mPreLayoutHolderMap.keyAt(j)).itemView == child) {
                                found = true;
                                break;
                            } else {
                                j++;
                        ...
                        if (!found) {
                            arrayMap2.put(child, new Rect(child.getLeft(), child.getTop(), child.getRight(), child.getBottom()));
                        }
                    }
                }
                clearOldPositions();
            ...
            if (this.mState.mRunSimpleAnimations) {
                ...
                for (int i5 = 0; i5 < count4; i5++) {
                    ...
                    if (!holder4.shouldIgnore()) {
                        ...
                        if (arrayMap4 == null || this.mState.mOldChangedHolders.get(Long.valueOf(key)) == null) {
                            ItemHolderInfo itemHolderInfo2 = r9;
                            ArrayMap<ViewHolder, ItemHolderInfo> arrayMap5 = this.mState.mPostLayoutHolderMap;
                            long j2 = key;
                            ItemHolderInfo itemHolderInfo3 = new ItemHolderInfo(holder4, view2.getLeft(), view2.getTop(), view2.getRight(), view2.getBottom());
                            arrayMap5.put(holder4, itemHolderInfo2);
                        } else {
                            arrayMap4.put(Long.valueOf(key), holder4);
                        }
                    }
                }
                processDisappearingList(arrayMap2);
                for (int i6 = this.mState.mPreLayoutHolderMap.size() - 1; i6 >= 0; i6--) {
                    if (!this.mState.mPostLayoutHolderMap.containsKey((ViewHolder) this.mState.mPreLayoutHolderMap.keyAt(i6))) {
                        ItemHolderInfo disappearingItem = (ItemHolderInfo) this.mState.mPreLayoutHolderMap.valueAt(i6);
                ...
                if (postLayoutCount > 0) {
                    for (int i7 = postLayoutCount - 1; i7 >= 0; i7--) {
                        ViewHolder itemHolder = (ViewHolder) this.mState.mPostLayoutHolderMap.keyAt(i7);
                        ItemHolderInfo info = (ItemHolderInfo) this.mState.mPostLayoutHolderMap.valueAt(i7);
                        if (this.mState.mPreLayoutHolderMap.isEmpty() || !this.mState.mPreLayoutHolderMap.containsKey(itemHolder)) {
                            ...
                            animateAppearance(itemHolder, arrayMap2 != null ? (Rect) arrayMap2.get(itemHolder.itemView) : null, info.left, info.top);
                        }
                    }
                }
                int count5 = this.mState.mPostLayoutHolderMap.size();
                for (int i8 = 0; i8 < count5; i8++) {
                    ViewHolder postHolder = (ViewHolder) this.mState.mPostLayoutHolderMap.keyAt(i8);
                    ItemHolderInfo postInfo = (ItemHolderInfo) this.mState.mPostLayoutHolderMap.valueAt(i8);
                    ...
                    if (!(preInfo == null || postInfo == null || (preInfo.left == postInfo.left && preInfo.top == postInfo.top))) {
                        ...
                        ItemHolderInfo itemHolderInfo4 = preInfo;
                        if (this.mItemAnimator.animateMove(postHolder, preInfo.left, preInfo.top, postInfo.left, postInfo.top)) {
                            postAnimationRunner();
                        }
                    }
                }
                for (int i9 = (this.mState.mOldChangedHolders != null ? this.mState.mOldChangedHolders.size() : 0) - 1; i9 >= 0; i9--) {
                    long key2 = ((Long) this.mState.mOldChangedHolders.keyAt(i9)).longValue();
                    ...
                    if (!oldHolder.shouldIgnore() && this.mRecycler.mChangedScrap != null && this.mRecycler.mChangedScrap.contains(oldHolder)) {
                        animateChange(oldHolder, (ViewHolder) arrayMap4.get(Long.valueOf(key2)));
                    }
                }
            }
            resumeRequestLayout(false);
    ...
    private void processDisappearingList(ArrayMap<View, Rect> appearingViews) {
        ...
        for (int i = disappearingList.size() - 1; i >= 0; i--) {
            ...
            if (appearingViews.remove(view) != null) {
                ...
                ItemHolderInfo itemHolderInfo = new ItemHolderInfo(vh, view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
    ...
    public void draw(Canvas c) {
        ...
        if (this.mLeftGlow != null && !this.mLeftGlow.isFinished()) {
            ...
            boolean z2 = this.mLeftGlow != null && this.mLeftGlow.draw(c);
            needsInvalidate = z2;
        ...
        if (this.mTopGlow != null && !this.mTopGlow.isFinished()) {
            ...
            boolean z3 = this.mTopGlow != null && this.mTopGlow.draw(c);
            needsInvalidate |= z3;
        ...
        if (this.mRightGlow != null && !this.mRightGlow.isFinished()) {
            ...
            boolean z4 = this.mRightGlow != null && this.mRightGlow.draw(c);
            needsInvalidate |= z4;
