    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        while (true) {
            ...
            if (layoutState.hasMore(state) && !this.mRemainingSpans.isEmpty()) {
                ...
                ? r16 = spanIndex == -1 ? z : r92;
                if (r16 != 0) {
                    currentSpan = lp.mFullSpan ? this.mSpans[r92] : getNextSpan(layoutState2);
                ...
                if (layoutState2.mLayoutDirection == z) {
                    int start2 = lp.mFullSpan ? getMaxEnd(defaultNewViewLine) : currentSpan3.getEndLine(defaultNewViewLine);
                    int end2 = this.mPrimaryOrientation.getDecoratedMeasurement(view) + start2;
                    if (r16 != 0 && lp.mFullSpan) {
                    ...
                    int end3 = lp.mFullSpan != 0 ? getMinStart(defaultNewViewLine) : currentSpan3.getStartLine(defaultNewViewLine);
                    int start3 = end3 - this.mPrimaryOrientation.getDecoratedMeasurement(view);
                    if (r16 != 0 && lp.mFullSpan) {
                        FullSpanItem fullSpanItem2 = createFullSpanItemFromStart(end3);
