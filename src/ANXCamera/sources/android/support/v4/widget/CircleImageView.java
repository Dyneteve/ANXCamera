...
class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(int shadowRadius, int circleDiameter) {
            ...
            RadialGradient radialGradient = new RadialGradient((float) (this.mCircleDiameter / 2), (float) (this.mCircleDiameter / 2), (float) CircleImageView.this.mShadowRadius, new int[]{CircleImageView.FILL_SHADOW_COLOR, 0}, null, TileMode.CLAMP);
