...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            ...
            case 5:
                ...
                this.mLastMotionY = (int) MotionEventCompat.getY(motionEvent, index);
    ...
    public boolean overScrollByCompat(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
        ...
        int i = overScrollMode;
        int overScrollMode2 = maxOverScrollY2 + scrollRangeY;
        ...
        int bottom = overScrollMode2;
        boolean clampedY2 = clampedY;
        boolean z = canScrollVertical;
