    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action2) {
            ...
            case 2:
                        ...
                        while (true) {
                            if (i3 < pointerCount2) {
                                ...
                                if (pastSlop) {
                                    ...
                                    int actionIndex3 = ((int) dy) + oldTop;
                                    pointerCount = pointerCount2;
                                    int i4 = targetLeft;
                                    int newTop = this.mCallback.clampViewPositionVertical(toCapture2, actionIndex3, (int) dy);
                ...
                break;
            case 5:
                int pointerId3 = MotionEventCompat.getPointerId(motionEvent, actionIndex2);
                ...
                break;
            case 6:
                clearMotionHistory(MotionEventCompat.getPointerId(motionEvent, actionIndex2));
                break;
        }
    }
        ...
        switch (action) {
            ...
            case 2:
                ...
                while (i < pointerCount) {
                    ...
                    reportNewEdgeDrags(dx, dy, pointerId2);
                    if (this.mDragState != 1) {
                        View toCapture2 = findTopChildUnder((int) x3, (int) y2);
                    ...
                    while (true) {
                        if (i < pointerCount2) {
                            ...
                            if (id != this.mActivePointerId) {
                                if (findTopChildUnder((int) MotionEventCompat.getX(ev, i), (int) MotionEventCompat.getY(ev, i)) == this.mCapturedView && tryCaptureViewForDrag(this.mCapturedView, id)) {
