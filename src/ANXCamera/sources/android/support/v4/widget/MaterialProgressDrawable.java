...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void setInsets(int i, int i2) {
            ...
            float ceil = (this.mRingCenterRadius <= 0.0d || min < 0.0f) ? (float) Math.ceil((double) (this.mStrokeWidth / 2.0f)) : (float) (((double) (min / 2.0f)) - this.mRingCenterRadius);
    ...
    private void setupAnimators() {
        ...
        AnonymousClass1 r1 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                if (f <= 0.5f) {
                    ring.setStartTrim(((MaterialProgressDrawable.MAX_PROGRESS_ARC - access$100) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f / 0.5f)) + startingStartTrim);
                }
                if (f > 0.5f) {
                    ring.setEndTrim((MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((f - 0.5f) / 0.5f) * (MaterialProgressDrawable.MAX_PROGRESS_ARC - access$100)) + startingEndTrim);
                }
