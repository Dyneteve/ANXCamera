    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case 3:
                ...
                float overscrollTop = (MotionEventCompat.getY(ev, MotionEventCompat.findPointerIndex(ev, this.mActivePointerId)) - this.mInitialMotionY) * 0.5f;
                this.mIsBeingDragged = false;
            ...
            case 2:
                ...
                float overscrollTop2 = (MotionEventCompat.getY(ev, pointerIndex) - this.mInitialMotionY) * 0.5f;
