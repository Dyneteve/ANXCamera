    ...
    public BackStackState(BackStackRecord bse) {
        ...
        if (bse.mAddToBackStack) {
            ...
            for (Op op2 = bse.mHead; op2 != null; op2 = op2.next) {
                ...
                int pos5 = pos4 + 1;
                this.mOps[pos4] = op2.exitAnim;
                int pos6 = pos5 + 1;
                this.mOps[pos5] = op2.popEnterAnim;
                int pos7 = pos6 + 1;
                this.mOps[pos6] = op2.popExitAnim;
                if (op2.removed != null) {
                    ...
                    while (i < N) {
                        int pos9 = pos8 + 1;
                        this.mOps[pos8] = ((Fragment) op2.removed.get(i)).mIndex;
                        i++;
                        pos8 = pos9;
                    }
                    pos = pos8;
