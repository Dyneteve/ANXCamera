...
public class NotificationCompat {
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        public static final Factory FACTORY = new Factory() {
            public Action build(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr) {
                Action action = new Action(i, charSequence, pendingIntent, bundle, (RemoteInput[]) remoteInputArr);
                return action;
            }
        ...
        public static final class Builder {
            ...
            public Action build() {
                Action action = new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, this.mRemoteInputs != null ? (RemoteInput[]) this.mRemoteInputs.toArray(new RemoteInput[this.mRemoteInputs.size()]) : null);
                return action;
            }
    ...
    static class NotificationCompatImplApi20 extends NotificationCompatImplKitKat {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            boolean z3 = z2;
            boolean z4 = z3;
            android.support.v4.app.NotificationCompatApi20.Builder builder3 = new android.support.v4.app.NotificationCompatApi20.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z4, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            NotificationCompat.addStyleToBuilderJellybean(builder3, builder2.mStyle);
    ...
    static class NotificationCompatImplApi21 extends NotificationCompatImplApi20 {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            boolean z3 = z2;
            boolean z4 = z3;
            android.support.v4.app.NotificationCompatApi21.Builder builder3 = new android.support.v4.app.NotificationCompatApi21.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z4, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            NotificationCompat.addStyleToBuilderJellybean(builder3, builder2.mStyle);
            return builderExtender.build(builder2, builder3);
        }
    ...
    static class NotificationCompatImplJellybean extends NotificationCompatImplBase {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            boolean z3 = z2;
            boolean z4 = z3;
            android.support.v4.app.NotificationCompatJellybean.Builder builder3 = new android.support.v4.app.NotificationCompatJellybean.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z4, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            NotificationCompat.addStyleToBuilderJellybean(builder3, builder2.mStyle);
            return builderExtender.build(builder2, builder3);
        }
    ...
    static class NotificationCompatImplKitKat extends NotificationCompatImplJellybean {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            boolean z3 = z2;
            boolean z4 = z3;
            android.support.v4.app.NotificationCompatKitKat.Builder builder3 = new android.support.v4.app.NotificationCompatKitKat.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z4, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            NotificationCompat.addStyleToBuilderJellybean(builder3, builder2.mStyle);
            return builderExtender.build(builder2, builder3);
        }
