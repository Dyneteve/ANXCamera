...
public abstract class TransportPerformer {
    ...
    public void onAudioFocusChange(int focusChange) {
        ...
        if (keyCode != 0) {
            ...
            long j2 = now;
            int i = keyCode;
            KeyEvent keyEvent = new KeyEvent(j, j2, 0, i, 0);
            onMediaButtonDown(keyCode, keyEvent);
            KeyEvent keyEvent2 = new KeyEvent(j, j2, 1, i, 0);
            onMediaButtonUp(keyCode, keyEvent2);
        }
    }
}
