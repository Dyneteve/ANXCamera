...
public final class E2EScenarioSettings implements Parcelable, Cloneable, Serializable {
    ...
    public void setHistoryLimitPerDay(int historyLimitPerDay2) {
        this.historyLimitPerDay = historyLimitPerDay2;
    }

    public void enableAutoAnalysis(int slownessFloorThresholdMillis2, int timeoutMillisOfAutoAnalysis2) {
        this.isAutoAnalysisEnabled = true;
        this.slownessFloorThresholdMillis = slownessFloorThresholdMillis2;
        this.timeoutMillisOfAutoAnalysis = timeoutMillisOfAutoAnalysis2;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.isAutoAnalysisEnabled ? 1 : 0);
