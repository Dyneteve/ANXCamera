...
public class MiuiSettings {
    ...
    public static final class ScreenEffect {
        ...
        private static int getDefaultSaturation() {
            int i = 10;
            if (FeatureParser.getBoolean(d.tZ, false)) {
                i = 11;
            }
    ...
    public static class Secure extends android.provider.SystemSettings.Secure {
        ...
        public static void showApplyPasswordConfirmDialog(final Activity activity, final OnClickListener onClickListener, final String str, String str2) {
            ...
            new Builder(activity).setCancelable(false).setIconAttribute(16843605).setTitle(activity.getString(285802672, new Object[]{str2})).setMessage(activity.getString(285802673, new Object[]{str2})).setPositiveButton(285802674, r0).setNegativeButton(285802668, r0).create().show();
        }

        private static void showConfirmDialog(Activity activity, OnClickListener onClickListener) {
            new Builder(activity).setCancelable(false).setIconAttribute(16843605).setTitle(285802670).setMessage(285802671).setPositiveButton(285802669, onClickListener).setNegativeButton(285802668, onClickListener).create().show();
        }
    ...
    public static class System extends android.provider.SystemSettings.System {
        ...
        static {
            int i = (Build.IS_CTA_BUILD || Build.IS_CM_CUSTOMIZATION_TEST || Build.IS_CU_CUSTOMIZATION_TEST || "mx_telcel".equals(SystemProperties.get("ro.miui.customized.region", ""))) ? 1 : 0;
        ...
        public static Rect getDisplayWindowSizeInSmartCover() {
            ...
            int[] iArr = {system.getInteger(285736975), system.getInteger(285736976), system.getInteger(285736977), system.getInteger(285736978)};
        ...
        public static String getScreenKeyLongPressAction(Context context, String str) {
            ...
            String str2 = "none";
            String[] stringArray = context.getResources().getStringArray(285605906);
    ...
    public static final class XSpace {
        ...
        public static int getAskType(Context context, String str) {
            try {
                ...
                if (str.equals(KEY_XSPACE_QQ_SEND_TO_FRIEND) || str.equals(KEY_XSPACE_QQ_SEND_TO_PC)) {
        ...
        public static String getSettingAppType(String str) {
            return PREKEY_XSPACE_WEIXIN_PAY.equals(str) ? KEY_WEIXIN_PAY : PREKEY_XSPACE_WEIXIN_SHARE.equals(str) ? KEY_WEIXIN_SHARE : PREKEY_XSPACE_WEIXIN_OPEN.equals(str) ? KEY_WEIXIN_OPEN : PREKEY_XSPACE_WEIBO_SEND.equals(str) ? KEY_WEIBO_SHARE : PREKEY_XSPACE_WEIBO_OPEN.equals(str) ? KEY_WEIBO_OPEN : PREKEY_XSPACE_QQ_SEND.equals(str) ? KEY_XSPACE_QQ_SEND : PREKEY_XSPACE_QQ_LOGIN.equals(str) ? KEY_XSPACE_QQ_LOGIN : PREKEY_XSPACE_QQ_OPEN.equals(str) ? KEY_XSPACE_QQ_OPEN : "";
        }
