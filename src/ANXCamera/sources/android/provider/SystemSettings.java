...
public class SystemSettings {
    ...
    public static class System {
        ...
        public static String getDeviceName(Context context) {
            String str = "";
            int i = FeatureParser.getBoolean("is_redmi", false) ? R.string.device_redmi : FeatureParser.getBoolean(d.tZ, false) ? R.string.device_hongmi : FeatureParser.getBoolean(d.tY, false) ? E10_DEVICE.equals(SystemProperties.get("ro.product.device")) ? SystemProperties.get("ro.boot.hwc", "").contains(INDIA) ? R.string.device_poco_india : R.string.device_poco_global : R.string.device_xiaomi : FeatureParser.getBoolean(d.ua, false) ? R.string.device_pad : R.string.miui_device_name;
