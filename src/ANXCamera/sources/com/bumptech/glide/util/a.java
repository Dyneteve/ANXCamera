...
public final class a {
    ...
    private static final AtomicReference<byte[]> qO = new AtomicReference<>();

    /* renamed from: com.bumptech.glide.util.a$a reason: collision with other inner class name */
    /* compiled from: ByteBufferUtil */
    private static class C0011a extends InputStream {
        private static final int UNSET = -1;
        @NonNull
        private final ByteBuffer byteBuffer;
        private int qP = -1;

        C0011a(@NonNull ByteBuffer byteBuffer2) {
        ...
        public synchronized void mark(int i) {
            this.qP = this.byteBuffer.position();
        }
        ...
        public synchronized void reset() throws IOException {
            if (this.qP != -1) {
                this.byteBuffer.position(this.qP);
            } else {
    ...
    public static void a(@NonNull ByteBuffer byteBuffer, @NonNull OutputStream outputStream) throws IOException {
        ...
        byte[] bArr = (byte[]) qO.getAndSet(null);
        if (bArr == null) {
            bArr = new byte[16384];
        }
    ...
    @NonNull
    public static ByteBuffer h(@NonNull InputStream inputStream) throws IOException {
