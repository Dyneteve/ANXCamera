...
public class l implements Callback {
    ...
    private static final String nj = "key";
    private static final a np = new a() {
        @NonNull
    ...
    private volatile i nk;
    private final a nl;
    private final ArrayMap<View, Fragment> nm = new ArrayMap<>();
    private final ArrayMap<View, android.app.Fragment> nn = new ArrayMap<>();
    private final Bundle no = new Bundle();
    @VisibleForTesting
    ...
    private android.app.Fragment a(@NonNull View view, @NonNull Activity activity) {
        this.nn.clear();
        a(activity.getFragmentManager(), this.nn);
        View findViewById = activity.findViewById(16908290);
        android.app.Fragment fragment = null;
        while (!view.equals(findViewById)) {
            fragment = (android.app.Fragment) this.nn.get(view);
    ...
    private Fragment a(@NonNull View view, @NonNull FragmentActivity fragmentActivity) {
        this.nm.clear();
        a((Collection<Fragment>) fragmentActivity.getSupportFragmentManager().getFragments(), (Map<View, Fragment>) this.nm);
        View findViewById = fragmentActivity.findViewById(16908290);
        Fragment fragment = null;
        while (!view.equals(findViewById)) {
            fragment = (Fragment) this.nm.get(view);
            if (fragment != null || !(view.getParent() instanceof View)) {
                break;
            }
            view = (View) view.getParent();
    ...
    private i a(@NonNull Context context, @NonNull FragmentManager fragmentManager, @Nullable android.app.Fragment fragment, boolean z) {
        ...
        i a3 = this.nl.a(c.c(context), a2.cX(), a2.cZ(), context);
        a2.c(a3);
        return a3;
    }
    ...
    private void b(@NonNull FragmentManager fragmentManager, @NonNull ArrayMap<View, android.app.Fragment> arrayMap) {
        ...
        while (true) {
            ...
            android.app.Fragment fragment = null;
            try {
                fragment = fragmentManager.getFragment(this.no, nj);
            } catch (Exception e) {
            }
            if (fragment != null) {
                if (fragment.getView() != null) {
    ...
    private i i(@NonNull Context context) {
        if (this.nk == null) {
            synchronized (this) {
                if (this.nk == null) {
                    this.nk = this.nl.a(c.c(context.getApplicationContext()), new b(), new g(), context.getApplicationContext());
                }
            }
        }
        return this.nk;
