...
public class n extends l<InputStream> {
    ...
    private static final UriMatcher em = new UriMatcher(-1);

    static {
        em.addURI("com.android.contacts", "contacts/lookup/*/#", 1);
        em.addURI("com.android.contacts", "contacts/lookup/*", 1);
        em.addURI("com.android.contacts", "contacts/#/photo", 2);
        em.addURI("com.android.contacts", "contacts/#", 3);
        em.addURI("com.android.contacts", "contacts/#/display_photo", 4);
        em.addURI("com.android.contacts", "phone_lookup/*", 5);
    }
