...
public class j implements d<InputStream> {
    ...
    private InputStream a(HttpURLConnection httpURLConnection) throws IOException {
        if (TextUtils.isEmpty(httpURLConnection.getContentEncoding())) {
            this.eb = com.bumptech.glide.util.b.a(httpURLConnection.getInputStream(), (long) httpURLConnection.getContentLength());
        } else {
            ...
            this.eb = httpURLConnection.getInputStream();
        }
        return this.eb;
    }
    ...
    private InputStream a(URL url, int i, URL url2, Map<String, String> map) throws IOException {
        if (i < 5) {
            ...
            this.urlConnection = this.ea.c(url);
            ...
            this.eb = this.urlConnection.getInputStream();
            if (this.ec) {
                return null;
            }
    ...
    public void a(@NonNull Priority priority, @NonNull com.bumptech.glide.load.a.d.a<? super InputStream> aVar) {
        ...
        long eK = e.eK();
        try {
            aVar.k(a(this.dZ.toURL(), 0, null, this.dZ.getHeaders()));
