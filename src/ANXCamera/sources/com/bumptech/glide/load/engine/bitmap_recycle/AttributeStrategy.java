...
class AttributeStrategy implements k {
    private final KeyPool hf = new KeyPool();
    ...
    public Bitmap b(int i, int i2, Config config) {
        return (Bitmap) this.hg.b(this.hf.f(i, i2, config));
    }

    public Bitmap bl() {
        return (Bitmap) this.hg.removeLast();
    }
    ...
    public void d(Bitmap bitmap) {
        this.hg.a(this.hf.f(bitmap.getWidth(), bitmap.getHeight(), bitmap.getConfig()), bitmap);
    }
