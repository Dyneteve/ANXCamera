...
public final class j implements h {
    ...
    private volatile Map<String, String> jP;

    /* compiled from: LazyHeaders */
    public static final class a {
        private static final String jQ = "User-Agent";
        private static final String jR = getSanitizedUserAgent();
        private static final Map<String, List<i>> jS;
        private Map<String, List<i>> headers = jS;
        ...
        static {
            ...
            if (!TextUtils.isEmpty(jR)) {
                hashMap.put("User-Agent", Collections.singletonList(new b(jR)));
            }
            jS = Collections.unmodifiableMap(hashMap);
        }
        ...
        public a a(String str, i iVar) {
            if (this.jU && "User-Agent".equalsIgnoreCase(str)) {
                return b(str, iVar);
            }
            ce();
            z(str).add(iVar);
    ...
    public Map<String, String> getHeaders() {
        if (this.jP == null) {
            synchronized (this) {
                if (this.jP == null) {
                    this.jP = Collections.unmodifiableMap(cd());
                }
            }
        }
        return this.jP;
