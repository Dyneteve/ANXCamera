...
public abstract class a<Model> implements m<Model, InputStream> {
    private final m<g, InputStream> lv;
    @Nullable
    private final ModelCache<Model, g> lw;
    ...
    public com.bumptech.glide.load.model.m.a<InputStream> b(@NonNull Model model, int i, int i2, @NonNull f fVar) {
        Object obj = this.lw != null ? (g) this.lw.c(model, i, i2) : null;
        if (obj == null) {
            ...
            if (this.lw != null) {
                this.lw.a(model, i, i2, gVar);
            }
            obj = gVar;
        }
        List d = d(model, i, i2, fVar);
        com.bumptech.glide.load.model.m.a<InputStream> b = this.lv.b(obj, i, i2, fVar);
        return (b == null || d.isEmpty()) ? b : new com.bumptech.glide.load.model.m.a<>(b.fK, a(d), b.kZ);
    }
