...
public abstract class a<Model> implements m<Model, InputStream> {
    private final m<g, InputStream> kw;
    @Nullable
    private final ModelCache<Model, g> kx;
    ...
    public com.bumptech.glide.load.model.m.a<InputStream> b(@NonNull Model model, int i, int i2, @NonNull f fVar) {
        Object obj = this.kx != null ? (g) this.kx.c(model, i, i2) : null;
        if (obj == null) {
            ...
            if (this.kx != null) {
                this.kx.a(model, i, i2, gVar);
            }
            obj = gVar;
        }
        List d = d(model, i, i2, fVar);
        com.bumptech.glide.load.model.m.a<InputStream> b = this.kw.b(obj, i, i2, fVar);
        return (b == null || d.isEmpty()) ? b : new com.bumptech.glide.load.model.m.a<>(b.eK, a(d), b.jZ);
    }
