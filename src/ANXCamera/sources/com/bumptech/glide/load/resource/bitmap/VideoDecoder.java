...
public class VideoDecoder<T> implements g<T, Bitmap> {
    ...
    public static final long lT = -1;
    public static final e<Long> lU = e.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", Long.valueOf(-1), new com.bumptech.glide.load.e.a<Long>() {
    ...
    public static final e<Integer> lV = e.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption", Integer.valueOf(2), new com.bumptech.glide.load.e.a<Integer>() {
    ...
    private static final MediaMetadataRetrieverFactory lW = new MediaMetadataRetrieverFactory();
    private final d am;
    private final MediaMetadataRetrieverInitializer<T> lX;
    private final MediaMetadataRetrieverFactory lY;
    ...
    VideoDecoder(d dVar, MediaMetadataRetrieverInitializer<T> mediaMetadataRetrieverInitializer) {
        this(dVar, mediaMetadataRetrieverInitializer, lW);
    }
    ...
    VideoDecoder(d dVar, MediaMetadataRetrieverInitializer<T> mediaMetadataRetrieverInitializer, MediaMetadataRetrieverFactory mediaMetadataRetrieverFactory) {
        this.am = dVar;
        this.lX = mediaMetadataRetrieverInitializer;
        this.lY = mediaMetadataRetrieverFactory;
    }
    ...
    private static Bitmap a(MediaMetadataRetriever mediaMetadataRetriever, long j, int i, int i2, int i3, DownsampleStrategy downsampleStrategy) {
        Bitmap b2 = (VERSION.SDK_INT < 27 || i2 == Integer.MIN_VALUE || i3 == Integer.MIN_VALUE || downsampleStrategy == DownsampleStrategy.li) ? null : b(mediaMetadataRetriever, j, i, i2, i3, downsampleStrategy);
    ...
    public p<Bitmap> a(@NonNull T t, int i, int i2, @NonNull f fVar) throws IOException {
        long longValue = ((Long) fVar.a(lU)).longValue();
        if (longValue >= 0 || longValue == -1) {
            Integer num = (Integer) fVar.a(lV);
            if (num == null) {
                num = Integer.valueOf(2);
            }
            DownsampleStrategy downsampleStrategy = (DownsampleStrategy) fVar.a(DownsampleStrategy.lk);
            if (downsampleStrategy == null) {
                downsampleStrategy = DownsampleStrategy.lj;
            }
            DownsampleStrategy downsampleStrategy2 = downsampleStrategy;
            MediaMetadataRetriever cB = this.lY.cB();
            try {
                this.lX.a(cB, t);
                Bitmap a2 = a(cB, longValue, num.intValue(), i, i2, downsampleStrategy2);
                cB.release();
                return f.a(a2, this.am);
