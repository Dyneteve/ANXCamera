...
public final class m implements ImageHeaderParser {
    ...
    private static final int kH = 4671814;
    private static final int kI = -1991225785;
    static final int kJ = 65496;
    private static final int kK = 19789;
    private static final int kL = 18761;
    private static final String kM = "Exif\u0000\u0000";
    static final byte[] kN = kM.getBytes(Charset.forName("UTF-8"));
    private static final int kO = 218;
    private static final int kP = 217;
    static final int kQ = 255;
    static final int kR = 225;
    private static final int kS = 274;
    private static final int[] kT = {0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};
    private static final int kU = 1380533830;
    private static final int kV = 1464156752;
    private static final int kW = 1448097792;
    private static final int kX = -256;
    private static final int kY = 255;
    ...
    private boolean a(byte[] bArr, int i) {
        boolean z = bArr != null && i > kN.length;
        if (!z) {
            return z;
        }
