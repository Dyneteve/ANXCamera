...
public final class n {
    ...
    private static final int dG = 10485760;
    public static final e<DecodeFormat> lo = e.a("com.bumptech.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.f0do);
    @Deprecated
    public static final e<DownsampleStrategy> lp = DownsampleStrategy.lk;
    public static final e<Boolean> lq = e.a("com.bumptech.glide.load.resource.bitmap.Downsampler.FixBitmapSize", Boolean.valueOf(false));
    public static final e<Boolean> lr = e.q("com.bumtpech.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode");
    private static final String ls = "image/vnd.wap.wbmp";
    private static final String lt = "image/x-ico";
    private static final Set<String> lu = Collections.unmodifiableSet(new HashSet(Arrays.asList(new String[]{ls, lt})));
    ...
    private static final Set<ImageType> lw = Collections.unmodifiableSet(EnumSet.of(ImageType.JPEG, ImageType.PNG_A, ImageType.PNG));
    private static final Queue<Options> lx = k.Y(0);
    private final d am;
    private final b ef;
    private final List<ImageHeaderParser> ew;
    private final DisplayMetrics iE;
    private final r ly = r.cv();
    ...
    public n(List<ImageHeaderParser> list, DisplayMetrics displayMetrics, d dVar, b bVar) {
        this.ew = list;
        this.iE = (DisplayMetrics) i.checkNotNull(displayMetrics);
        this.am = (d) i.checkNotNull(dVar);
        this.ef = (b) i.checkNotNull(bVar);
    }
    ...
    private Bitmap a(InputStream inputStream, Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, boolean z, int i, int i2, boolean z2, a aVar) throws IOException {
        ...
        int[] a2 = a(inputStream2, options2, aVar2, this.am);
        boolean z3 = false;
        int i6 = a2[0];
        int i7 = a2[1];
        String str = options2.outMimeType;
        boolean z4 = (i6 == -1 || i7 == -1) ? false : z;
        int b = com.bumptech.glide.load.b.b(this.ew, inputStream2, this.ef);
        int E = w.E(b);
        boolean F = w.F(b);
        int i8 = i;
        ...
        ImageType a3 = com.bumptech.glide.load.b.a(this.ew, inputStream2, this.ef);
        ImageType imageType = a3;
        a(a3, inputStream2, aVar2, this.am, downsampleStrategy, E, i6, i7, i9, i11, options2);
        int i12 = b;
        String str2 = str;
        int i13 = i7;
        int i14 = i6;
        ...
        if ((options3.inSampleSize == 1 || z3) && a(imageType)) {
            ...
            if (i5 > 0 && i4 > 0) {
                a(options3, this.am, i5, i4);
            }
        }
        Bitmap b2 = b(inputStream, options3, aVar3, this.am);
        aVar3.a(this.am, b2);
        if (Log.isLoggable(TAG, 2)) {
            i3 = i12;
        ...
        Bitmap bitmap = null;
        if (b2 != null) {
            b2.setDensity(this.iE.densityDpi);
            bitmap = w.a(this.am, b2, i3);
            if (!b2.equals(bitmap)) {
                this.am.d(b2);
            }
        }
    ...
    private static void a(ImageType imageType, InputStream inputStream, a aVar, d dVar, DownsampleStrategy downsampleStrategy, int i, int i2, int i3, int i4, int i5, Options options) throws IOException {
        ...
        if (a2 > 0.0f) {
            ...
            if (b != null) {
                ...
                if (VERSION.SDK_INT > 23 || !lu.contains(options2.outMimeType)) {
    ...
    private void a(InputStream inputStream, DecodeFormat decodeFormat, boolean z, boolean z2, Options options, int i, int i2) {
        boolean z3;
        if (!this.ly.a(i, i2, options, decodeFormat, z, z2)) {
            ...
            try {
                z3 = com.bumptech.glide.load.b.a(this.ew, inputStream, this.ef).hasAlpha();
            } catch (IOException e) {
                if (Log.isLoggable(TAG, 3)) {
                    String str = TAG;
                    StringBuilder sb = new StringBuilder();
    ...
    public p<Bitmap> a(InputStream inputStream, int i, int i2, f fVar) throws IOException {
        return a(inputStream, i, i2, fVar, lv);
    }
    ...
    public p<Bitmap> a(InputStream inputStream, int i, int i2, f fVar, a aVar) throws IOException {
        ...
        DecodeFormat decodeFormat = (DecodeFormat) fVar2.a(lo);
        DownsampleStrategy downsampleStrategy = (DownsampleStrategy) fVar2.a(DownsampleStrategy.lk);
        boolean booleanValue = ((Boolean) fVar2.a(lq)).booleanValue();
        boolean z = fVar2.a(lr) != null && ((Boolean) fVar2.a(lr)).booleanValue();
        try {
            return f.a(a(inputStream, cs, downsampleStrategy, decodeFormat, decodeFormat == DecodeFormat.PREFER_ARGB_8888_DISALLOW_HARDWARE ? false : z, i, i2, booleanValue, aVar), this.am);
        } finally {
            c(cs);
            this.ef.put(bArr);
        }
