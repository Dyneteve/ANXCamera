...
public class e implements h<Bitmap> {
    ...
    public static final com.bumptech.glide.load.e<Integer> lC = com.bumptech.glide.load.e.a("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", Integer.valueOf(90));
    public static final com.bumptech.glide.load.e<CompressFormat> lD = com.bumptech.glide.load.e.q("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");
    @Nullable
    private final b br;
    ...
    private CompressFormat a(Bitmap bitmap, f fVar) {
        CompressFormat compressFormat = (CompressFormat) fVar.a(lD);
    ...
    public boolean a(@NonNull p<Bitmap> pVar, @NonNull File file, @NonNull f fVar) {
        ...
        try {
            ...
            int intValue = ((Integer) fVar.a(lC)).intValue();
            boolean z = false;
            OutputStream outputStream = null;
            try {
                FileOutputStream fileOutputStream = new FileOutputStream(file);
                try {
                    outputStream = this.br != null ? new c(fileOutputStream, this.br) : fileOutputStream;
