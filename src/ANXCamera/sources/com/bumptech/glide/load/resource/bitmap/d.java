...
public class d implements i<BitmapDrawable> {
    private final i<Drawable> lB;

    public d(i<Bitmap> iVar) {
        this.lB = (i) com.bumptech.glide.util.i.checkNotNull(new p(iVar, false));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.lB.equals(((d) obj).lB);
    }
    ...
    public p<BitmapDrawable> transform(@NonNull Context context, @NonNull p<BitmapDrawable> pVar, int i, int i2) {
        return j(this.lB.transform(context, k(pVar), i, i2));
    }
