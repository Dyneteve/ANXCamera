...
public class a {
    private final List<C0002a<?>> nx = new ArrayList();
    ...
    private static final class C0002a<T> {
        ...
        final com.bumptech.glide.load.a<T> eP;
