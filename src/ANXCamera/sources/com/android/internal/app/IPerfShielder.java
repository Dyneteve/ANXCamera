...
public interface IPerfShielder extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPerfShielder {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            MiuiServicePriority miuiServicePriority;
            boolean z;
            MiuiServicePriority miuiServicePriority2;
            MiuiServicePriority miuiServicePriority3;
            MiuiServicePriority miuiServicePriority4;
            MiuiServicePriority miuiServicePriority5;
            MiuiServicePriority miuiServicePriority6;
            MiuiServicePriority miuiServicePriority7;
            MiuiServicePriority miuiServicePriority8;
            MiuiServicePriority miuiServicePriority9;
            MiuiServicePriority miuiServicePriority10;
            int i3 = i;
            ...
            if (i3 != 1598968902) {
                boolean z2 = false;
                MiuiServicePriority miuiServicePriority11 = null;
                switch (i3) {
                    case 1:
                    ...
                    case 20:
                        ...
                        if (parcel.readInt() != 0) {
                            miuiServicePriority2 = (Bundle) Bundle.CREATOR.createFromParcel(parcel3);
                        }
                        boolean insertRedirectRule = insertRedirectRule(readString, readString2, readString3, miuiServicePriority2);
                        parcel2.writeNoException();
                    ...
                    case 22:
                        parcel3.enforceInterface(str);
                        if (parcel.readInt() != 0) {
                            miuiServicePriority3 = (PackageInfo) PackageInfo.CREATOR.createFromParcel(parcel3);
                        }
                        boolean insertPackageInfo = insertPackageInfo(miuiServicePriority3);
                        parcel2.writeNoException();
                    ...
                    case 29:
                        ...
                        if (parcel.readInt() != 0) {
                            miuiServicePriority4 = (E2EScenarioPayload) E2EScenarioPayload.CREATOR.createFromParcel(parcel3);
                        }
                        Bundle beginScenario = beginScenario(e2EScenario, e2EScenarioSettings, readString4, miuiServicePriority4, parcel.readInt(), parcel.readLong(), parcel.readInt() != 0);
                        parcel2.writeNoException();
                    ...
                    case 30:
                        parcel3.enforceInterface(str);
                        if (parcel.readInt() != 0) {
                            miuiServicePriority5 = (E2EScenario) E2EScenario.CREATOR.createFromParcel(parcel3);
                        }
                        abortMatchingScenario(miuiServicePriority5, parcel.readString(), parcel.readInt(), parcel.readLong());
                        parcel2.writeNoException();
                        return true;
                    case 31:
                        parcel3.enforceInterface(str);
                        if (parcel.readInt() != 0) {
                            miuiServicePriority6 = (Bundle) Bundle.CREATOR.createFromParcel(parcel3);
                        }
                        abortSpecificScenario(miuiServicePriority6, parcel.readInt(), parcel.readLong());
                        parcel2.writeNoException();
                        return true;
                    case 32:
                        parcel3.enforceInterface(str);
                        ...
                        if (parcel.readInt() != 0) {
                            miuiServicePriority7 = (E2EScenarioPayload) E2EScenarioPayload.CREATOR.createFromParcel(parcel3);
                        }
                        finishMatchingScenario(e2EScenario2, readString5, miuiServicePriority7, parcel.readInt(), parcel.readLong());
                        parcel2.writeNoException();
                        return true;
                    case 33:
                        parcel3.enforceInterface(str);
                        ...
                        if (parcel.readInt() != 0) {
                            miuiServicePriority8 = (E2EScenarioPayload) E2EScenarioPayload.CREATOR.createFromParcel(parcel3);
                        }
                        finishSpecificScenario(bundle, miuiServicePriority8, parcel.readInt(), parcel.readLong());
                        parcel2.writeNoException();
                        return true;
                    case 34:
                        parcel3.enforceInterface(str);
                    ...
                    case 35:
                        ...
                        if (parcel.readInt() != 0) {
                            miuiServicePriority9 = (Intent) Intent.CREATOR.createFromParcel(parcel3);
                        }
                        reportNotificationClick(readString6, miuiServicePriority9, parcel.readLong());
                        return true;
                    case 36:
                        parcel3.enforceInterface(str);
                        ...
                        if (parcel.readInt() != 0) {
                            miuiServicePriority10 = (Uri) Uri.CREATOR.createFromParcel(parcel3);
                        }
                        boolean insertFilterInfo = insertFilterInfo(readString7, readString8, miuiServicePriority10, parcel3.createTypedArrayList(Bundle.CREATOR));
                        parcel2.writeNoException();
                    ...
                    case 38:
                        parcel3.enforceInterface(str);
                        if (parcel.readInt() != 0) {
                            miuiServicePriority11 = (Intent) Intent.CREATOR.createFromParcel(parcel3);
                        }
                        List resolveQuickAppInfos = resolveQuickAppInfos(miuiServicePriority11);
                        parcel2.writeNoException();
                    ...
                    case 39:
                        ...
                        if (parcel.readInt() != 0) {
                            miuiServicePriority11 = (ActivityInfo) ActivityInfo.CREATOR.createFromParcel(parcel3);
                        }
                        setHapLinks(readHashMap, miuiServicePriority11);
                        return true;
                    default:
