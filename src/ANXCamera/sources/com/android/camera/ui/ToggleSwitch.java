...
public class ToggleSwitch extends CompoundButton implements Checkable {
    ...
    private float[] compThumbRoundRectAttr(float f) {
        ...
        float f2 = (((float) (this.mThumbPadding + this.mStrokeWidth)) * (1.0f - f)) + (((((float) this.mThumbPadding) / 2.0f) + width) * f);
        float f3 = (float) (this.mThumbPadding + this.mStrokeWidth);
        float height = (((float) (getHeight() - (this.mThumbPadding * 2))) + f3) - ((float) (this.mStrokeWidth * 2));
        return new float[]{f2, f3, ((width - ((float) this.mStrokeWidth)) - ((((float) this.mThumbPadding) * 3.0f) / 2.0f)) + f2, height, (height - f3) * 0.5f};
    }
