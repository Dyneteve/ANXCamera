...
public class ZoomRatioToggleView extends ViewGroup implements OnClickListener, OnLongClickListener {
    ...
    private int mColor;
    private int mCurrentSelectdStandaloneMacroIndex;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public boolean mIsStandaloneMacro;
    /* access modifiers changed from: private */
    ...
    public ZoomRatioToggleView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCurrentSelectdStandaloneMacroIndex = HybridZoomingSystem.getDefaultStandaloneMacroOpticalZoomRatioIndex();
        this.mZoomRatio = HybridZoomingSystem.getOpticalZoomRatioAt(this.mCurrentSelectedChildIndex);
        this.mIsStandaloneMacro = false;
        this.mScaleX = 1.0f;
        this.mScaleY = 1.0f;
        ...
        this.mIndexUpdater = new Runnable() {
            public void run() {
                int standaloneMacroOpticalZoomRatioIndex = ZoomRatioToggleView.this.mIsStandaloneMacro ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioIndex(ZoomRatioToggleView.this.mZoomRatio) : HybridZoomingSystem.getOpticalZoomRatioIndex(ZoomRatioToggleView.this.mZoomRatio);
                if (ZoomRatioToggleView.this.isAnimating()) {
                    String str = ZoomRatioToggleView.TAG;
                    StringBuilder sb = new StringBuilder();
                    sb.append("postpone index updater again: ");
                    sb.append(standaloneMacroOpticalZoomRatioIndex);
                ...
                ZoomRatioToggleView.this.setSelectedChildIndex(standaloneMacroOpticalZoomRatioIndex, false);
                String str2 = ZoomRatioToggleView.TAG;
                StringBuilder sb2 = new StringBuilder();
                sb2.append("run index updater: ");
                sb2.append(standaloneMacroOpticalZoomRatioIndex);
            ...
            AnonymousClass3 r0 = new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (zoomRatioView2 != null) {
                        int zoomRatioIndex = zoomRatioView2.getZoomRatioIndex();
                        zoomRatioView2.setZoomRatio(ZoomRatioToggleView.this.mIsStandaloneMacro ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioAt(zoomRatioIndex) : HybridZoomingSystem.getOpticalZoomRatioAt(zoomRatioIndex));
                    }
                ...
                public void onAnimationStart(Animator animator) {
                    ...
                    if (zoomRatioView3 != null) {
                        ...
                        if (i5 == 1) {
                            float standaloneMacroOpticalZoomRatioAt = ZoomRatioToggleView.this.mIsStandaloneMacro ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioAt(zoomRatioIndex) : HybridZoomingSystem.getOpticalZoomRatioAt(zoomRatioIndex);
                            String str = ZoomRatioToggleView.TAG;
                            StringBuilder sb = new StringBuilder();
                            sb.append("onAnimationStart(): click, set zoom ratio to ");
                            sb.append(standaloneMacroOpticalZoomRatioAt);
                            ZoomRatioToggleView.debugUi(str, sb.toString());
                            zoomRatioView3.setZoomRatio(standaloneMacroOpticalZoomRatioAt);
                        } else if (i5 != 2) {
                            String str2 = ZoomRatioToggleView.TAG;
                            StringBuilder sb2 = new StringBuilder();
            ...
            this.mLongPressRunnable = new Runnable() {
                public void run() {
                    if (ZoomRatioToggleView.this.mTouchState == 1) {
                        int access$900 = ZoomRatioToggleView.this.getContainingChildIndex(ZoomRatioToggleView.this.mTouchStartX, ZoomRatioToggleView.this.mTouchStartY);
                        if (access$900 != -1) {
                            ZoomRatioToggleView.this.longClickChild(access$900);
                        }
                    }
                }
            };
    ...
    public void onDatasetChange(boolean z) {
        this.mIsStandaloneMacro = z;
        int length = (z ? HybridZoomingSystem.getStandaloneMacroSupportedOpticalZoomRatios() : HybridZoomingSystem.getSupportedOpticalZoomRatios()).length;
        if (length > 0) {
            int defaultStandaloneMacroOpticalZoomRatioIndex = z ? HybridZoomingSystem.getDefaultStandaloneMacroOpticalZoomRatioIndex() : HybridZoomingSystem.getDefaultOpticalZoomRatioIndex();
            if (length != getChildCount()) {
                ...
                while (i < length) {
                    ...
                    zoomRatioView.setZoomRatio(z ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioAt(i) : HybridZoomingSystem.getOpticalZoomRatioAt(i));
                    zoomRatioView.setZoomRatioIndex(i);
                    zoomRatioView.setIconify(i != defaultStandaloneMacroOpticalZoomRatioIndex);
                    addView(zoomRatioView, new LayoutParams(-2, -2));
                    i++;
                }
            }
            this.mCurrentSelectedChildIndex = defaultStandaloneMacroOpticalZoomRatioIndex;
            this.mZoomRatio = z ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioAt(defaultStandaloneMacroOpticalZoomRatioIndex) : HybridZoomingSystem.getOpticalZoomRatioAt(defaultStandaloneMacroOpticalZoomRatioIndex);
        }
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int childCount = getChildCount();
        if (childCount > 0) {
            int defaultStandaloneMacroOpticalZoomRatioIndex = this.mIsStandaloneMacro ? HybridZoomingSystem.getDefaultStandaloneMacroOpticalZoomRatioIndex() : HybridZoomingSystem.getDefaultOpticalZoomRatioIndex();
            boolean isLayoutRTL = isLayoutRTL();
            int width = !isLayoutRTL ? ((getWidth() / 2) - (this.mItemWidth / 2)) - (defaultStandaloneMacroOpticalZoomRatioIndex * this.mItemWidth) : ((getWidth() / 2) - (this.mItemWidth / 2)) + (defaultStandaloneMacroOpticalZoomRatioIndex * this.mItemWidth);
    ...
    public void setImmersive(boolean z) {
        ...
        if (this.mIsImmersive) {
            ...
            setSelectedChildIndex(this.mIsStandaloneMacro ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioIndex(this.mZoomRatio) : HybridZoomingSystem.getOpticalZoomRatioIndex(this.mZoomRatio), true);
            if (isEnabled()) {
    ...
    public void setZoomRatio(float f, int i) {
        if (Thread.currentThread().equals(Looper.getMainLooper().getThread())) {
            int standaloneMacroOpticalZoomRatioIndex = this.mIsStandaloneMacro ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioIndex(f) : HybridZoomingSystem.getOpticalZoomRatioIndex(f);
            String str = TAG;
            StringBuilder sb = new StringBuilder();
            ...
            sb4.append(standaloneMacroOpticalZoomRatioIndex);
            debugUi(str4, sb4.toString());
            String str5 = TAG;
