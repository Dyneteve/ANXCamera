...
public class EdgeHorizonScrollView extends HorizontalScrollView {
    ...
    public void initView() {
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, (float) this.mEdgeWidth, new int[]{-16777216, -1728053248, 0}, new float[]{0.0f, 0.2f, 1.0f}, TileMode.CLAMP);
