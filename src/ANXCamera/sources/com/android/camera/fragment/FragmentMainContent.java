...
public class FragmentMainContent extends BaseFragment implements AutoZoomViewProtocol, HandleBackTrace, MainContentProtocol, SnapShotIndicator {
    ...
    public static /* synthetic */ void lambda$updateMimojiFaceDetectResultTip$0(FragmentMainContent fragmentMainContent, boolean z) {
        ...
        if (mimojiAvatarEngine != null) {
            mimojiAvatarEngine.setDetectSuccess(fragmentMainContent.lastFaceSuccess);
            BottomPopupTips bottomPopupTips = (BottomPopupTips) ModeCoordinatorImpl.getInstance().getAttachProtocol(175);
            if (fragmentMainContent.lastFaceSuccess && !z) {
        ...
        } else if (fragmentMainContent.mMimojiLastFaceSuccess != fragmentMainContent.lastFaceSuccess) {
            fragmentMainContent.mMimojiLightingView.triggerAnimateFocusing();
        } else {
            return;
        }
        fragmentMainContent.mMimojiLastFaceSuccess = fragmentMainContent.lastFaceSuccess;
    }

    /* access modifiers changed from: private */
    public void mimojiFaceDetectSync(int i, int i2) {
        if (MimojiHelper.getTipsResIdFace(i2) == -1 && MimojiHelper.getTipsResId(i2) == -1 && i != 6) {
            String str = TAG;
            StringBuilder sb = new StringBuilder();
            sb.append("mimojiFaceDetectSync Error 1, faceResult = ");
            sb.append(i2);
            Log.e(str, sb.toString());
        } else if (i2 == this.mMimojiFaceDetect && i == this.mMimojiDetectTipType) {
            String str2 = TAG;
            StringBuilder sb2 = new StringBuilder();
            sb2.append("mimojiFaceDetectSync, Error 2, faceResult = ");
            sb2.append(i2);
            ...
            if (i2 == 6 && MimojiHelper.getTipsResId(this.mCurrentMimojiFaceResult) == -1) {
                this.lastFaceSuccess = true;
            } else {
                this.lastFaceSuccess = false;
            }
            StringBuilder sb3 = new StringBuilder();
            sb3.append("face_detect_type:");
            sb3.append(i);
            sb3.append(",result:");
            sb3.append(i2);
            sb3.append(",is_face_location_ok:");
            sb3.append(this.lastFaceSuccess);
            Log.d("mimojiFaceDetectSync", sb3.toString());
        }
    }
