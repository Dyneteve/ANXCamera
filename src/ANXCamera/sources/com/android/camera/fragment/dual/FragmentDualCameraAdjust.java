...
import com.android.camera.protocol.ModeProtocol.OnOpticalZoomRatioChangeProtocol;
...
public class FragmentDualCameraAdjust extends BaseFragment implements ManuallyListener, DualController, HandleBackTrace, OnOpticalZoomRatioChangeProtocol, SnapShotIndicator, ToggleStateListener {
    ...
    private static ViewSpec getViewSpecForCapturingMode(int i) {
        ...
        int i4 = -1;
        boolean z6 = true;
        if (DataRepository.dataItemGlobal().getCurrentCameraId() != 1 && ((!CameraSettings.isMacroModeEnabled(i) || DataRepository.dataItemFeature().hu()) && !CameraSettings.isAutoZoomEnabled(i) && HybridZoomingSystem.IS_2_OR_MORE_SAT)) {
            if (i == 161) {
                ...
                if (!HybridZoomingSystem.IS_2_SAT) {
                    ...
                    if ((miBeautyProtocol == null || !miBeautyProtocol.isBeautyPanelShow()) && ((!CameraSettings.isMacroModeEnabled(i) && !CameraSettings.isUltraWideConfigOpen(i)) || DataRepository.dataItemFeature().hu())) {
                        i3 = 1;
                        z2 = i2 != -1;
                        if (i2 != -1) {
                            z6 = false;
                ...
                if (i == 163) {
                    if ((!CameraSettings.isMacroModeEnabled(i) && !CameraSettings.isUltraWideConfigOpen(i) && !CameraSettings.isUltraPixelRearOn()) || DataRepository.dataItemFeature().hu()) {
                        i4 = 1;
                    }
                    ...
                    return new ViewSpec(i4, z2, z, z5);
                } else if (i == 166 && DataRepository.dataItemFeature().gB()) {
                    i4 = 1;
                }
                boolean z7 = z4;
                z2 = z3;
    ...
    private void initiateZoomRatio() {
        if (CameraSettings.isZoomByCameraSwitchingSupported()) {
            ...
            sb7.append("initiateZoomRatio(): real-sat-zoom: ");
            ...
            sb8.append("initiateZoomRatio(): fake-sat-zoom: ");
    ...
    public boolean isZoomVisible() {
        return (!CameraSettings.isMacroModeEnabled(this.mCurrentMode) || DataRepository.dataItemFeature().hu()) && this.mCurrentState == 1 && this.mZoomRatioToggleView.getVisibility() == 0;
    }
    ...
    public void onClick(ZoomRatioView zoomRatioView) {
        ...
        if (!isSlideVisible()) {
            ...
            if (this.mZoomRatioToggleView.isSuppressed()) {
                ...
                float standaloneMacroOpticalZoomRatioAt = this.mIsStandaloneMacroMode ? HybridZoomingSystem.getStandaloneMacroOpticalZoomRatioAt(zoomRatioIndex) : HybridZoomingSystem.getOpticalZoomRatioAt(zoomRatioIndex);
                CameraStatUtil.trackDualZoomChanged(this.mCurrentMode, HybridZoomingSystem.toString(standaloneMacroOpticalZoomRatioAt));
                this.mIsZoomTo2X = false;
                this.mZoomRatioToggleAnimator.setFloatValues(new float[]{this.mZoomRatio, standaloneMacroOpticalZoomRatioAt});
                this.mZoomRatioToggleAnimator.start();
            }
        }
        onBackEvent(5);
    ...
    public void onOpticalZoomRatioUpdate(boolean z) {
        this.mZoomRatioToggleView.onDatasetChange(z);
        this.mIsStandaloneMacroMode = z;
    }
    ...
    public void provideAnimateElement(int i, List<Completable> list, int i2) {
        ...
        if (isMacroModeEnabled != this.mIsStandaloneMacroMode && DataRepository.dataItemFeature().hu()) {
            this.mZoomRatioToggleView.onDatasetChange(isMacroModeEnabled);
    ...
    public void register(ModeCoordinator modeCoordinator) {
        ...
        if (DataRepository.dataItemFeature().hu()) {
            modeCoordinator.attachProtocol(203, this);
        }
    }
    ...
    public void unRegister(ModeCoordinator modeCoordinator) {
        ...
        if (DataRepository.dataItemFeature().hu()) {
            modeCoordinator.detachProtocol(203, this);
        }
    }
