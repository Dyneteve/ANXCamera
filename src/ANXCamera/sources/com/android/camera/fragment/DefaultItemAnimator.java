...
public class DefaultItemAnimator extends ItemAnimator {
    ...
    public void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            duration.setListener(new VpaListenerAdapter() {
                public void onAnimationEnd(View view) {
            ...
            final ViewPropertyAnimatorCompat duration2 = ViewCompat.animate(view2).setDuration(0);
            duration2.alpha(0.0f).setListener(new VpaListenerAdapter() {
                public void onAnimationEnd(View view) {
    ...
    public boolean animateChange(ViewHolder viewHolder, ViewHolder viewHolder2, int i, int i2, int i3, int i4) {
        ...
        ChangeInfo changeInfo = new ChangeInfo(viewHolder3, viewHolder4, i, i2, i3, i4);
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                if (z) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, r5, getRemoveDuration());
                } else {
                    r5.run();
                }
            }
            if (z3) {
                ...
                if (z) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList2.get(0)).oldHolder.itemView, r2, getRemoveDuration());
                } else {
                    r2.run();
                }
            }
            if (z4) {
                ...
                if (z) {
                    ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList3.get(0)).itemView, r22, getRemoveDuration());
                } else {
                    r22.run();
                }
            }
