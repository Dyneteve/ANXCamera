...
public class FragmentTopAlert extends BaseFragment {
    ...
    public static /* synthetic */ void lambda$showCloseConfirm$8(FragmentTopAlert fragmentTopAlert, DialogInterface dialogInterface, int i) {
    ...
    static /* synthetic */ void lambda$showCloseConfirm$9(DialogInterface dialogInterface, int i) {
    }

    public static /* synthetic */ void lambda$updateStateText$7(FragmentTopAlert fragmentTopAlert) {
    ...
    public void showCloseConfirm() {
        ...
        builder.setPositiveButton(R.string.live_music_close_sure_message, new OnClickListener() {
            public final void onClick(DialogInterface dialogInterface, int i) {
                FragmentTopAlert.lambda$showCloseConfirm$8(FragmentTopAlert.this, dialogInterface, i);
            }
        });
        builder.setNegativeButton(R.string.live_music_close_cancel_message, $$Lambda$FragmentTopAlert$R85sxA5fmtNdqOQNEyXX3hCG3B0.INSTANCE);
        builder.show();
    }
            ...
            if (this.mTopTipLayout.indexOfChild(this.mZoomTip) == -1 || this.mZoomTip.getVisibility() != 0) {
                ...
                if (!z || !isLandScape()) {
                    addViewToTipLayout(this.mZoomTip, new Runnable() {
                        ...
                        public final void run() {
                            FragmentTopAlert.lambda$updateStateText$7(FragmentTopAlert.this);
                        }
                    });
                }
            }
    ...
    public void alertFlash(int i, boolean z) {
        ...
        if (i == 0) {
            ...
            if (this.mAlertImageType != i2) {
                ...
                if (CameraSettings.isFrontCamera() && b.iq()) {
                    z = false;
                }
    ...
    public void updateLyingDirectHint(boolean z, boolean z2) {
        ...
        if (this.mIsShowTopLyingDirectHint && this.mTopTipLayout.indexOfChild(this.mLyingDirectHintText) == -1) {
            addViewToTipLayout(this.mLyingDirectHintText, new Runnable() {
                public final void run() {
                    FragmentTopAlert.this.mTopTipLayout.setLayoutTransition(null);
                }
            }, $$Lambda$FragmentTopAlert$Xrm_hKnVP2W969y_W2pasM_2YI.INSTANCE);
        } else if (!this.mIsShowTopLyingDirectHint && this.mTopTipLayout.indexOfChild(this.mLyingDirectHintText) != -1) {
