...
public class FragmentFullScreen extends BaseFragment implements OnClickListener, FullScreenProtocol, HandleBackTrace, Consumer<Pair<String, String>> {
    ...
    private void showShareSheet() {
        ...
        if (arrayList.isEmpty()) {
            ...
            ShareInfo shareInfo2 = new ShareInfo(length + 1, "com.oneplus.camera", "more", R.drawable.ic_live_share_more, R.string.accessibility_more);
        ...
        if (this.mConcatDisposable == null || this.mConcatDisposable.isDisposed()) {
            ...
            this.mConcatDisposable = Single.create(new SingleOnSubscribe<Pair<String, String>>() {
                public void subscribe(SingleEmitter<Pair<String, String>> singleEmitter) throws Exception {
                    ...
                    boolean z = liveConfigChanges != null && liveConfigChanges.onRecordConcat();
                    if (!z) {
    ...
    public void notifyAfterFrameAvailable(int i) {
        ...
        if (this.mFragmentMimojiEdit == null && DataRepository.dataItemFeature().fP()) {
    ...
    public void onClick(View view) {
        if (this.mConcatProgress.getVisibility() != 0 && this.mCombineProgress.getVisibility() != 0 && this.mShareProgress.getVisibility() != 0) {
            switch (view.getId()) {
                case R.id.live_preview_layout /*2131558520*/:
                    pausePlay();
                    break;
                case R.id.live_preview_play /*2131558521*/:
                ...
                case R.id.live_preview_back /*2131558526*/:
                    showExitConfirm();
                    break;
                case R.id.live_preview_save_circle /*2131558527*/:
                case R.id.live_preview_save /*2131558528*/:
                ...
                case R.id.live_preview_share /*2131558530*/:
                    ...
                    break;
                case R.id.live_share_cancel /*2131558534*/:
                    hideShareSheet();
                    break;
                case R.id.live_share_item /*2131558535*/:
