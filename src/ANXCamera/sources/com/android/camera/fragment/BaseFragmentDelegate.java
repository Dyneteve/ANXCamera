...
public class BaseFragmentDelegate implements BaseDelegate {
    public static final int BEAUTY_FRAGMENT_CONTAINER_ID = 2131623977;
    public static final int EYE_LIGHT_POPU_TIP_FRAGMENT_CONTAINER_ID = 2131624240;
    ...
    public static final int MAKE_UP_POPU_FRAGMENT_CONTAINER_ID = 2131624239;
        ...
        switch (i) {
            ...
            case 6:
                if (getActiveFragment(R.id.bottom_action) == 4083) {
                    ...
                    if (b.isSupportedOpticalZoom() || b.iS() || HybridZoomingSystem.IS_3_OR_MORE_SAT) {
    ...
    public void init(FragmentManager fragmentManager, int i, BaseLifecycleListener baseLifecycleListener) {
        ...
        BaseFragment baseFragment = (b.isSupportedOpticalZoom() || HybridZoomingSystem.IS_3_OR_MORE_SAT) ? constructFragment(true, 4084, 240, baseLifecycleListener2) : b.iS() ? constructFragment(true, 4085, 240, baseLifecycleListener2) : null;
        if (baseFragment != null) {
