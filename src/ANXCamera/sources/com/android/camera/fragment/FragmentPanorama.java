...
public class FragmentPanorama extends BaseFragment implements OnClickListener, RequestRenderListener, PanoramaProtocol {
    ...
    public void initView(View view) {
        ...
        if (Util.isNotchDevice || Util.sIsnotchScreenHidden) {
    ...
    public void moveToDirection(int i) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.mIndicator, "translationX", new float[]{this.mIndicator.getTranslationX(), translationX});
        ofFloat.setDuration(500);
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.mPanoramaArrowAnimateDrawable, "transformationRatio", new float[]{this.mPanoramaArrowAnimateDrawable.getTransformationRatio(), transformationRatio});
        ofFloat2.setDuration(500);
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.mStillPreview, "alpha", new float[]{this.mStillPreview.getAlpha(), 0.0f});
