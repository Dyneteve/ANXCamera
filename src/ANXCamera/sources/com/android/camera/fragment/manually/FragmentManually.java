        ...
        if (isEnableClick()) {
            ...
            if (manuallyValueChanged != null) {
                switch (componentData.getDisplayTitleString()) {
                    case R.string.pref_camera_whitebalance_title /*2131296358*/:
