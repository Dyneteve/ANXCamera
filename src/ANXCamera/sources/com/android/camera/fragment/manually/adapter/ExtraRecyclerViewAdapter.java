...
public class ExtraRecyclerViewAdapter extends Adapter<CommonRecyclerViewHolder> implements OnClickListener {
    ...
    public boolean couldNewValueTakeEffect(String str) {
        return str != null && !str.equals(this.mCurrentValue);
    }
    ...
    public void onBindViewHolder(CommonRecyclerViewHolder commonRecyclerViewHolder, int i) {
        ...
        int i2 = str.equals(this.mCurrentValue) ? ColorConstant.COLOR_COMMON_SELECTED : ColorConstant.COLOR_COMMON_NORMAL;
