...
public class FragmentBottomAction extends BaseFragment implements OnClickListener, ActionProcessing, BottomMenuProtocol, HandleBackTrace, HandleBeautyRecording, HandlerSwitcher, ModeChangeController, SnapListener, onModeClickedListener {
                ...
                default:
                    switch (i4) {
                        ...
                        case 177:
                            ...
                            break;
                        default:
                            if (this.mCurrentMode == 163 || this.mCurrentMode == 165) {
    ...
    private boolean isFPS960() {
        if (this.mCurrentMode != 172 || !DataRepository.dataItemFeature().gg()) {
            return false;
        }
    ...
    private void updateBottomInRecording(final boolean z, boolean z2) {
        ...
        if (i != 162) {
            ...
            if (!b.hO() || CameraSettings.isVideoBokehOn()) {
                z3 = false;
            }
...
EDGE_INSN: B:27:0x004a->B:17:0x004a ?: BREAK  , SYNTHETIC] */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0044, code lost:
        if (r5 == 163) goto L_0x004a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0048, code lost:
        if (r5 != 165) goto L_0x0056;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x004a, code lost:
        r5 = com.android.camera.data.DataRepository.dataItemConfig().getComponentConfigRatio().getMappingModeByRatio(163);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x005a, code lost:
        if (isThumbLoading() == false) goto L_0x005d;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x006f, code lost:
        if (r2.isDoingAction() == false) goto L_0x0072;
     */
    ...
    public void changeModeByNewMode(int i, int i2) {
        if (i == 166 && CameraSettings.isFrontCamera() && DataRepository.dataItemFeature().gx()) {
            i = 176;
        }
        ...
        if (isEnableClick()) {
            ...
            if (cameraAction != null) {
                ...
                if (!currentModule.isIgnoreTouchEvent() || (currentModule.isShot2Gallery() && view.getId() == R.id.v9_thumbnail_layout)) {
                    switch (view.getId()) {
                        case R.id.bottom_recording_camera_picker /*2131623987*/:
                        ...
                        case R.id.v9_thumbnail_layout /*2131623989*/:
                            if (!isThumbLoading()) {
                                if (DataRepository.dataItemGlobal().isIntentAction()) {
                        ...
                        case R.id.mimoji_create_back /*2131623991*/:
                            ...
                            break;
                        case R.id.v9_recording_pause /*2131623992*/:
                        ...
                        case R.id.v9_camera_picker /*2131623997*/:
                            ...
                            break;
                        case R.id.v9_recording_snap /*2131623998*/:
                            ...
                            break;
                        case R.id.v9_recording_reverse /*2131623999*/:
