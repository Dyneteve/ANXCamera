...
public class FragmentBottomPopupTips extends BaseFragment implements OnClickListener, BottomPopupTips, HandleBackTrace {
    ...
    private void reIntTipViewMarginBottom(View view, int i) {
        ...
        if (this.mCurrentMode == 165) {
            ...
            i2 = (makeupProtocol == null || !makeupProtocol.isSeekBarVisible()) ? (miBeautyProtocol == null || !miBeautyProtocol.isBeautyPanelShow()) ? (getResources().getDimensionPixelSize(R.dimen.manually_indicator_layout_height) / 2) - (i / 2) : getResources().getDimensionPixelSize(R.dimen.beauty_fragment_height) + dimensionPixelSize : getResources().getDimensionPixelSize(R.dimen.beautycamera_popup_fragment_height) + getResources().getDimensionPixelSize(R.dimen.beauty_fragment_height);
        } else {
            i2 = ((int) this.mRootView.getTranslationY()) + bokehFNumberController.visibleHeight();
        }
  ...
  mth insns count: 93
    ...
    private void updateCenterTipImage(int i, int i2, List<Completable> list) {
        ...
        if (r4 > 0) {
            this.mCenterTipImage.setImageResource(r4);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0021, code lost:
        if (com.android.camera.CameraSettings.isMacroModeEnabled(r11) == false) goto L_0x002f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x002c, code lost:
        if (com.android.camera.data.DataRepository.dataItemRunning().supportPopShineEntry() != false) goto L_0x003a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0037, code lost:
        if (com.android.camera.data.DataRepository.dataItemRunning().supportPopShineEntry() == false) goto L_0x0059;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x00dd, code lost:
        if (com.mi.config.b.isSupportedOpticalZoom() != false) goto L_0x00d0;
     */
