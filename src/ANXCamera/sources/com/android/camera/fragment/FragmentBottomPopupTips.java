...
public class FragmentBottomPopupTips extends BaseFragment implements OnClickListener, BottomPopupTips, HandleBackTrace {
    ...
    /* JADX WARNING: type inference failed for: r12v0, types: [int] */
  ...
  mth insns count: 140
    ...
    private void updateCenterTipImage(int i, int i2, List<Completable> list) {
        ...
        if (i3 != -1) {
            ...
            if (i3 == 18) {
                if (!"".equals(CameraSettings.getCurrentLiveSticker())) {
                    r125 = R.drawable.ic_live_sticker_on;
                }
        ...
        if (r12 > 0) {
            ...
            this.mCenterTipImage.setImageResource(r12);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x003d, code lost:
        if (com.android.camera.data.DataRepository.dataItemFeature().fJ() != false) goto L_0x00ac;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0048, code lost:
        if (com.android.camera.data.DataRepository.dataItemFeature().fI() != false) goto L_0x00ac;
     */
    ...
    private void updateLeftTipImage(int i, int i2, int i3, List<Completable> list) {
        ...
        switch (i2) {
            ...
            case 163:
            case 165:
                if (!CameraSettings.isMacroModeEnabled(i2) && !CameraSettings.isUltraPixelRearOn() && z && currentCameraId == 0) {
                    if (this.mIsShowLeftImageIntro) {
                        startLeftImageIntroAnim(i);
                        return;
                    }
    ...
    public void onClick(View view) {
        if (isEnableClick()) {
            ...
            if (!CameraSettings.isFrontCamera() || !((Camera) getContext()).isScreenSlideOff()) {
                switch (view.getId()) {
                    case R.id.popup_tip_image /*2131624002*/:
                    ...
                    case R.id.popup_left_tip_image /*2131624003*/:
                        break;
                    case R.id.popup_center_tip_image /*2131624005*/:
                        break;
                    case R.id.popup_left_tip_intro /*2131624007*/:
                        view.setTag(Integer.valueOf(21));
                        CameraSettings.setPopupUltraWideIntroClicked();
                        directHideLeftImageIntro();
                        break;
                    case R.id.popup_speed_tip_image /*2131624009*/:
                        ...
                        break;
                    case R.id.popup_tips_qrcode /*2131624011*/:
                        hideQrCodeTip();
    ...
    public void showTips(int i, @StringRes int i2, int i3) {
        ...
        if (!(i == 10 && CameraSettings.getBogusCameraId() == 0) && !isLightingHintVisible()) {
            ...
            this.mLastTipType = this.mCurrentTipType;
            this.mLastTipMessage = this.mCurrentTipMessage;
            if (this.mLastTipMessage != R.string.mimoji_start_create || i2 != R.string.mimoji_check_normal) {
                this.mCurrentTipType = i;
                this.mCurrentTipMessage = i2;
