...
public class FragmentBeauty extends BaseFragment implements OnClickListener, HandleBackTrace, MakeupProtocol, MiBeautyProtocol, Consumer<Integer> {
    ...
    private static class BeautyPagerAdapter extends FragmentPagerAdapter {
        ...
        public long getItemId(int i) {
            ...
            return item != null ? (long) (i | item.hashCode()) : FragmentBeauty.super.getItemId(i);
        }
  ...
  mth insns count: 14
    ...
    private void initShineType() {
        ...
        int dimensionPixelSize = this.mCurrentMode == 165 ? ((((int) (((float) Util.sWindowWidth) / 0.75f)) - Util.sWindowWidth) / 2) + getResources().getDimensionPixelSize(R.dimen.square_mode_bottom_cover_extra_margin) : getResources().getDimensionPixelSize(R.dimen.beauty_fragment_height);
        MarginLayoutParams marginLayoutParams = (MarginLayoutParams) this.mBeautyExtraView.getLayoutParams();
        ((MarginLayoutParams) this.mViewPager.getLayoutParams()).height = dimensionPixelSize;
    ...
    public void setClickEnable(boolean z) {
        ...
        if (this.mBeautyPagerAdapter != null) {
            List<BeautyLevelFragment> fragmentList = this.mBeautyPagerAdapter.getFragmentList();
            if (fragmentList != null) {
                for (BeautyLevelFragment beautyLevelFragment : fragmentList) {
