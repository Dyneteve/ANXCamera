...
public class Camera extends ActivityBase implements OnRequestPermissionsResultCallback, BaseLifecycleListener, BaseProtocol {
            ...
            while (!isInterrupted()) {
                ...
                try {
                    ...
                    if (Camera.this.mTick == access$000) {
                        ...
                        if (Util.sIsKillCameraService && DataRepository.dataItemFeature().gP() && SystemClock.elapsedRealtime() - CameraSettings.getBroadcastKillServiceTime() > 60000) {
        ...
        if (!isSwitchingModule()) {
            if (!ModeCoordinatorImpl.isAlive(hashCode())) {
                ...
                if (this.mJumpedToGallery) {
                    ...
                    if (this.mReleaseByModule && this.mCurrentModule != null && this.mCurrentModule.isShot2Gallery()) {
                    ...
                    if (intentType != 0) {
                        ...
                        sb3.append("resumeCamera: lastType=");
    ...
    private void triggerWatchDog(boolean z) {
        ...
        sb.append(z);
        Log.d(str, sb.toString());
        if (b.sP && DataRepository.dataItemFeature().gP()) {
            if (z) {
    ...
    public boolean handleScreenSlideKeyEvent(int i, KeyEvent keyEvent) {
        ...
        if (i == 701 && getCameraIntentManager().isFromScreenSlide().booleanValue() && !isModeSwitched()) {
            ...
            if ((currentMode == 171 && !DataRepository.dataItemFeature().hj()) || currentMode == 166 || currentMode == 167 || currentMode == 173 || currentMode == 175) {
                currentMode = 163;
    ...
    public void notifyOnFirstFrameArrived(int i) {
        if (this.mCurrentModule != null && !this.mCurrentModule.isDeparted() && !isSwitchingModule()) {
            ...
            if ((getCurrentModuleIndex() == 165 || getCurrentModuleIndex() == 163) && b.ja() && CameraSettings.isFrontCamera() && this.mDisplayRotation == 0 && DataRepository.dataItemGlobal().getBoolean("pref_front_camera_first_use_hint_shown_key", true)) {
    ...
    public void onLifeAlive() {
        ...
        Log.d(str, sb.toString());
        if (!isFromKeyguard() || (this.mHasbeenSetupOnFocusChanged && isFromKeyguard())) {
