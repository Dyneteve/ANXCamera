...
public class Camera extends ActivityBase implements OnRequestPermissionsResultCallback, BaseLifecycleListener, BaseProtocol {
  ...
  mth insns count: 36
    ...
    private boolean mForceCloseImmediate = true;
    /* access modifiers changed from: private */
  ...
  mth insns count: 25
    ...
    /* access modifiers changed from: private */
    public String newbieDialogFragmentTag = null;
    /* access modifiers changed from: private */
  ...
  mth insns count: 57
            ...
            while (!isInterrupted()) {
                ...
                try {
                    ...
                    if (Camera.this.mTick == access$000) {
                        ...
                        if (Util.sIsKillCameraService && DataRepository.dataItemFeature().gi() && SystemClock.elapsedRealtime() - CameraSettings.getBroadcastKillServiceTime() > 60000) {
        ...
        if (!isSwitchingModule()) {
            if (!ModeCoordinatorImpl.isAlive(hashCode())) {
                ...
                if (this.mJumpedToGallery) {
                    ...
                    dataItemGlobal.parseIntent(getIntent(), Boolean.valueOf(checkCallerLegality), startFromSecureKeyguard(), false, !this.mDelayReleaseCamera);
                    ...
                    if (intentType != 0) {
                        ...
                        sb.append(z);
                        sb.append(" delayReleaseCamera=");
                        sb.append(this.mDelayReleaseCamera);
                        ...
                        sb2.append(" delayReleaseCamera=");
                        sb2.append(this.mDelayReleaseCamera);
    ...
    private void triggerWatchDog(boolean z) {
        ...
        sb.append(z);
        Log.d(str, sb.toString());
        if (b.rM && DataRepository.dataItemFeature().gi()) {
            if (z) {
    ...
    public boolean handleScreenSlideKeyEvent(int i, KeyEvent keyEvent) {
        ...
        if (i == 701 && getCameraIntentManager().isFromScreenSlide().booleanValue() && !isModeSwitched()) {
            ...
            if ((currentMode == 171 && !DataRepository.dataItemFeature().gB()) || currentMode == 166 || currentMode == 167 || currentMode == 173 || currentMode == 175) {
                currentMode = 163;
    ...
    public void notifyOnFirstFrameArrived(int i) {
        if (this.mCurrentModule != null && !this.mCurrentModule.isDeparted() && !isSwitchingModule()) {
            ...
            if ((getCurrentModuleIndex() == 165 || getCurrentModuleIndex() == 163) && b.ih() && CameraSettings.isFrontCamera() && this.mDisplayRotation == 0 && DataRepository.dataItemGlobal().getBoolean("pref_front_camera_first_use_hint_shown_key", true)) {
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [com.android.camera.ActivityBase, android.content.Context, com.android.camera.module.loader.SurfaceStateListener, java.lang.Object, android.app.Activity, com.android.camera.Camera] */
    public void onCreate(Bundle bundle) {
        ...
        if (CompatibilityUtils.isInMultiWindowMode(this)) {
            ...
            boolean z = DataRepository.dataItemFeature().gh() || !isFromKeyguard();
            this.mForceCloseImmediate = z;
    ...
    /* JADX WARNING: type inference failed for: r9v0, types: [android.content.Context, com.android.camera.ActivityBase, com.android.camera.fragment.lifeCircle.BaseLifecycleListener, com.android.camera.Camera] */
    @MainThread
    ...
    public void onPause() {
        ...
        if (isGotoGallery()) {
            ...
            releaseAll(false, true, this.mForceCloseImmediate);
        }
        this.mForceCloseImmediate = true;
        removeNewBie();
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [android.content.Context, com.android.camera.ActivityBase, android.app.Activity, com.android.camera.Camera] */
    ...
    public void releaseAll(boolean z, final boolean z2, final boolean z3) {
        String str = TAG;
        StringBuilder sb = new StringBuilder();
            ...
            public void run() {
                ...
                if (z2) {
                    ...
                    if (!containsResumedCameraInStack) {
                        Camera2OpenManager.getInstance().release(z3);
                    } else {
