...
public class MutexModeManager {
    ...
    public String getSuffix() {
        ...
        if (!b.iD() && !Util.isForceNameSuffix()) {
            return "";
        }
        int i = this.mCurrentMutexMode;
        if (i != 5) {
    ...
    public boolean isSupportedTorch() {
        return b.hz() && (this.mCurrentMutexMode == 0 || this.mCurrentMutexMode == 2 || this.mCurrentMutexMode == 7 || this.mCurrentMutexMode == 9 || this.mCurrentMutexMode == 10);
    }
