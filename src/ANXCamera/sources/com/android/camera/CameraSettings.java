...
public class CameraSettings {
    ...
    public static boolean checkLensAvailability(Context context) {
        ...
        if (!Util.isGlobalVersion()) {
            if (DataRepository.dataItemFeature().fs() && Util.isPackageAvailable(context, AI_LENS_PACKAGE)) {
                z = true;
            }
            return z;
        }
    ...
    public static int[] getBeautifyValueRange() {
        return b.isMTKPlatform() ? new int[]{-12, 12} : b.hf() ? new int[]{0, 7} : new int[]{0, 10};
    }
    ...
    public static String getCustomWatermarkDefault() {
        return isUltraPixelRear48MPOn() ? getString(R.string.device_48m_watermark_default_text) : getString(R.string.device_watermark_default_text);
    }
    ...
    public static int getDefaultPreferenceId(int i) {
        if (i != R.string.pref_video_quality_default) {
            if (i != R.string.pref_camera_antibanding_default) {
                if (i == R.bool.pref_camera_auto_chroma_flash_default && (b.qS || b.qT)) {
    ...
    public static int getScreenLightBrightness() {
        ...
        return screenLightBrightness <= 0 ? SystemProperties.getInt("camera_screen_light_brightness", DataRepository.dataItemFeature().fx()) : screenLightBrightness;
    }
    ...
    public static ArrayList<String> getSupportedHfrSettings(int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            Size size = supportedHighSpeedVideoSize[i2];
    ...
    public static ArrayList<String> getSupportedVideoQuality(int i) {
        ...
        int i2 = get4kProfile();
        if (b.hn() && supportedOutputSize.contains(new CameraSize(3840, 2160)) && CamcorderProfile.hasProfile(bogusCameraId, i2)) {
    ...
    public static boolean isAgeGenderAndMagicMirrorWaterOpen() {
        return DataRepository.dataItemFeature().fn() && isFrontCamera() && (isAgeGenderWaterMarkOpen() || isMagicMirrorWaterMarkOpen());
    }
    ...
    public static boolean isAsdMotionEnable() {
        return b.hs() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_ASD_NIGHT, Boolean.valueOf(getString(R.bool.pref_camera_asd_night_default)).booleanValue());
    }

    public static boolean isAsdNightEnable() {
        return b.hu() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_ASD_NIGHT, Boolean.valueOf(getString(R.bool.pref_camera_asd_night_default)).booleanValue());
    }
    ...
    public static boolean isBurstShootingEnable() {
        return b.gT() && "burst".equals(DataRepository.dataItemGlobal().getString(KEY_LONG_PRESS_SHUTTER_FEATURE, getString(R.string.pref_camera_long_press_shutter_feature_default)));
    }
    ...
    public static boolean isCameraSoundOpen() {
        return !b.gR() || DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_SOUND, true);
    }
    ...
    public static boolean isFPS960(int i) {
        return i == 172 && DataRepository.dataItemFeature().fB() && DataRepository.dataItemConfig().getComponentConfigSlowMotion().isSlowMotionFps960();
    }
    ...
    public static boolean isFrontMirror() {
        DataItemGlobal dataItemGlobal = DataRepository.dataItemGlobal();
        String string = dataItemGlobal.getString(KEY_FRONT_MIRROR, b.iJ() ? getString(R.string.pref_front_mirror_entryvalue_off) : getString(R.string.pref_front_mirror_default));
    ...
    public static boolean isMovieSolidOn() {
        return b.gN() && DataRepository.dataItemGlobal().getBoolean(KEY_MOVIE_SOLID, Boolean.valueOf(getString(R.string.pref_camera_movie_solid_default)).booleanValue());
    }
    ...
    public static boolean isPopupTipBeautyIntroEnable() {
        return b.iz() && !DataRepository.dataItemGlobal().getBoolean(KEY_POPUP_TIP_BEAUTY_INTRO_CLICKED, false) && DataRepository.dataItemGlobal().getInt(KEY_POPUP_TIP_BEAUTY_INTRO_SHOW_TIMES, 0) < 3;
    }
    ...
    public static boolean isRecordLocation() {
        return b.gW() && DataRepository.dataItemGlobal().getBoolean(KEY_RECORD_LOCATION, false);
    }
    ...
    public static boolean isScanQRCode(Context context) {
        return !isFrontCamera() && isQRCodeReceiverAvailable(context) && b.hM() && !b.fZ() && DataRepository.dataItemGlobal().getBoolean(KEY_SCAN_QRCODE, Boolean.valueOf(getString(R.string.pref_scan_qrcode_default)).booleanValue());
    }
    ...
    public static boolean isSupportQuickShot() {
        return DataRepository.dataItemFeature().fv() || (DEBUG_FAST_SHOT && !b.rO);
    }
    ...
    public static boolean isSupportedMetadata() {
        return b.hq() || isSupportedPortrait();
    }
    ...
    public static boolean isSupportedPortrait() {
        return DataRepository.dataItemFeature().gD() && Camera2DataContainer.getInstance().hasSATCamera();
    }
    ...
    public static boolean isTimeWaterMarkOpen() {
        return DataRepository.dataItemGlobal().getBoolean("pref_watermark_key", false) && !isUltraPixelFront32MPOn();
    }
    ...
    public static boolean isUltraPixelRear48MPOn() {
        if (DataRepository.dataItemRunning().supportUltraPixel() && !ModuleManager.isSquareModule()) {
            return DataRepository.dataItemRunning().getComponentUltraPixel().isRear48MPSwitchOn();
        }
        return false;
    }
    ...
    public static boolean isVideoCaptureVisible() {
        return (!b.isMTKPlatform() || !isStereoModeOn()) && !isVideoBokehOn() && (b.ic() || (!VIDEO_SPEED_SLOW.equals(DataRepository.dataItemRunning().getVideoSpeed()) && !VIDEO_SPEED_HFR.equals(DataRepository.dataItemRunning().getVideoSpeed())));
    }
    ...
    public static void setCurrentMimojiState(String str) {
        DataRepository.dataItemLive().editor().putString(KEY_MIMOJI_INDEX, str).apply();
    }
