...
public class CameraSettings {
    ...
    public static int addExtraHeight(Context context, int i) {
        return (b.sC || !Util.checkDeviceHasNavigationBar(context) || Global.getInt(context.getContentResolver(), "can_nav_bar_hide", 0) != 1) ? i : i + Util.getNavigationBarHeight(context);
    }
