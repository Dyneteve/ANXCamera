...
public class Panorama3Module extends BaseModule implements SensorEventListener, CameraAction, CameraPreviewCallback {
    ...
    private class DecideDirection extends PanoramaState {
        ...
        private class DecideDirectionAttach extends AttachRunnable {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:54:0x01d5, code lost:
                if (com.android.camera.module.Panorama3Module.access$3600(r1.this$1.this$0).enabled() == false) goto L_0x01d8;
             */
    ...
    private class PanoramaPreview extends PanoramaState {
        ...
        private class PreviewAttach extends AttachRunnable {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:25:0x01fb, code lost:
                return;
             */
            /* Code decompiled incorrectly, please refer to instructions dump. */
  ...
  mth insns count: 60
    ...
    /* JADX WARNING: type inference failed for: r1v7, types: [android.content.Context, com.android.camera.Camera] */
    /* JADX WARNING: type inference failed for: r0v9, types: [android.app.Activity, com.android.camera.Camera] */
    /* access modifiers changed from: private */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r1v7, types: [android.content.Context, com.android.camera.Camera]
  assigns: [com.android.camera.Camera]
  ...
  mth insns count: 109
    ...
    public void onCameraOpened() {
        ...
        if (b.qp.equals("lavender") && this.mViewAngleH > 50.0f) {
            this.mGoalAngle = 291;
        }
    ...
    public void onCreate(int i, int i2) {
        ...
        this.mGoalAngle = DataRepository.dataItemFeature().fM();
        this.mLongSideCropRatio = DataRepository.dataItemFeature().fN();
