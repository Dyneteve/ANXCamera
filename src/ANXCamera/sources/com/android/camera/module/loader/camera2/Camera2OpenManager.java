...
public class Camera2OpenManager {
    ...
    private final StateCallback mCameraOpenCallback = new StateCallback() {
        public void onClosed(@NonNull CameraDevice cameraDevice) {
            ...
            if (DataRepository.dataItemFeature().gF() && Integer.valueOf(cameraDevice.getId()).intValue() == 1 && Camera2OpenManager.this.mPendingCameraId.get() == -1) {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            ...
            if (capabilities != null) {
                ...
                MiCamera2 miCamera2 = new MiCamera2(cameraDevice, parseInt, capabilities, Camera2OpenManager.this.getCameraHandler(), Camera2OpenManager.this.getCameraPreviewHandler(), Camera2OpenManager.this.getCameraMainThreadHandler());
        ...
        switch (message.what) {
            ...
            case 5:
                if (this.mCamera2Device == null) {
                    ...
                    sb7.append("force close start reason ");
                    sb7.append(i);
                    Log.e(str3, sb7.toString());
                    this.mCamera2Device.releasePreview(i);
