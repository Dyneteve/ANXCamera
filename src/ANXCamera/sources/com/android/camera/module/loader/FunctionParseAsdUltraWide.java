...
public class FunctionParseAsdUltraWide implements Function<CaptureResult, CaptureResult> {
    ...
    public FunctionParseAsdUltraWide(int i, UltraWideCheckCallback ultraWideCheckCallback) {
        boolean z = DataRepository.dataItemFeature().isSupportUltraWide() && !CameraSettings.isUltraWideConfigOpen(i) && !CameraSettings.isUltraPixelOn() && !CameraSettings.isMacroModeEnabled(i);
        this.mEnable = z;
        if (this.mEnable) {
