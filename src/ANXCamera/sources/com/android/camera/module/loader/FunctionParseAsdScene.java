...
public class FunctionParseAsdScene implements Function<CaptureResult, Integer> {
    ...
    public Integer apply(CaptureResult captureResult) {
        ...
        if (camera2Module != null) {
            ...
            boolean isScreenSlideOff = camera2Module.getActivity() != null ? camera2Module.getActivity().isScreenSlideOff() : false;
            ...
            if (num != null && num.intValue() == 4 && b.hm() && cameraDevice != null && 3 == cameraDevice.getFlashMode()) {
