    ...
    private void reconfigureData() {
        ...
        switch (this.mResetType) {
            ...
            case 6:
                ...
                ProviderEditor editor3 = dataItemConfig.editor();
                resetFlash(dataItemConfig.getComponentFlash(), editor3);
                resetHdr(dataItemConfig.getComponentHdr(), editor3);
                resetFrontBokenh(dataItemConfig.getComponentBokeh(), editor3);
                resetVideoBeauty(dataItemConfig.getComponentConfigBeauty(), editor3);
        ...
        boolean fS = DataRepository.dataItemFeature().fS();
