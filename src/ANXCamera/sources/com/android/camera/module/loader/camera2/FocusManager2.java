...
public class FocusManager2 extends FocusManagerAbstract {
    ...
    private Consumer<FocusTask> mFocusResultConsumer = new Consumer<FocusTask>() {
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0061, code lost:
            if (r5.getFocusTrigger() != 3) goto L_0x0065;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x006c, code lost:
            if (com.android.camera.module.loader.camera2.FocusManager2.access$1000(r4.this$0) != 2) goto L_0x00a3;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0072, code lost:
            if (r5.isSuccess() == false) goto L_0x007f;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:19:0x0094, code lost:
            if (com.android.camera.module.loader.camera2.FocusManager2.access$200(r4.this$0) == false) goto L_0x009d;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x00aa, code lost:
            if (com.android.camera.module.loader.camera2.FocusManager2.access$1100(r4.this$0) != 1) goto L_0x0105;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:25:0x00b0, code lost:
            if (r5.isSuccess() == false) goto L_0x00dc;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x00c8, code lost:
            if ("auto".equals(com.android.camera.module.loader.camera2.FocusManager2.access$1200(r4.this$0)) == false) goto L_0x00f1;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x00d0, code lost:
            if (com.android.camera.module.loader.camera2.FocusManager2.access$1300(r4.this$0) == 1) goto L_0x00f1;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00e4, code lost:
            if (com.android.camera.module.loader.camera2.FocusManager2.access$1500(r4.this$0) == false) goto L_0x00e8;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:9:0x005a, code lost:
            if (r5.getFocusTrigger() == 2) goto L_0x010b;
         */
    ...
    public void prepareCapture(boolean z, int i) {
        if (this.mInitialized) {
            ...
            if (isFocusEnabled() && !equals && z3) {
                ...
                } else if (z && this.mCameraFocusArea != null && !b.hV()) {
    ...
    public void setCharacteristics(CameraCapabilities cameraCapabilities) {
        ...
        if (!DataRepository.dataItemFeature().gV() || this.mFocusAreaSupported || !this.mMeteringAreaSupported || !cameraCapabilities.isAELockSupported()) {
            z = false;
        }
