...
public class FunctionParseAsdFace implements Function<CaptureResult, CaptureResult> {
    ...
    public CaptureResult apply(CaptureResult captureResult) throws Exception {
        ...
        CameraHardwareFace[] convertCameraHardwareFace = (!this.mNeedFaceInfo || !isUseFaceInfo || faceArr.length <= 0 || this.mFaceInfo.mAge == null) ? CameraHardwareFace.convertCameraHardwareFace(faceArr) : CameraHardwareFace.convertExCameraHardwareFace(faceArr, this.mFaceInfo);
