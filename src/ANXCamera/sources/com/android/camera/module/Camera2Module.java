...
public class Camera2Module extends BaseModule implements Listener, CameraAction, CameraModuleSpecial, FilterProtocol, TopConfigProtocol, ObjectViewListener, BeautyBodySlimCountCallback, CameraMetaDataCallback, CameraPreviewCallback, FaceDetectionCallback, FocusCallback, HDRCheckerCallback, LivePhotoResultCallback, PictureCallback, ScreenLightCallback, UltraWideCheckCallback {
    ...
    private SensorStateListener mSensorStateListener = new SensorStateListener() {
        ...
        public void onDeviceLieChanged(boolean z) {
            if (!Camera2Module.this.mPaused && Camera2Module.this.mIsShowLyingDirectHintStatus != Camera2Module.this.mOrientationCompensation + (z ? 1 : 0)) {
                ...
                if (z) {
                    ...
                    Camera2Module.this.mHandler.obtainMessage(58, 1, Camera2Module.this.mOrientationCompensation).sendToTarget();
                    return;
                }
        ...
        /* JADX WARNING: type inference failed for: r5v6, types: [android.app.Activity, com.android.camera.Camera] */
        /* JADX WARNING: type inference failed for: r1v4, types: [android.app.Activity, com.android.camera.Camera] */
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r5v6, types: [android.app.Activity, com.android.camera.Camera]
  ...
  mth insns count: 118
    ...
    private boolean enableFrontMFNR() {
        return b.ix() && (this.mOperatingMode == 32773 || (DataRepository.dataItemFeature().gn() && this.mOperatingMode == 36865));
    }
    ...
    public DeviceWatermarkParam getDeviceWaterMarkParam() {
        ...
        if (isDualCameraWaterMarkOpen) {
            ...
            f2 = 0.0f;
            f = 0.0f;
            DeviceWatermarkParam deviceWatermarkParam = new DeviceWatermarkParam(isDualCameraWaterMarkOpen, isFrontCameraWaterMarkOpen, CameraSettings.isUltraPixelRear48MPOn(), CameraSettings.getDualCameraWaterMarkFilePathVendor(), f3, f2, f);
            return deviceWatermarkParam;
        }
        f = resourceFloat3;
        f3 = resourceFloat;
        f2 = resourceFloat2;
        DeviceWatermarkParam deviceWatermarkParam2 = new DeviceWatermarkParam(isDualCameraWaterMarkOpen, isFrontCameraWaterMarkOpen, CameraSettings.isUltraPixelRear48MPOn(), CameraSettings.getDualCameraWaterMarkFilePathVendor(), f3, f2, f);
    ...
    private boolean isEnableQcfa() {
        ...
        if (CameraSettings.isUltraPixelOn() && (b.rK || b.rL || b.rN)) {
            z = true;
        }
        return z;
    }
    ...
    private boolean isTriggerQcfaModeChange(boolean z, boolean z2) {
        ...
        if ((this.mModuleIndex == 171 && isBokehFrontCamera()) || DataRepository.dataItemFeature().gf() > 0) {
            return false;
        }
        if (z) {
            if (!mIsBeautyFrontOn) {
    ...
    private boolean isUseSwMfnr() {
        if (CameraSettings.isGroupShotOn()) {
            ...
            if (this.mOperatingMode == 32773 && b.ix()) {
                return true;
            }
            if (this.mOperatingMode != 32773 || b.ix()) {
                return DataRepository.dataItemFeature().isSupportUltraWide() || b.rz || b.rI;
            }
            return false;
        }
    }
    ...
    public static /* synthetic */ void lambda$onUltraWideChanged$10(Camera2Module camera2Module, boolean z, int i) {
        String str = TAG;
        StringBuilder sb = new StringBuilder();
    ...
    private void resetAsdSceneInHdrOrFlashChange() {
        if (b.iv() && isFrontCamera() && this.mCurrentAsdScene != -1 && this.mCurrentAsdScene == 9) {
            this.mHandler.post(new Runnable() {
                public void run() {
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [android.app.Activity, com.android.camera.Camera] */
    /* access modifiers changed from: private */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r0v1, types: [android.app.Activity, com.android.camera.Camera]
  assigns: [com.android.camera.Camera]
  uses: [android.app.Activity]
  mth insns count: 14
    	at jadx.core.dex.visitors.typeinference.TypeSearch.fillTypeCandidates(TypeSearch.java:237)
    ...
    /* JADX WARNING: type inference failed for: r2v6, types: [android.app.Activity, com.android.camera.Camera] */
    /* access modifiers changed from: private */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r2v6, types: [android.app.Activity, com.android.camera.Camera]
  assigns: [com.android.camera.Camera]
  uses: [android.app.Activity]
  mth insns count: 40
    	at jadx.core.dex.visitors.typeinference.TypeSearch.fillTypeCandidates(TypeSearch.java:237)
    ...
    /* JADX WARNING: type inference failed for: r3v2, types: [android.content.Context, com.android.camera.Camera] */
    /* access modifiers changed from: private */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r3v2, types: [android.content.Context, com.android.camera.Camera]
  assigns: [com.android.camera.Camera]
  ...
  mth insns count: 54
    ...
    public void startNormalCapture(int i) {
        ...
        if (!CameraSettings.isGroupShotOn() || isParallelSessionEnable()) {
            ...
            if (isFrontCamera() && DataRepository.dataItemFeature().gv() && 32775 != this.mOperatingMode) {
    ...
    private void updateAlgorithmName() {
        String str = !b.iD() ? this.mCamera2Device.isBokehEnabled() ? DataRepository.dataItemFeature().fY() > 0 ? Util.ALGORITHM_NAME_SOFT_PORTRAIT_ENCRYPTED : Util.ALGORITHM_NAME_SOFT_PORTRAIT : isPortraitMode() ? "portrait" : this.mMutexModePicker.getAlgorithmName() : null;
    ...
    private void updateBokeh() {
        boolean z = false;
        boolean z2 = isFrontCamera() && !isBokehFrontCamera() && ((ModuleManager.isPortraitModule() && DataRepository.dataItemFeature().gE()) || (DataRepository.dataItemFeature().gG() && "on".equals(DataRepository.dataItemConfig().getComponentBokeh().getComponentValue(this.mModuleIndex))));
    ...
    private void updateDecodePreview() {
        if (this.mIsGoogleLensAvailable || scanQRCodeEnabled() || b.gg()) {
            String str = TAG;
            StringBuilder sb = new StringBuilder();
    ...
    private void updateFpsRange() {
        ...
        if (b.rE && CameraSettings.isPortraitModeBackOn()) {
    ...
    private void updateMfnr(boolean z) {
        boolean z2 = false;
        if (!isUseSwMfnr() && z && this.mModuleIndex != 167 && ((!b.rD || isDualCamera()) && this.mMutexModePicker.isNormal() && !CameraSettings.isGroupShotOn() && ((!isFrontCamera() || enableFrontMFNR()) && (DataRepository.dataItemFeature().fc() || getZoomRatio() == 1.0f || isUltraWideBackCamera() || isZoomRatioBetweenUltraAndWide())))) {
            z2 = true;
        }
    ...
    private void updatePictureAndPreviewSize() {
        ...
        if (b.rL && getOperatingMode() == 36867) {
    ...
    private void updateShotDetermine() {
        ...
        if (this.mModuleIndex == 171) {
            ...
            } else if (b.iw() || DataRepository.dataItemFeature().fg()) {
                z = true;
            }
            if (!this.mIsImageCaptureIntent) {
                i = z ? -3 : -2;
    ...
    public void closeCamera() {
        ...
        synchronized (this.mCameraDeviceLock) {
            if (this.mCamera2Device != null) {
                ...
                this.mCamera2Device.setASD(false);
                if (scanQRCodeEnabled() || b.gg() || this.mIsGoogleLensAvailable) {
    ...
    public int getMutexHdrMode(String str) {
        ...
        return (!b.hj() || !"live".equals(str)) ? 0 : 2;
    }
            ...
            if (isFrontCamera) {
                ...
                if (!isPortraitMode() || !DataRepository.dataItemFeature().fh()) {
                    if (!isPortraitMode() || !isBokehFrontCamera()) {
                        if (!this.mCameraCapabilities.isSupportedQcfa() || mIsBeautyFrontOn || !"off".equals(DataRepository.dataItemConfig().getComponentHdr().getComponentValue(this.mModuleIndex)) || DataRepository.dataItemFeature().gf() > 0) {
                            i = 32773;
                            i2 = i;
    ...
    /* JADX WARNING: type inference failed for: r0v27, types: [android.app.Activity, com.android.camera.Camera] */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r0v27, types: [android.app.Activity, com.android.camera.Camera]
  assigns: [com.android.camera.Camera]
  uses: [android.app.Activity]
  mth insns count: 78
    	at jadx.core.dex.visitors.typeinference.TypeSearch.fillTypeCandidates(TypeSearch.java:237)
  ...
  mth insns count: 28
    ...
    /* JADX WARNING: type inference failed for: r2v5, types: [android.content.Context, com.android.camera.Camera] */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r2v5, types: [android.content.Context, com.android.camera.Camera]
  assigns: [com.android.camera.Camera]
  uses: [android.content.Context]
  mth insns count: 35
    	at jadx.core.dex.visitors.typeinference.TypeSearch.fillTypeCandidates(TypeSearch.java:237)
    ...
    public void onPreviewMetaDataUpdate(CaptureResult captureResult) {
        if (captureResult != null) {
            ...
            boolean z = false;
            if (DataRepository.dataItemFeature().gn() || !isFrontCamera()) {
    ...
    public void onPreviewPixelsRead(byte[] bArr, int i, int i2) {
        ...
        if (isFrontCamera() && b.im() && i3 % 180 == 0) {
            i3 = 0;
        }
        synchronized (this.mCameraDeviceLock) {
            if (isAlive()) {
    ...
    public void onUltraWideChanged(boolean z, int i) {
        this.mHandler.post(new Runnable(z, i) {
            ...
            public final void run() {
                Camera2Module.lambda$onUltraWideChanged$10(Camera2Module.this, this.f$1, this.f$2);
            }
        });
    }
  ...
  mth insns count: 28
    ...
    public boolean scanQRCodeEnabled() {
        return CameraSettings.isScanQRCode(this.mActivity) && this.mModuleIndex == 163 && !this.mIsImageCaptureIntent && CameraSettings.isBackCamera() && !this.mMultiSnapStatus && !CameraSettings.isStereoModeOn() && !CameraSettings.isPortraitModeBackOn() && (!DataRepository.dataItemFeature().go() || !CameraSettings.isUltraPixelOn()) && !CameraSettings.isUltraWideConfigOpen(this.mModuleIndex) && !CameraSettings.isMacroModeEnabled(this.mModuleIndex);
    }
    ...
    public void setFrameAvailable(boolean z) {
        ...
        if (z && isBackCamera()) {
            if ((this.mModuleIndex == 165 || this.mModuleIndex == 163) && DataRepository.dataItemFeature().gM()) {
    ...
    public void startPreview() {
        if (this.mCamera2Device != null) {
            ...
            boolean z = this.mEnableParallelSession && isEnableQcfa();
            String str3 = TAG;
            StringBuilder sb3 = new StringBuilder();
            sb3.append("[QCFA] startPreview: set qcfa enable ");
            sb3.append(z);
            Log.d(str3, sb3.toString());
            this.mCamera2Device.setQcfaEnable(z);
            ...
            this.mCamera2Device.startPreviewSession(surfaceTexture != null ? new Surface(surfaceTexture) : null, z2, isNeedRawStream(), getOperatingMode(), this.mEnableParallelSession, this);
        }
    }
    ...
    public void updateManualEvAdjust() {
        if (this.mModuleIndex == 167) {
            ...
            Log.d(str, sb.toString());
            boolean z = b.iE() ? getString(R.string.pref_camera_exposuretime_default).equals(manualValue) : getString(R.string.pref_camera_iso_default).equals(manualValue2) || getString(R.string.pref_camera_exposuretime_default).equals(manualValue);
            if (this.mHandler != null) {
