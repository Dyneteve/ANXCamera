...
public class ConfigChangeImpl implements ConfigChanges {
  ...
  mth insns count: 40
    ...
    public void configRotationChange(int i, int i2) {
        ...
        if (i2 != 0) {
            if (i2 != 90) {
                if (i2 == 180) {
                    ...
                    if (bottomPopupTips != null) {
                        ...
                        bottomPopupTips.updateLyingDirectHint(z2, false);
                        return;
                    }
                    return;
                } else if (i2 != 270) {
            ...
            if (mainContentProtocol != null) {
                ...
                mainContentProtocol.updateLyingDirectHint(z2, false);
                return;
            }
            return;
        }
    ...
    public void reCheckFrontBokenTip() {
        if (DataRepository.dataItemFeature().gG() && ((TopAlert) ModeCoordinatorImpl.getInstance().getAttachProtocol(172)) != null && "on".equals(DataRepository.dataItemConfig().getComponentBokeh().getComponentValue(getBaseModule().getModuleIndex()))) {
            updateTipMessage(4, R.string.bokeh_use_hint, 2);
        }
    }
