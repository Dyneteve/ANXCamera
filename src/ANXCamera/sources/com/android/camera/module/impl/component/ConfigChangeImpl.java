...
public class ConfigChangeImpl implements ConfigChanges {
    ...
    private void configMacroMode() {
        ...
        if (isMacroModeEnabled) {
            switch (moduleIndex) {
                ...
                case 163:
                case 165:
                    bottomPopupTips.showTips(18, R.string.macro_mode_tip, 4, 500);
                    break;
            }
        } else {
    ...
    /* JADX WARNING: type inference failed for: r6v5, types: [com.android.camera.ActivityBase, android.content.Context] */
    /* JADX WARNING: type inference failed for: r6v6, types: [com.android.camera.ActivityBase, android.content.Context] */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r6v5, types: [com.android.camera.ActivityBase, android.content.Context]
