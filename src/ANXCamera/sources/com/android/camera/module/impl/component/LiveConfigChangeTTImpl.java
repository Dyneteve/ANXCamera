...
public class LiveConfigChangeTTImpl implements LiveConfigChanges {
    ...
    public void initResource() {
        ...
        String string = this.mContext.getString(R.string.live_appid);
        this.mAuthResult = VESDK.activate(this.mContext, this.mContext.getString(R.string.live_license), string, DataRepository.dataItemLive().getActivation());
    ...
    public void startPreview(Surface surface) {
        ...
        Log.d(str, sb.toString());
        TERecorder.addSlamDetectListener(new SlamDetectListener() {
    ...
    public void updateRecordingTime() {
        if (this.mMediaRecorderRecording) {
            ...
            AnonymousClass6 r1 = new CountDownTimer((long) (((float) (((long) this.mMaxVideoDurationInMs) - this.mTotalRecordingTime)) * this.mSpeed), (long) (1000.0f * this.mSpeed)) {
