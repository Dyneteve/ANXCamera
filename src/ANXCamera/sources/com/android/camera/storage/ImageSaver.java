...
public class ImageSaver implements SaverCallback, ParallelCallback, VideoClipSavingCallback {
    ...
    private DrawJPEGAttribute getDrawJPEGAttribute(byte[] bArr, int i, int i2, int i3, boolean z, int i4, int i5, Location location, String str, int i6, int i7, float f, String str2, boolean z2, boolean z3, String str3, List<WaterMarkData> list, boolean z4, PictureInfo pictureInfo, int i8, int i9) {
        ...
        boolean z5 = CameraSettings.isDualCameraWaterMarkOpen() || CameraSettings.isFrontCameraWaterMarkOpen();
        DrawJPEGAttribute drawJPEGAttribute = new DrawJPEGAttribute(bArr, z, max, max2, i10, i11, i3, copyEffectRectAttribute, location3, str, currentTimeMillis, i6, i7, f, isFrontMirror, str2, z2, pictureInfo, list, z5, z3, CameraSettings.isTimeWaterMarkOpen() ? str3 : null, z4, i8, i9);
            ...
            synchronized (obj2) {
                try {
                    if (this.mEffectProcessor != null) {
                        ...
                        i3 = orientation;
                        parallelTaskDataParameter = dataParameter;
                        DrawJPEGAttribute drawJPEGAttribute = getDrawJPEGAttribute(jpegImageData, dataParameter.getPreviewSize().getWidth(), dataParameter.getPreviewSize().getHeight(), filterId, parallelTaskData.isNeedThumbnail(), i2, i, dataParameter.getLocation(), sb2, dataParameter.getShootOrientation(), orientation, dataParameter.getShootRotation(), dataParameter.getAlgorithmName(), dataParameter.isHasWaterMark(), dataParameter.is48MPWaterMark(), dataParameter.getTimeWaterMarkString(), dataParameter.getFaceWaterMarkList(), false, dataParameter.getPictureInfo(), parallelTaskData.getCurrentModuleIndex(), parallelTaskData.getPreviewThumbnailHash());
                        this.mEffectProcessor.processorJpegSync(drawJPEGAttribute, false);
