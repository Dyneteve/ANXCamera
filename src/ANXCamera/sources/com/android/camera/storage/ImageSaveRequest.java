...
public final class ImageSaveRequest implements SaveRequest {
    ...
    public void save() {
        if (this.uri != null) {
            ...
            this.uri = Storage.addImage(this.context, this.title, this.date, this.loc, this.orientation, this.data, this.width, this.height, false, this.isHide, this.isMap, z, this.isParallelProcess, this.algorithmName, this.info);
        }
