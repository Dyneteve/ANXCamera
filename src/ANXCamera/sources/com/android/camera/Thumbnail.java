...
public class Thumbnail {
                ...
                try {
                    if (cursor.moveToFirst()) {
                        ...
                        if (TextUtils.isEmpty(string) || !new File(string).exists()) {
                            ...
                            z = true;
                            if (!z) {
                                cursor3 = contentResolver.query(uri, strArr, sb2, null, str);
                                if (cursor3 != null) {
                                    String str2 = TAG;
                                    try {
                                        ...
                                        while (cursor3.moveToNext()) {
                                            ...
                                            if (!TextUtils.isEmpty(string2) && new File(string2).exists()) {
                                                ...
                                                Media media = new Media(j, cursor3.getInt(1), cursor3.getLong(2), ContentUris.withAppendedId(uri, j), string2);
                                                if (cursor != null) {
                                                    cursor.close();
                                                }
                                                if (cursor3 != null) {
    ...
    public static int getLastThumbnailFromContentResolver(ContentResolver contentResolver, Thumbnail[] thumbnailArr, Uri uri) {
        ...
        if (bitmap == null || !Util.isUriValid(lastImageThumbnail.uri, contentResolver)) {
            return 2;
        }
    ...
    public void saveLastThumbnailToFile(File file) {
        ...
        synchronized (sLock) {
            try {
                ...
                try {
                    r32 = new BufferedOutputStream(fileOutputStream, 4096);
                } catch (IOException e2) {
                    r43 = 0;
                    e = e2;
                    r32 = 0;
