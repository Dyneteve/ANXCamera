                ...
                if (wideSelfStateCallback != null) {
                    ...
                    if (i4 > 0) {
                        if (i4 > WideSelfieEngineWrapper.this.mPreviewRect.top) {
                            ...
                            wideSelfStateCallback.onMove(processResult.direction, processResult.progress, new Point(i, i5), processResult.progressBarThumbOffset, z);
                        }
                        ...
                        wideSelfStateCallback.onMove(processResult.direction, processResult.progress, new Point(i, i52), processResult.progressBarThumbOffset, z);
                    }
                    i = 0;
                    ...
                    wideSelfStateCallback.onMove(processResult.direction, processResult.progress, new Point(i, i522), processResult.progressBarThumbOffset, z);
                }
            } else if (i3 == 2) {
