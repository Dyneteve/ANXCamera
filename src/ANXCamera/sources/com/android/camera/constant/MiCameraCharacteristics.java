...
public class MiCameraCharacteristics {
    public static final Key<Boolean> ADAPTIVE_SNAPSHOT_SIZE_IN_SAT_MODE_SUPPORTED = new Key<>(KEY_ADAPTIVE_SNAPSHOT_SIZE_IN_SAT_MODE_SUPPORTED, Boolean.class);
    public static final Key<Boolean> BEAUTY_MAKEUP = new Key<>(KEY_FEATURE_BEAUTY_MAKEUP, Boolean.class);
    public static final Key<Byte> BEAUTY_VERSION = new Key<>(KEY_BEAUTY_VERSION, Byte.class);
    ...
    private static final String KEY_ADAPTIVE_SNAPSHOT_SIZE_IN_SAT_MODE_SUPPORTED = "xiaomi.capabilities.satAdaptiveSnapshotSizeSupported";
    ...
    private static final String KEY_BEAUTY_VERSION = "com.xiaomi.camera.supportedfeatures.beautyVersion";
    ...
    public static final String KEY_STATS_SENSOR_HDR = "org.quic.camera2.statsconfigs.AECIsInsensorHDR";
    ...
    public static final Key<Byte> SENSOR_HDR_SUPPORTED = new Key<>(KEY_STATS_SENSOR_HDR, Byte.class);
