...
public class MiCaptureResult {
    public static final Key<Boolean> REMOSAIC_DETECTED = new Key<>("xiaomi.remosaic.detected", Boolean.TYPE);
    public static final Key<Byte> SENSOR_HDR_ENABLE = new Key<>(MiCameraCharacteristics.KEY_STATS_SENSOR_HDR, Byte.class);
