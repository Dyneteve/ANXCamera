...
public class UpdateConstant {
    ...
    @UpdateType
    public static final int[] CAMERA_TYPES_INIT = {44, 1};
    @UpdateType
    public static final int[] CAMERA_TYPES_MANUALLY = {6, 16, 15};
    @UpdateType
    public static final int[] CAMERA_TYPES_ON_PREVIEW_SUCCESS = {24, 2, 26, 27, 28, 29, 46, 47, 7, 8, 10, 11, 14, 19, 4, 13, 45, 5, 9, 20, 21, 22, 34, 23, 25, 36, 37, 42, 43, 48, 49, 52};
    @UpdateType
    ...
    @UpdateType
    public static final int[] PANORAMA_TYPES_INIT = {1};
    ...
    @UpdateType
    public static final int[] VIDEO_TYPES_INIT = {1};
    @UpdateType
    public static final int[] VIDEO_TYPES_ON_PREVIEW_SUCCESS = {24, 29, 13, 35, 19, 47, 31, 5, 9, 10, 14, 25, 52, 53};
    @UpdateType
    public static final int[] VIDEO_TYPES_RECORD = {19, 31, 40, 35, 33};
    @UpdateType
    public static final int[] WIDESELFIE_ON_PREVIEW_SUCCESS = {32, 13, 5};
    @UpdateType
    public static final int[] WIDESELFIE_TYPES_INIT = {1};
