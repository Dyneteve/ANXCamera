...
public class UpdateConstant {
    ...
    @UpdateType
    public static final int[] CAMERA_TYPES_INIT = {55, 44, 1};
    @UpdateType
    public static final int[] CAMERA_TYPES_MANUALLY = {6, 16, 15};
    @UpdateType
    public static final int[] CAMERA_TYPES_ON_PREVIEW_SUCCESS = {24, 2, 26, 27, 28, 29, 46, 47, 7, 8, 10, 11, 14, 19, 4, 13, 45, 5, 9, 20, 21, 22, 34, 23, 25, 36, 37, 42, 43, 48, 49, 52, 56};
    @UpdateType
    public static final int[] FUN_TYPES_INIT = {55, 1};
    @UpdateType
    ...
    @UpdateType
    public static final int[] VIDEO_TYPES_INIT = {55, 1};
    @UpdateType
