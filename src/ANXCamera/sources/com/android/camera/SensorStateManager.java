        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (access$000 != null) {
                ...
                if (f != SensorStateManager.this.mOrientation) {
                    ...
                    sb2.append(" mIsLying=");
                    sb2.append(SensorStateManager.this.mIsLying);
    ...
    class OrientationSensorEventListenerImpl implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (access$000 != null) {
                ...
                int i2 = SensorStateManager.this.mIsLying ? 5 : 0;
                int i3 = 26 + i2;
                int i4 = 153 - i2;
                float f4 = (float) i3;
                boolean z = (abs <= f4 || abs >= ((float) i4)) && (abs2 <= f4 || abs2 >= ((float) i4));
                ...
                if (z != SensorStateManager.this.mIsLying || (z && f != SensorStateManager.this.mOrientation)) {
                    ...
                    String str = SensorStateManager.TAG;
                    StringBuilder sb = new StringBuilder();
                    sb.append("SensorEventListenerImpl TYPE_ORIENTATION mOrientation=");
                    sb.append(SensorStateManager.this.mOrientation);
                    sb.append(" mIsLying=");
                    sb.append(SensorStateManager.this.mIsLying);
                    Log.v(str, sb.toString());
                    access$000.onDeviceOrientationChanged(SensorStateManager.this.mOrientation, SensorStateManager.this.mIsLying);
                }
            }
