...
public class CameraIntentManager {
    ...
    public static final String EXTRA_START_WHEN_LOCKED = "StartActivityWhenLocked";
    ...
    public int getCameraModeId() {
        ...
        switch (cameraMode.hashCode()) {
            ...
            case 73114540:
                if (cameraMode.equals(CameraMode.MACRO)) {
                    c = 14;
                    break;
                }
            case 76699320:
        ...
        switch (c) {
            ...
            case 6:
                return 165;
            case 7:
                return DataRepository.dataItemFeature().gt() ? 174 : 161;
            case 8:
                return 162;
            case 9:
                return 169;
            case 10:
                return DataRepository.dataItemFeature().gh() ? 172 : 168;
            case 11:
                return 173;
            case 12:
                return 175;
