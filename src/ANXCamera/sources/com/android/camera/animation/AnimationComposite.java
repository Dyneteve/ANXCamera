...
public class AnimationComposite implements Consumer<Integer> {
    ...
    public Disposable dispose(@Nullable Completable completable, @Nullable Action action, StartControl startControl) {
        ...
        switch (startControl.mViewConfigType) {
            ...
            case 2:
                while (i3 < this.mResourceSparseArray.size()) {
                    AnimationResource animationResource2 = (AnimationResource) this.mResourceSparseArray.valueAt(i3);
            ...
            case 3:
                while (i3 < this.mResourceSparseArray.size()) {
                    AnimationResource animationResource3 = (AnimationResource) this.mResourceSparseArray.valueAt(i3);
