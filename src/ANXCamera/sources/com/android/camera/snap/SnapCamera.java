...
public class SnapCamera implements OnErrorListener, OnInfoListener {
    ...
    private void initOrientationListener() {
        this.mOrientationListener = new OrientationEventListener(this.mContext, b.jt() ? 2 : 3) {
    ...
    public static boolean isSnapEnabled(Context context) {
        ...
        return !"public_transportation_shortcuts".equals(string2) && !"none".equals(string2);
    }
    ...
    private void setupMediaRecorder() {
        ...
        if (VideoModule.VIDEO_MAX_SINGLE_FILE_SIZE < availableSpace && DataRepository.dataItemFeature().fX()) {
            String str = TAG;
        ...
        try {
            ...
            if (!Storage.isUseDocumentMode()) {
                ...
                ParcelFileDescriptor parcelFileDescriptor2 = FileCompat.getParcelFileDescriptor(sb4, true);
                try {
