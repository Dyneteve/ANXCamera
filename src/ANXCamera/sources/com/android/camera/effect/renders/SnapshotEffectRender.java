    ...
    private class EGLHandler extends Handler {
        ...
        private byte[] applyEffect(DrawJPEGAttribute drawJPEGAttribute, int i, boolean z, Size size, Size size2) {
            ...
            if (thumbnailBytes == null) {
                ...
                if (drawJPEGAttribute2.mApplyWaterMark) {
                    ...
                    if (!DataRepository.dataItemFeature().hr() || drawJPEGAttribute2.mInfo == null || !drawJPEGAttribute2.mInfo.isFrontCamera()) {
                ...
                GLES20.glPixelStorei(SuperNightProcess.ASVL_PAF_RAW12_RGGB_12B, i9);
        ...
        private WaterMark drawDoubleShotWaterMark(DrawJPEGAttribute drawJPEGAttribute, int i, int i2, int i3, int i4, int i5, WaterMark waterMark) {
            ...
            if (waterMark2 != null) {
                ...
                if (!drawJPEGAttribute2.mIsUtralPixelWatermarkEnabled || DataRepository.dataItemFeature().gI() || !equals) {
                    ...
                    ImageWaterMark imageWaterMark = new ImageWaterMark(bitmap, i3, i4, i8, SnapshotEffectRender.this.mDualCameraWaterMarkSizeRatio, SnapshotEffectRender.this.mDualCameraWaterMarkPaddingXRatio, SnapshotEffectRender.this.mDualCameraWaterMarkPaddingYRatio);
                    drawWaterMark(imageWaterMark, i6, i7, i8);
                    return imageWaterMark;
                }
                if (SnapshotEffectRender.this.mUltraPixelCameraWaterMarkBitmap == null) {
                    SnapshotEffectRender.this.mUltraPixelCameraWaterMarkBitmap = SnapshotEffectRender.this.loadUltraPixelWatermark(SnapshotEffectRender.this.mContext);
                }
                if (SnapshotEffectRender.this.mUltraPixelCameraWaterMarkBitmap != null) {
        ...
        private WaterMark drawTimeWaterMark(DrawJPEGAttribute drawJPEGAttribute, int i, int i2, int i3, int i4, int i5, WaterMark waterMark) {
            ...
            if (waterMark != null) {
                ...
                WaterMark newStyleTextWaterMark = b.hM() ? new NewStyleTextWaterMark(str, i3, i4, i5) : new TextWaterMark(str, i3, i4, i5);
  ...
  mth insns count: 183
                    ...
                    case 2:
                        ...
                        if (drawJPEGAttribute2.mWidth != 0 && drawJPEGAttribute2.mHeight != 0) {
                            ...
                            if (drawJPEGAttribute2.mData != null) {
                                r2 = drawJPEGAttribute2.mData.length;
                            }
    ...
    public Bitmap loadCameraWatermark(Context context) {
        ...
        if (!DataRepository.dataItemFeature().fP()) {
            return (!DataRepository.dataItemFeature().fQ() || new File(Util.WATERMARK_STORAGE_DIRECTORY, Util.WATERMARK_FILE_NAME).exists()) ? BitmapFactory.decodeFile(CameraSettings.getDualCameraWaterMarkFilePathVendor(), options) : Util.generateWatermark2File();
        }
    ...
    public Bitmap loadUltraPixelWatermark(Context context) {
        ...
        options.inPremultiplied = false;
        if (!DataRepository.dataItemFeature().fP()) {
            return (!DataRepository.dataItemFeature().fQ() || new File(Util.WATERMARK_STORAGE_DIRECTORY, Util.WATERMARK_ULTRA_PIXEL_FILE_NAME).exists()) ? BitmapFactory.decodeFile(CameraSettings.getDualCameraWaterMarkFilePathVendor(true), options) : Util.generateUltraPixelWatermark2File();
        }
