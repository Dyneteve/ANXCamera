...
public class SnapshotRender {
    ...
    private class EGLHandler extends Handler implements WatermarkRender {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:68:0x0364  */
        /* JADX WARNING: Removed duplicated region for block: B:69:0x0366  */
        /* JADX WARNING: Removed duplicated region for block: B:72:0x03ec  */
        /* JADX WARNING: Removed duplicated region for block: B:73:0x041c  */
        /* JADX WARNING: Removed duplicated region for block: B:76:0x0455  */
        ...
        private byte[] applyEffect(DrawYuvAttribute drawYuvAttribute) {
            ...
            if (drawYuvAttribute4.mEffectIndex != FilterInfo.FILTER_ID_NONE || CameraSettings.isAgeGenderAndMagicMirrorWaterOpen() || ModuleManager.isSquareModule() || CameraSettings.isGradienterOn() || CameraSettings.isTiltShiftOn() || (!drawYuvAttribute4.mApplyWaterMark && drawYuvAttribute4.mTimeWatermark == null)) {
                ...
                int[] watermarkRange = Util.getWatermarkRange(drawYuvAttribute4.mPictureSize.getWidth(), drawYuvAttribute4.mPictureSize.getHeight(), (drawYuvAttribute4.mJpegRotation + 270) % 360, drawYuvAttribute4.mApplyWaterMark, drawYuvAttribute4.mTimeWatermark != null, 0.11f);
            ...
            if (!ModuleManager.isSquareModule()) {
                ...
                if (!drawYuvAttribute2.mApplyWaterMark) {
                    ...
                    if (!z) {
                        iArr = Util.getWatermarkRange(i6, i5, (drawYuvAttribute2.mJpegRotation + 270) % 360, drawYuvAttribute2.mApplyWaterMark, drawYuvAttribute2.mTimeWatermark != null ? r8 : 0, 0.11f);
                        int i16 = iArr[0];
                        i10 = iArr[r8];
                        i11 = i16;
                    } else {
                    ...
                    bArr2 = ShaderNativeUtil.getPicture(i11 + i4, i10 + i3, iArr[2], iArr[3], i18);
                ...
                if (drawYuvAttribute3.mApplyWaterMark) {
                    int[] watermarkRange2 = Util.getWatermarkRange(drawYuvAttribute3.mOutputSize.getWidth(), drawYuvAttribute3.mOutputSize.getHeight(), (drawYuvAttribute3.mJpegRotation + 270) % 360, drawYuvAttribute3.mApplyWaterMark, drawYuvAttribute3.mTimeWatermark != null, 0.11f);
        ...
        private byte[] blockSplitApplyEffect(DrawYuvAttribute drawYuvAttribute) {
            ...
            if (drawYuvAttribute2.mApplyWaterMark) {
                int[] watermarkRange = Util.getWatermarkRange(i3, i4, (drawYuvAttribute2.mJpegRotation + 270) % 360, drawYuvAttribute2.mApplyWaterMark, drawYuvAttribute2.mTimeWatermark != null, 0.11f);
            ...
            while (i15 < split.size()) {
                ...
                SnapshotRender.this.mFrameCounter.reset(String.format("[loop%d/%d]begin", objArr));
                Block block = (Block) split.get(i15);
                int i16 = block.mWidth;
                int i17 = block.mHeight;
                RectF rectF5 = rectF;
                int i18 = block.mRowStride;
                int i19 = block.mOffset;
                if (effectRender instanceof PipeRender) {
                    effectRender.setFrameBufferSize(i16, i17);
                }
                checkFrameBuffer(i16, i17);
                effectRender.setParentFrameBufferId(this.mFrameBuffer.getId());
                RectF rectF6 = rectF4;
                this.mGLCanvas.beginBindFrameBuffer(this.mFrameBuffer.getId(), i16, i17);
                ...
                drawYuvAttribute2.mBlockWidth = i16;
                drawYuvAttribute2.mBlockHeight = i17;
                effectRender.draw(drawYuvAttribute2);
                int i21 = rowStride;
                SnapshotRender.this.mFrameCounter.tick(String.format("[loop%d/%d]gl drawFrame", new Object[]{Integer.valueOf(i15), Integer.valueOf(split.size())}));
                ...
                if (drawYuvAttribute2.mApplyWaterMark) {
                    ...
                    rectF7.right = (float) (offset[0] + i16);
                    rectF7.bottom = (float) (offset[1] + i17);
                    int i22 = i2 - offset[0];
                    int i23 = i - offset[1];
                    ...
                    drawAgeGenderAndMagicMirrorWater(list2, i25, i26, width, height, width2, drawYuvAttribute2.mPreviewSize.getHeight(), drawYuvAttribute2.mJpegRotation, false);
                    rectF3 = rectF5;
                    if (rectangle_collision(rectF2.left, rectF2.top, rectF2.width(), rectF2.height(), rectF3.left, rectF3.top, rectF3.width(), rectF3.height())) {
                        getIntersectRect(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, rectF3.left, rectF3.top, rectF3.right, rectF3.bottom);
                        drawWaterMark(i22, i23, i8, i7, drawYuvAttribute2.mJpegRotation, drawYuvAttribute2.mTimeWatermark);
                    }
                    counterUtil2.tick("drawWaterMark");
                    this.mGLCanvas.endBindFrameBuffer();
                    i12 = i27;
                    i13 = i28;
                    Size size = new Size(i13, i12);
                    checkWatermarkFrameBuffer(size);
                    this.mGLCanvas.beginBindFrameBuffer(this.mWatermarkFrameBuffer);
                    RgbToYuvRender rgbToYuvRender = (RgbToYuvRender) fetchRender(FilterInfo.FILTER_ID_RGB2YUV);
                    updateRenderParameters(rgbToYuvRender, drawYuvAttribute2);
                ...
                GLES20.glPixelStorei(SuperNightProcess.ASVL_PAF_RAW12_RGGB_12B, 1);
                ShaderNativeUtil.mergeYUV(i13, i12, yUVOffset[c], yUVOffset[1]);
        ...
        private void drawAgeGenderAndMagicMirrorWater(List<WaterMarkData> list, int i, int i2, int i3, int i4, int i5, int i6, int i7, boolean z) {
            if (b.iD() && !z && CameraSettings.isAgeGenderAndMagicMirrorWaterOpen()) {
        ...
        private Bitmap getGPUYYY(int i, int i2, int i3, int i4) {
            ...
            for (int i9 = 0; i9 < i7; i9++) {
                byte b = bArr[i9];
                iArr[i8] = (b & 255) | ((b << 8) & 65280) | -16777216 | ((b << 16) & 16711680);
                i8++;
            }
            ...
            if (SnapshotRender.this.mFrontCameraWaterMarkBitmap != null && SnapshotRender.this.mDeviceWaterMarkParam.isFrontWatermarkEnable()) {
                ...
                if (SnapshotRender.this.mDeviceWaterMarkParam.isUltraWatermarkEnable() && equals) {
                    if (SnapshotRender.this.mUltraPixelCameraWaterMarkBitmap == null) {
                        SnapshotRender.this.mUltraPixelCameraWaterMarkBitmap = SnapshotRender.this.loadUltraWatermark(CameraAppImpl.getAndroidContext());
                    }
                    if (SnapshotRender.this.mUltraPixelCameraWaterMarkBitmap != null) {
