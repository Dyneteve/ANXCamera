...
public class EffectController {
    ...
    private RenderGroup getPrivateRender(GLCanvas gLCanvas, RenderGroup renderGroup, boolean z, boolean z2, int i) {
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_TILTSHIFT) == null && b.hR() && (z || i2 == FilterInfo.FILTER_ID_TILTSHIFT || (i2 < 0 && !z3))) {
        ...
        if (d.getBoolean(d.uE, false) || renderGroup2.getRender(FilterInfo.FILTER_ID_GAUSSIAN) != null || (!z && i2 != FilterInfo.FILTER_ID_GAUSSIAN && (i2 >= 0 || z3))) {
            z4 = z3;
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_PEAKINGMF) == null && b.hG() && !z2 && (z || i2 == FilterInfo.FILTER_ID_PEAKINGMF || (i2 < 0 && !z4))) {
        ...
        synchronized (this) {
            ...
            if (!isDualCameraWaterMarkOpen && !isFrontCameraWaterMarkOpen && !isTimeWaterMarkOpen && !isAgeGenderWaterMarkOpen) {
                if (!isMagicMirrorWaterMarkOpen) {
                    z2 = false;
                    boolean z4 = !fn && z2;
                    if (gQ && (z3 || isSquareModule || isGradienterOn || isTiltShiftOn || z4)) {
                        z = true;
                    }
                }
            }
