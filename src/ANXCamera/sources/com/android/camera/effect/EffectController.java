...
public class EffectController {
    ...
    private RenderGroup getPrivateRender(GLCanvas gLCanvas, RenderGroup renderGroup, boolean z, boolean z2, int i) {
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_TILTSHIFT) == null && b.iF() && (z || i2 == FilterInfo.FILTER_ID_TILTSHIFT || (i2 < 0 && !z3))) {
        ...
        if (d.getBoolean(d.vP, false) || renderGroup2.getRender(FilterInfo.FILTER_ID_GAUSSIAN) != null || (!z && i2 != FilterInfo.FILTER_ID_GAUSSIAN && (i2 >= 0 || z3))) {
            z4 = z3;
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_PEAKINGMF) == null && b.iu() && !z2 && (z || i2 == FilterInfo.FILTER_ID_PEAKINGMF || (i2 < 0 && !z4))) {
    ...
    public int getEffectForSaving(boolean z) {
        return !(this.mEffectId != FilterInfo.FILTER_ID_NONE && FilterInfo.getCategory(this.mEffectId) != 6) ? FilterInfo.FILTER_ID_NONE : getEffectForPreview(z);
    }
    ...
    public boolean hasEffect() {
        ...
        synchronized (this) {
            ...
            boolean fP = DataRepository.dataItemFeature().fP();
            ...
            if (!isDualCameraWaterMarkOpen && !isFrontCameraWaterMarkOpen && !isTimeWaterMarkOpen && !isAgeGenderWaterMarkOpen) {
                if (!isMagicMirrorWaterMarkOpen) {
                    z2 = false;
                    boolean z4 = !fP && z2;
                    if (hD && (z3 || isSquareModule || isGradienterOn || isTiltShiftOn || z4)) {
                        z = true;
                    }
                }
            }
