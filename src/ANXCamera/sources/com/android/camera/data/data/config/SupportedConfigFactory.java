        ...
        switch (i) {
            ...
            case 170:
                if (i2 == 0) {
                    ...
                    if (b.hk() && !dataItemFeature.fC()) {
                        supportedConfigs.add(232);
                    }
                    if (z && dataItemRunning.supportMacroMode()) {
    ...
    public static final SupportedConfigs getSupportedTopConfigs(int i, int i2, CameraCapabilities cameraCapabilities, boolean z) {
        ...
        switch (i) {
            ...
            case 170:
                if (i2 != 0) {
                    ...
                    if (z) {
                        ...
                        if (!dataItemFeature.fC() && b.hk() && b.iy()) {
            ...
            case 167:
                ...
                if (b.hG() && !manuallyFocus.getComponentValue(i).equals(manuallyFocus.getDefaultValue(i)) && cameraCapabilities.isAFRegionSupported()) {
