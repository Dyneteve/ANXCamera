    ...
    private List<ComponentDataItem> initItems() {
        if (this.mIntentType != -1) {
            ...
            if (this.mIntentType == 3) {
                ...
                if (dataItemFeature.gi() && this.mIntentType == 0) {
