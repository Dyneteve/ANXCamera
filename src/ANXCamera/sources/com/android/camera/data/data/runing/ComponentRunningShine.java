...
public class ComponentRunningShine extends ComponentData {
    ...
    private ComponentDataItem generateBeautyLevelItem(boolean z) {
        return b.jo() ? new ComponentDataItem(R.drawable.ic_beauty_off, R.drawable.ic_beauty_on, R.string.beauty_fragment_tab_name_3d_beauty, "1") : new ComponentDataItem(R.drawable.ic_beauty_off, R.drawable.ic_beauty_on, R.string.beauty_fragment_tab_name_beauty, "1");
    }
                ...
                if (!CameraSettings.isUltraPixelRearOn()) {
                    ...
                    if (i2 == 0) {
                        ...
                        if (!DataRepository.dataItemFeature().hm()) {
                            ...
                            if (DataRepository.dataItemFeature().ga() && cameraCapabilities.isSupportBeautyMakeup()) {
