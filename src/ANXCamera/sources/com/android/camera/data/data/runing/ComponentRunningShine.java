...
public class ComponentRunningShine extends ComponentData {
    ...
    private ComponentDataItem generateBeautyLevelItem(boolean z) {
        return b.iB() ? new ComponentDataItem(R.drawable.ic_beauty_off, R.drawable.ic_beauty_on, R.string.beauty_fragment_tab_name_3d_beauty, "1") : new ComponentDataItem(R.drawable.ic_beauty_off, R.drawable.ic_beauty_on, R.string.beauty_fragment_tab_name_beauty, "1");
    }
