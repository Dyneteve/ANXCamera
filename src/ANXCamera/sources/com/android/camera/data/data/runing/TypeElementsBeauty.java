...
public class TypeElementsBeauty extends TypeElements {
    ...
    private void initAdvanceItems(List<TypeItem> list, int i, CameraCapabilities cameraCapabilities, ComponentRunningShine componentRunningShine) {
        initItemsBySupportedTypes("3", new String[]{"pref_beautify_slim_face_ratio_key", "pref_beautify_enlarge_eye_ratio_key", "pref_beautify_skin_color_ratio_key", "pref_beautify_skin_smooth_ratio_key"}, list, true, cameraCapabilities);
    }
    ...
    private void initLiveBeautyItems(List<TypeItem> list, int i, CameraCapabilities cameraCapabilities, ComponentRunningShine componentRunningShine) {
        initItemsBySupportedTypes(ComponentRunningShine.SHINE_LIVE_BEAUTY, new String[]{"key_live_smooth_strength", "key_live_shrink_face_ratio", "key_live_enlarge_eye_ratio"}, list, false, cameraCapabilities);
    }
    ...
    private void initMakeUpItems(List<TypeItem> list, int i, CameraCapabilities cameraCapabilities, ComponentRunningShine componentRunningShine) {
        ...
        if (i != 1 || !DataRepository.dataItemFeature().fD()) {
            strArr[3] = null;
        }
        initItemsBySupportedTypes("5", strArr, list, true, cameraCapabilities);
    }
