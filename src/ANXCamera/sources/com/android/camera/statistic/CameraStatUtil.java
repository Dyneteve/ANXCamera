...
public class CameraStatUtil {
    ...
    static {
        ...
        sCameraModeIdToName.put(177, "Live视频");
    ...
    private static void addUltraPixelParameter(boolean z, Map<String, String> map) {
        ...
        if (z) {
            if (DataRepository.dataItemFeature().gd() == 32275200) {
                map.put(CameraStat.PARAM_ULTRA_PIXEL_32MP, isUltraPixelOn ? "on" : "off");
            }
        } else if (DataRepository.dataItemFeature().gb() == 48000000) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:56:0x010e A[RETURN] */
    ...
    public static void trackGeneralInfo(int i, boolean z, int i2, int i3, boolean z2, MutexModeManager mutexModeManager, String str) {
        ...
        String str3 = (z || !CameraSettings.isGroupShotOn()) ? "off" : "on";
        ...
        if (!z) {
            ...
            if (componentRunningTimer != null) {
                str4 = componentRunningTimer.getComponentValue(i2);
            }
        }
        hashMap.put(CameraStat.PARAM_TIMER, str4);
        String str5 = "0";
        ComponentConfigFlash componentFlash = dataItemConfig.getComponentFlash();
        if (componentFlash != null) {
            str5 = componentFlash.getComponentValue(i2);
            if (z && !"2".equals(str5)) {
                str5 = "0";
            }
        }
        if (str != null) {
            ...
            hashMap.put(CameraStat.PARAM_FLASH_MODE, flashModeToName(str5));
        }
        ...
        String str6 = CameraStat.PARAM_TILTSHIFT;
        String componentValue = (z || !CameraSettings.isTiltShiftOn()) ? "off" : dataItemRunning.getComponentRunningTiltValue().getComponentValue(i2);
        hashMap.put(str6, componentValue);
        String str7 = CameraStat.PARAM_GRADIENTER;
        String str8 = (z || !CameraSettings.isGradienterOn()) ? "off" : "on";
        hashMap.put(str7, str8);
        String str9 = CameraStat.PARAM_HHT;
        String str10 = (z || mutexModeManager == null || !mutexModeManager.isHandNight()) ? "off" : "on";
        ...
        if (!z && mutexModeManager != null) {
            ...
            if (componentHdr != null && "auto".equals(componentHdr.getComponentValue(i2))) {
                str11 = isHdr ? AUTO_ON : AUTO_OFF;
            } else if (isHdr) {
                str11 = "on";
            }
        }
        hashMap.put(CameraStat.PARAM_HDR, str11);
        String str12 = CameraStat.PARAM_SUPER_RESOLUTION;
        String str13 = (z || mutexModeManager == null || !mutexModeManager.isSuperResolution()) ? "off" : "on";
