...
public class MiCamera2ShotStill extends MiCamera2Shot<ParallelTaskData> {
        ...
        return new CaptureCallback() {
            ...
            public void onCaptureStarted(@NonNull CameraCaptureSession cameraCaptureSession, @NonNull CaptureRequest captureRequest, long j, long j2) {
                ...
                if (!CameraSettings.isSupportedZslShutter() && !CameraSettings.getPlayToneOnCaptureStart()) {
                    MiCamera2ShotStill.this.mMiCamera.getPictureCallback().onCaptureShutter(false);
                }
    ...
    public Builder generateRequestBuilder() throws CameraAccessException, IllegalStateException {
        ...
        if (this.mMiCamera.useLegacyFlashStrategy()) {
    ...
    public void onImageReceived(Image image, int i) {
        ...
        sb3.append(firstPlane == null ? TEDefine.FACE_BEAUTY_NULL : Integer.valueOf(firstPlane.length));
