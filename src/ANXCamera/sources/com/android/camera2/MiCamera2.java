...
public class MiCamera2 extends Camera2Proxy {
    ...
    private static final int MAX_IMAGE_BUFFER_SIZE = (b.iJ() ? 12 : 10);
    ...
    /* access modifiers changed from: private */
    public boolean mSetRepeatingEarly = DataRepository.dataItemFeature().gm();
    /* access modifiers changed from: private */
    ...
    private ImageReader mYuvPreviewImageReader;
    ...
    private class PictureCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCapabilityChanged(CameraCapabilities cameraCapabilities) {
            ...
            boolean z = DataRepository.dataItemFeature().gq() && !this.mFocusAreaSupported && cameraCapabilities.isAERegionSupported() && cameraCapabilities.isAELockSupported();
    ...
    public void captureStillPicture() {
        if (checkCaptureSession(CameraStat.CATEGORY_CAMERA)) {
            ...
            if (CameraSettings.isCameraQuickShotEnable() || CameraSettings.isCameraQuickShotAnimateEnable() || (DataRepository.dataItemFeature().gv() && this.mPreviewControl.needForFrontCamera())) {
    ...
    private long getCaptureInterval() {
        long gx = DataRepository.dataItemFeature().gx() - (System.currentTimeMillis() - this.mCaptureTime);
    ...
    private Builder initFocusRequestBuilder(int i) throws CameraAccessException {
        ...
        if (i == 160) {
            ...
            if (this.mYuvPreviewImageReader != null) {
                builder.addTarget(this.mYuvPreviewImageReader.getSurface());
            }
            return builder;
        }
    }
    ...
    public static /* synthetic */ void lambda$setCaptureEnable$1(MiCamera2 miCamera2, boolean z) {
        boolean z2 = false;
        boolean z3 = miCamera2.mMiCamera2ShotQueue.size() < DataRepository.dataItemFeature().gy();
    ...
    private void prepareVideoSnapshotImageReader(CameraSize cameraSize) {
        ...
        AnonymousClass4 r0 = new OnImageAvailableListener() {
            public void onImageAvailable(ImageReader imageReader) {
                Image acquireNextImage = imageReader.acquireNextImage();
                if (acquireNextImage != null) {
                    if (MiCamera2.this.mMiCamera2Shot == null) {
    ...
    public void triggerDeviceChecking(boolean z) {
        if (b.rO && DataRepository.dataItemFeature().gk() && this.mHelperHandler != null) {
    ...
    public void triggerPrecapture() {
        ...
        } else if (!DataRepository.dataItemFeature().gJ() || !(this.mConfigs.getISO() == 0 || this.mConfigs.getExposureTime() == 0)) {
            lockFocus();
        } else {
    ...
    public void close() {
        ...
        abortCaptures();
        if (this.mCameraDevice != null) {
            if (DataRepository.dataItemFeature().gh() && !DataRepository.dataItemFeature().gz()) {
                try {
        ...
        if (checkCaptureSession("resumePreview")) {
            ...
            synchronized (this.mSessionLock) {
                if (this.mCaptureSession != null) {
                    try {
                        if (this.mYuvPreviewImageReader != null) {
                            this.mPreviewRequestBuilder.addTarget(this.mYuvPreviewImageReader.getSurface());
                        }
    ...
    public void startHighSpeedRecordSession(@NonNull Surface surface, @NonNull Surface surface2, Range<Integer> range, CameraPreviewCallback cameraPreviewCallback) {
        if (checkCameraDevice("startHighSpeedRecordSession")) {
            ...
            try {
                ...
                if (((Integer) this.mHighSpeedFpsRange.getUpper()).intValue() != 120 || DataRepository.dataItemFeature().fX()) {
    ...
    public void startHighSpeedRecording() {
        if (checkCaptureSession("startHighSpeedRecording")) {
            ...
            if (DataRepository.dataItemFeature().gr()) {
