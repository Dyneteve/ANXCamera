...
public class MiCamera2 extends Camera2Proxy {
    ...
    private static final int MAX_IMAGE_BUFFER_SIZE = (b.iI() ? 12 : 10);
    ...
    /* access modifiers changed from: private */
    public ConcurrentLinkedQueue<MiCamera2Shot> mMiCamera2ShotQueue = new ConcurrentLinkedQueue<>();
    private ImageReader mMimojiPreviewImageReader;
    ...
    /* access modifiers changed from: private */
    public boolean mSetRepeatingEarly = DataRepository.dataItemFeature().gk();
    /* access modifiers changed from: private */
    ...
    private class PictureCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCapabilityChanged(CameraCapabilities cameraCapabilities) {
            ...
            boolean z = DataRepository.dataItemFeature().go() && !this.mFocusAreaSupported && cameraCapabilities.isAERegionSupported() && cameraCapabilities.isAELockSupported();
    ...
    private void abortCaptures() {
        if (DataRepository.dataItemFeature().gx()) {
    ...
    private void applyCommonSettings(Builder builder, int i) {
        ...
        if (ModuleManager.isWideSelfieModule()) {
        ...
        } else if (ModuleManager.isPortraitModule() || ModuleManager.isCapture()) {
            CaptureRequestBuilder.applyBeautyValues(builder, this.mCapabilities, this.mConfigs);
        ...
        if (ModuleManager.isPanoramaModule() || ModuleManager.isWideSelfieModule() || ModuleManager.isPortraitModule() || ModuleManager.isCapture()) {
    ...
    public void captureStillPicture() {
        if (checkCaptureSession(CameraStat.CATEGORY_CAMERA)) {
            ...
            if (CameraSettings.isCameraQuickShotEnable() || CameraSettings.isCameraQuickShotAnimateEnable() || (DataRepository.dataItemFeature().gt() && CameraSettings.isFrontCamera())) {
    ...
    private long getCaptureInterval() {
        long gv = DataRepository.dataItemFeature().gv() - (System.currentTimeMillis() - this.mCaptureTime);
    ...
    private Builder initFocusRequestBuilder(int i) throws CameraAccessException {
        ...
        if (i == 160) {
            ...
            if (ModuleManager.isFunARModule()) {
                builder.addTarget(this.mMimojiPreviewImageReader.getSurface());
            }
            return builder;
        }
    }
    ...
    public static /* synthetic */ void lambda$setCaptureEnable$0(MiCamera2 miCamera2, boolean z) {
        boolean z2 = false;
        boolean z3 = miCamera2.mMiCamera2ShotQueue.size() < DataRepository.dataItemFeature().gw();
    ...
    private boolean needOptimizedFlash() {
        return this.mConfigs.isNeedFlash() && (this.mConfigs.getFlashMode() == 1 || this.mConfigs.getFlashMode() == 3 || getExposureTime() > 0);
    }
    ...
    private void prepareMimojiPreviewImageReader(@NonNull CameraSize cameraSize, int i, int i2, Handler handler) {
        if (this.mMimojiPreviewImageReader != null) {
            this.mMimojiPreviewImageReader.close();
        }
        this.mMimojiPreviewImageReader = ImageReader.newInstance(cameraSize.getWidth(), cameraSize.getHeight(), i, i2);
        ImageReader imageReader = this.mMimojiPreviewImageReader;
        AnonymousClass4 r3 = new OnImageAvailableListener() {
            public void onImageAvailable(ImageReader imageReader) {
                Log.d(MiCamera2.TAG, "MimojiPreviewImageReader onImageAvailable");
                Image acquireNextImage = imageReader.acquireNextImage();
                if (acquireNextImage != null) {
                    ...
                    if (mimojiAvatarEngine != null) {
                        mimojiAvatarEngine.onPreviewFrame(acquireNextImage);
                    }
                    acquireNextImage.close();
                }
            }
        ...
        imageReader.setOnImageAvailableListener(r3, handler);
    }
    ...
    private void preparePortraitRawImageReader(CameraSize cameraSize) {
        ...
        AnonymousClass8 r0 = new OnImageAvailableListener() {
            public void onImageAvailable(ImageReader imageReader) {
                Image acquireNextImage = imageReader.acquireNextImage();
                if (acquireNextImage != null) {
                    if (MiCamera2.this.mMiCamera2Shot == null) {
    ...
    private void preparePreviewImageReader() {
        preparePreviewImageReader(this.mConfigs.getAlgorithmPreviewSize(), this.mConfigs.getAlgorithmPreviewFormat(), this.mConfigs.getPreviewMaxImages(), null);
    }
    ...
    private void preparePreviewImageReader(@NonNull CameraSize cameraSize, int i, int i2, Handler handler) {
        ...
        AnonymousClass3 r3 = new OnImageAvailableListener() {
            public void onImageAvailable(ImageReader imageReader) {
                Image acquireNextImage = imageReader.acquireNextImage();
                if (acquireNextImage != null) {
    ...
    public void triggerDeviceChecking(boolean z) {
        if (b.rN && DataRepository.dataItemFeature().gi() && this.mHelperHandler != null) {
    ...
    public void triggerPrecapture() {
        ...
        } else if (DataRepository.dataItemFeature().gH()) {
    ...
    public void captureBurstPictures(int i, @NonNull PictureCallback pictureCallback, @NonNull ParallelCallback parallelCallback) {
        ...
        if (this.mConfigs.getShotType() == 9) {
            ...
            this.mMiCamera2ShotQueue.offer(this.mMiCamera2Shot);
            this.mCaptureTime = System.currentTimeMillis();
            this.mMiCamera2Shot.startShot();
            return;
        }
    ...
    public void close() {
        ...
        abortCaptures();
        if (this.mCameraDevice != null) {
            if (DataRepository.dataItemFeature().gf() && !DataRepository.dataItemFeature().gx()) {
                try {
            ...
            if (currentTimeMillis > FunctionParseBeautyBodySlimCount.TIP_INTERVAL_TIME) {
                ...
                if (!(this.mCaptureCallback == null || this.mCaptureCallback.getPreviewCaptureResult() == null)) {
                    ...
                    if (num == null || num.intValue() >= 800) {
                        ...
                        Byte b = (Byte) this.mCaptureCallback.getPreviewCaptureResult().get(MiCaptureResult.SENSOR_HDR_ENABLE);
                        if (b.byteValue() > 0) {
                            String str2 = TAG;
                            StringBuilder sb3 = new StringBuilder();
    ...
    public boolean isFrontBeautyOn() {
        if (this.mCameraId == 1) {
            ...
            if (beautyValues == null) {
                ...
                return false;
            } else if (beautyValues.isFaceBeautyOn()) {
                return true;
            }
        }
        return false;
        ...
        if (checkCaptureSession("resumePreview")) {
            ...
            synchronized (this.mSessionLock) {
                if (this.mCaptureSession != null) {
                    try {
                        if (ModuleManager.isFunARModule()) {
                            this.mPreviewRequestBuilder.addTarget(this.mMimojiPreviewImageReader.getSurface());
                        }
    ...
    public void setCaptureEnable(boolean z) {
        ...
        if (this.mFrontQuickCaptureCallback != null) {
            this.mCameraHandler.postDelayed(new Runnable(z) {
                ...
                public final void run() {
                    MiCamera2.lambda$setCaptureEnable$0(MiCamera2.this, this.f$1);
                }
            }, getCaptureInterval());
        }
    }
    ...
    public void setHFRDeflickerEnable(boolean z) {
        if (this.mConfigs.setHFRDeflickerEnable(z)) {
            CaptureRequestBuilder.applyHFRDeflicker(this.mPreviewRequestBuilder, this.mCapabilities, this.mConfigs);
        }
    }
    ...
    public void setMacroMode(boolean z) {
        boolean macroMode = this.mConfigs.setMacroMode(z);
        String str = TAG;
        StringBuilder sb = new StringBuilder();
        sb.append("SET_MACRO_MODE:");
        sb.append(z);
        Log.v(str, sb.toString());
        if (macroMode) {
            CaptureRequestBuilder.applyMacroMode(this.mPreviewRequestBuilder, this.mConfigs);
        }
    }
    ...
    public void setOpticalZoomToTele(boolean z) {
        if (DataRepository.dataItemFeature().fz() && this.mCapabilities.isSupportFastZoomIn()) {
            String str = TAG;
            StringBuilder sb = new StringBuilder();
    ...
    public void startHighSpeedRecordSession(@NonNull Surface surface, @NonNull Surface surface2, Range<Integer> range, CameraPreviewCallback cameraPreviewCallback) {
        if (checkCameraDevice("startHighSpeedRecordSession")) {
            ...
            try {
                ...
                if (((Integer) this.mHighSpeedFpsRange.getUpper()).intValue() != 120 || DataRepository.dataItemFeature().fW()) {
            ...
            synchronized (this.mSessionLock) {
                ...
                if (!z5) {
                    ...
                    if (isLocalParallelServiceReady()) {
                        ...
                        for (Surface outputConfiguration2 : this.mParallelCaptureSurfaceList) {
                            OutputConfiguration outputConfiguration3 = new OutputConfiguration(outputConfiguration2);
                            outputConfiguration3.enableSurfaceSharing();
                            this.mDeferOutputConfigurations.add(outputConfiguration3);
                        }
                    }
                }
                ...
                this.mCaptureSession = null;
                if (z4) {
                    preparePreviewImageReader(this.mConfigs.getAlgorithmPreviewSize(), this.mConfigs.getAlgorithmPreviewFormat(), this.mConfigs.getPreviewMaxImages(), handler2);
                ...
                if (ModuleManager.isFunARModule()) {
                    prepareMimojiPreviewImageReader(this.mConfigs.getPreviewSize(), 35, 3, handler2);
                    arrayList.add(this.mMimojiPreviewImageReader.getSurface());
                }
                ...
                if (this.mPreviewSurface == null) {
                    ...
                    String str = TAG;
                    StringBuilder sb = new StringBuilder();
                    sb.append("startPreviewSession: add preview surface to HAL: ");
                    sb.append(this.mPreviewSurface);
                    sb.append("->");
                    sb.append(SurfaceUtils.getSurfaceSize(this.mPreviewSurface));
                    Log.d(str, sb.toString());
                ...
                for (OutputConfiguration outputConfiguration4 : this.mDeferOutputConfigurations) {
                    String str2 = TAG;
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("add surface from deferOutputConfig: ");
                    sb2.append(outputConfiguration4.getSurface());
                    Log.d(str2, sb2.toString());
                ...
                while (it.hasNext()) {
                    ...
                    String str3 = TAG;
                    StringBuilder sb3 = new StringBuilder();
                    sb3.append("startPreviewSession: add surface to HAL: ");
                    sb3.append(surface3);
                    sb3.append("->");
                    sb3.append(SurfaceUtils.getSurfaceSize(surface3));
                    Log.d(str3, sb3.toString());
