...
public class SimplePlayer implements b {
    ...
    public int prepare(String str, String str2) {
        ...
        return (nativePrepare != 0 || this.mAudioPlayer == null || this.mAudioPlayer.a((b) this)) ? nativePrepare : Error.SYN_INIT_FAILED;
    }

    public void release() {
        if (this.mAudioPlayer != null) {
            this.mAudioPlayer.iM();
        }
