    ...
    public void detectGPUSurpportAdvancedEffect() {
        new Thread() {
            public void run() {
                ...
                String str2 = GPUModelDetector.TAG;
                StringBuilder sb2 = new StringBuilder();
                sb2.append("isSurpportAdvancedEffect:");
                sb2.append(GPUModelDetector.this.isSurpportAdvancedEffect);
    ...
    public void detectGPUSurpportHighResolutionRecord() {
        new Thread() {
            public void run() {
                ...
                String str2 = GPUModelDetector.TAG;
                StringBuilder sb2 = new StringBuilder();
                sb2.append("isSurpportHighResolutionSupport:");
                sb2.append(GPUModelDetector.this.isSurpportHighResolutionRecord);
                Log.i(str2, sb2.toString());
            }
        }.start();
    }
