...
public class VERuntime {
    ...
    public int needUpdateEffectModelFiles() {
        return (this.mEnv != null && !TextUtils.isEmpty(this.mEnv.getWorkspace())) ? EffectSDKUtils.needUpdate(this.mContext, this.mEnv.getDetectModelsDir()) ? 0 : -1 : VEResult.TER_INVALID_ENV;
    }
    ...
    public void updateEffectModelFiles(File file) {
        this.mEnv.setDetectModelsDir(file.getAbsolutePath());
    }
}
