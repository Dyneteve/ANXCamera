...
public class RecordV1 implements IRecorder {
    ...
    public TTRecorder mRecorder;
    /* access modifiers changed from: private */
    public VERecorderStateListener mRecorderStateCallback;
    /* access modifiers changed from: private */
        ...
        this.mRecorder.setGLCallback(new GLCallback() {
            ...
            public boolean onDestroy() {
                if (RecordV1.this.mRenderCallback != null) {
                    return RecordV1.this.mRenderCallback.onDestroy();
                }
                return true;
            }
    ...
    public int startRecord(String str, String str2, float f) {
        return this.mRecorder.startRecord((double) f, !this.mVideoEncodeSettings.isHwEnc(), 1.0f, 1, this.mVideoEncodeSettings.getEncodeProfile());
    }
    ...
    public int updatePreviewSettings(VEPreviewSettings vEPreviewSettings) {
        this.mPreviewSettings = vEPreviewSettings;
        this.mRecorder.updateCameraInfo(this.mPreviewSettings.getRotation(), this.mPreviewSettings.getFacingID() == CAMERA_FACING_ID.FACING_FRONT);
        return 0;
    }
