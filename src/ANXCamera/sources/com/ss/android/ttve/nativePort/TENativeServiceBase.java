...
public class TENativeServiceBase {
    ...
    public synchronized void setErrorListener(TECommonCallback tECommonCallback) {
        this.mOnErrorListener = tECommonCallback;
    }

    public synchronized void setInfoListener(TECommonCallback tECommonCallback) {
        this.mOnInfoListener = tECommonCallback;
    }

    public synchronized void setOpenGLListeners(IOpenGLCallback iOpenGLCallback) {
