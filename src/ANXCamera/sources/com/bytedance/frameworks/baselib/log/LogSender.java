        ...
        if (log != null) {
            ...
            if (log.value == null || log.value.length <= 0) {
                ...
                if (responseConfig != null) {
                    if (responseConfig.getRemoveSwitch()) {
                        ...
                        try {
                            if (!TextUtils.isEmpty(lastSuccessChannel)) {
                                z7 = sendLog(logHandler, lastSuccessChannel, log.value);
                                z6 = true;
                            } else {
                                z7 = false;
                                z6 = false;
                                ...
                                try {
                                    ...
                                    while (true) {
                                        try {
                                            ...
                                            if (!responseConfig.getMoreChannelSwitch() && z6) {
                                                break;
                                            } else if (isStop()) {
                                                return true;
                                            } else {
                    ...
                    try {
                        boolean sendLog2 = !TextUtils.isEmpty(lastSuccessChannel2) ? sendLog(logHandler, lastSuccessChannel2, log.value) : false;
                        if (!sendLog2) {
                            try {
                                ...
                                while (true) {
                                    ...
                                    if (!TextUtils.isEmpty(str4)) {
                                        if (!str4.equals(lastSuccessChannel2)) {
                                            boolean sendLog3 = sendLog(logHandler, str4, log.value);
                                            if (sendLog3) {
                                                str = str4;
                                                z2 = sendLog3;
                                                break;
