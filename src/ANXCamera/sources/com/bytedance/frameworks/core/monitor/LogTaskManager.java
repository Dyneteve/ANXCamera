...
public class LogTaskManager {
    ...
    /* access modifiers changed from: private */
    public List<IInactiveMonitor> sAllInactiveMonitor = new ArrayList();
    ...
    public void handleCount(String str, String str2, String str3, float f, boolean z) {
        Message obtain = Message.obtain();
        obtain.what = 3;
        InitialLogInfo initialLogInfo = new InitialLogInfo(str, str2, str3, f, z);
        obtain.obj = initialLogInfo;
        this.mHandler.sendMessage(obtain);
    }
    ...
    public void handleDirectTimer(String str, String str2, float f, boolean z) {
        Message obtain = Message.obtain();
        obtain.what = 6;
        InitialLogInfo initialLogInfo = new InitialLogInfo(str, "", str2, f, z);
        obtain.obj = initialLogInfo;
        this.mHandler.sendMessage(obtain);
    }
