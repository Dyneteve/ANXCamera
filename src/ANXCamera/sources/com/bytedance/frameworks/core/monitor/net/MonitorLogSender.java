...
public class MonitorLogSender {
    ...
    public static boolean send(String str, String str2, String str3) {
        ...
        ConcurrentHashMap<String, ILogSendImpl> concurrentHashMap = mapTypeLogSendImpl;
        StringBuilder sb = new StringBuilder();
        sb.append(str);
        sb.append(str2);
        ILogSendImpl iLogSendImpl = (ILogSendImpl) concurrentHashMap.get(sb.toString());
    ...
    public static void setImpl(String str, String str2, ILogSendImpl iLogSendImpl) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && iLogSendImpl != null) {
            ...
            sb.append(str);
            sb.append(str2);
            concurrentHashMap.put(sb.toString(), iLogSendImpl);
        }
    }
}
