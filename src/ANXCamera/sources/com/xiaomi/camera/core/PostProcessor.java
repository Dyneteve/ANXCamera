            ...
            if (parallelTaskData != null) {
                if (PostProcessor.this.mCurrentAlgoType != 4) {
                    if (Util.isDumpImageEnabled()) {
                        ...
                        ImageUtil.dumpYuvImage(image, sb4.toString());
                    }
                    ...
                    Log.d(access$0002, String.format(Locale.ENGLISH, "[2] onImageProcessed: pictureSize: %s, imageSize: %s", new Object[]{pictureSize, sb5.toString()}));
                ...
                sb6.append("[2] onImageProcessed: captureResult = ");
                sb6.append(captureResult.getResults());
                Log.d(access$0003, sb6.toString());
                String access$0004 = PostProcessor.TAG;
                StringBuilder sb7 = new StringBuilder();
                sb7.append("[2] onImageProcessed: send jpeg Encoder image target is: ");
                sb7.append(sb2);
                Log.d(access$0004, sb7.toString());
                ...
                sb8.append("no parallelTaskData with timestamp ");
