...
public class g {
    ...
    private g(Context context) {
        this.X = context;
        this.Z = this.X.getContentResolver();
    }
    ...
    private b b(Cursor cursor, boolean z) {
        ...
        if (z) {
            ...
            bVar.g = cursor.getString(e.b(this.ae, "_display_name"));
            bVar.h = cursor.getInt(e.b(this.ae, "width"));
            bVar.i = cursor.getInt(e.b(this.ae, "height"));
            bVar.j = cursor.getLong(e.b(this.ae, "_size"));
            bVar.k = cursor.getString(e.b(this.ae, "mime_type"));
            bVar.l = cursor.getString(e.b(this.ae, "datetaken"));
            bVar.m = cursor.getString(e.b(this.ae, "date_modified"));
    ...
    public Bitmap a(String str, Options options) {
        ...
        return j2.a ? Thumbnails.getThumbnail(this.Z, j2.c, 3, options) : Images.Thumbnails.getThumbnail(this.Z, j2.c, 3, options);
    }
    ...
    public Uri a(String str, int i2, int i3, Location location, int i4) {
        ...
        Uri insert = this.Z.insert(Media.EXTERNAL_CONTENT_URI, contentValues);
        String str2 = "android.hardware.action.NEW_PICTURE";
        if (VERSION.SDK_INT >= 14) {
            this.X.sendBroadcast(new Intent(str2, insert));
        }
        return insert;
    }
    ...
    public boolean b(String str) {
        b j2 = j(str);
        return j2 != null && this.Z.delete(j2.b, null, null) > 0;
    }
    ...
    public boolean j(String str, String str2) {
        ...
        return this.Z.update(j2.b, contentValues, null, null) > 0;
    }
