...
public class g {
    ...
    public static Cursor a(ContentResolver contentResolver) {
        ...
        return contentResolver.query(b, bh, "(media_type=? or media_type=?) and bucket_id=? ", strArr, "_id DESC");
    }
    ...
    private b b(Cursor cursor, boolean z) {
        ...
        bVar.a = z;
        if (z) {
            bVar.c = cursor.getLong(e.b((T[]) this.bf, "_id"));
            bVar.b = ContentUris.withAppendedId(Video.Media.EXTERNAL_CONTENT_URI, bVar.c);
            bVar.d = (long) cursor.getInt(e.b((T[]) this.bf, "bucket_id"));
            bVar.e = cursor.getString(e.b((T[]) this.bf, "bucket_display_name"));
            bVar.f = cursor.getString(e.b((T[]) this.bf, "_data"));
            bVar.g = cursor.getString(e.b((T[]) this.bf, "_display_name"));
            bVar.h = cursor.getInt(e.b((T[]) this.bf, "width"));
            bVar.i = cursor.getInt(e.b((T[]) this.bf, "height"));
            bVar.j = cursor.getLong(e.b((T[]) this.bf, "_size"));
            bVar.k = cursor.getString(e.b((T[]) this.bf, "mime_type"));
            bVar.l = cursor.getString(e.b((T[]) this.bf, "datetaken"));
            bVar.m = cursor.getString(e.b((T[]) this.bf, "date_modified"));
            bVar.n = cursor.getString(e.b((T[]) this.bf, "date_added"));
            bVar.o = cursor.getDouble(e.b((T[]) this.bf, "latitude"));
            bVar.p = cursor.getDouble(e.b((T[]) this.bf, "longitude"));
            bVar.r = cursor.getLong(e.b((T[]) this.bf, "duration"));
            bVar.s = cursor.getString(e.b((T[]) this.bf, "resolution"));
        } else {
            bVar.c = cursor.getLong(e.b((T[]) this.bg, "_id"));
            bVar.b = ContentUris.withAppendedId(Media.EXTERNAL_CONTENT_URI, bVar.c);
            bVar.d = (long) cursor.getInt(e.b((T[]) this.bg, "bucket_id"));
            bVar.e = cursor.getString(e.b((T[]) this.bg, "bucket_display_name"));
            bVar.f = cursor.getString(e.b((T[]) this.bg, "_data"));
            bVar.g = cursor.getString(e.b((T[]) this.bg, "_display_name"));
            bVar.h = cursor.getInt(e.b((T[]) this.bg, "width"));
            bVar.i = cursor.getInt(e.b((T[]) this.bg, "height"));
            bVar.j = cursor.getLong(e.b((T[]) this.bg, "_size"));
            bVar.k = cursor.getString(e.b((T[]) this.bg, "mime_type"));
            bVar.l = cursor.getString(e.b((T[]) this.bg, "datetaken"));
            bVar.m = cursor.getString(e.b((T[]) this.bg, "date_modified"));
            bVar.n = cursor.getString(e.b((T[]) this.bg, "date_added"));
            bVar.o = cursor.getDouble(e.b((T[]) this.bg, "latitude"));
            bVar.p = cursor.getDouble(e.b((T[]) this.bg, "longitude"));
            bVar.q = cursor.getInt(e.b((T[]) this.bg, "orientation"));
        }
        return bVar;
    }
    ...
    public Bitmap a(String str, Options options) {
        ...
        return j2.a ? Thumbnails.getThumbnail(this.ba, j2.c, 3, options) : Images.Thumbnails.getThumbnail(this.ba, j2.c, 3, options);
    }
    ...
    public Uri a(String str, int i2, int i3, Location location, int i4) {
        ...
        Uri insert = this.ba.insert(Media.EXTERNAL_CONTENT_URI, contentValues);
        String str2 = "android.hardware.action.NEW_PICTURE";
        if (VERSION.SDK_INT >= 14) {
            this.aZ.sendBroadcast(new Intent(str2, insert));
        }
        return insert;
    }
    ...
    public List<b> a(String str, boolean z) {
        ...
        if (z) {
            String[] strArr = {str};
            cursor = this.ba.query(Video.Media.EXTERNAL_CONTENT_URI, this.bf, "bucket_display_name=?", strArr, "_id ASC");
        } else {
            String[] strArr2 = {str};
            cursor = this.ba.query(Media.EXTERNAL_CONTENT_URI, this.bg, "bucket_display_name=?", strArr2, "_id ASC");
        }
    ...
    public boolean b(String str) {
        b j2 = j(str);
        return j2 != null && this.ba.delete(j2.b, null, null) > 0;
    }
    ...
    public b j(String str) {
        ...
        if (isVideoFile) {
            String[] strArr = {str};
            cursor = this.ba.query(Video.Media.EXTERNAL_CONTENT_URI, this.bf, "_data=?", strArr, "_id DESC");
        } else {
            String[] strArr2 = {str};
            cursor = this.ba.query(Media.EXTERNAL_CONTENT_URI, this.bg, "_data=?", strArr2, "_id DESC");
        }
        if (cursor != null && cursor.getCount() > 0) {
            cursor.moveToFirst();
    ...
    public boolean j(String str, String str2) {
        ...
        return this.ba.update(j2.b, contentValues, null, null) > 0;
    }
