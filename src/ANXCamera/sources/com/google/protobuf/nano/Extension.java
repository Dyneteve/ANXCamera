        ...
        private int computePackedDataSize(Object obj) {
            ...
            switch (i6) {
                ...
                case 3:
                    int i8 = 0;
                    while (i < length) {
                        i8 += CodedOutputByteBufferNano.computeInt64SizeNoTag(Array.getLong(obj, i));
                        i++;
                    }
                    return i8;
                case 4:
                    int i9 = 0;
                    while (i2 < length) {
                        i9 += CodedOutputByteBufferNano.computeUInt64SizeNoTag(Array.getLong(obj, i2));
                        i2++;
                    }
                    return i9;
                case 5:
                    int i10 = 0;
                    while (i3 < length) {
                        i10 += CodedOutputByteBufferNano.computeInt32SizeNoTag(Array.getInt(obj, i3));
                        i3++;
                    }
                    return i10;
                case 8:
                ...
                default:
                    switch (i6) {
                        case 13:
                            int i11 = 0;
                            while (i4 < length) {
                                i11 += CodedOutputByteBufferNano.computeUInt32SizeNoTag(Array.getInt(obj, i4));
                                i4++;
                            }
                            return i11;
                        case 14:
                            int i12 = 0;
                            while (i5 < length) {
                                i12 += CodedOutputByteBufferNano.computeEnumSizeNoTag(Array.getInt(obj, i5));
                                i5++;
                            }
                            return i12;
                        case 15:
                        ...
                        case 17:
                            int i13 = 0;
                            while (i7 < length) {
                                i13 += CodedOutputByteBufferNano.computeSInt32SizeNoTag(Array.getInt(obj, i7));
                                i7++;
                            }
                            return i13;
                        case 18:
                            int i14 = 0;
                            while (i7 < length) {
                                i14 += CodedOutputByteBufferNano.computeSInt64SizeNoTag(Array.getLong(obj, i7));
                                i7++;
                            }
                            return i14;
                        default:
