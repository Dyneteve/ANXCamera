...
final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    public static TypeAdapterFactory newFactory(TypeToken<?> exactType, Object typeAdapter) {
        SingleTypeFactory singleTypeFactory = new SingleTypeFactory(typeAdapter, exactType, false, null);
        return singleTypeFactory;
    }

    public static TypeAdapterFactory newFactoryWithMatchRawType(TypeToken<?> exactType, Object typeAdapter) {
        SingleTypeFactory singleTypeFactory = new SingleTypeFactory(typeAdapter, exactType, exactType.getType() == exactType.getRawType(), null);
        return singleTypeFactory;
    }

    public static TypeAdapterFactory newTypeHierarchyFactory(Class<?> hierarchyType, Object typeAdapter) {
        SingleTypeFactory singleTypeFactory = new SingleTypeFactory(typeAdapter, null, false, hierarchyType);
        return singleTypeFactory;
    }
}
