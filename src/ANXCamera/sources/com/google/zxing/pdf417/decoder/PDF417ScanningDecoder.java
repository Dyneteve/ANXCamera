...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        DetectionResultRowIndicatorColumn detectionResultRowIndicatorColumn4 = detectionResultRowIndicatorColumn2;
        DetectionResult detectionResult2 = detectionResult;
        boolean z = true;
        int barcodeColumnCount = detectionResult2.getBarcodeColumnCount() + 1;
        boolean z2 = false;
        detectionResult2.setDetectionResultColumn(0, detectionResultRowIndicatorColumn3);
        detectionResult2.setDetectionResultColumn(barcodeColumnCount, detectionResultRowIndicatorColumn4);
        boolean z3 = detectionResultRowIndicatorColumn3 != null;
        int i5 = 1;
        int i6 = i;
        int i7 = i2;
