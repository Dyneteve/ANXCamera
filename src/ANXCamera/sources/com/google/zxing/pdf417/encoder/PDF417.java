...
public final class PDF417 {
    ...
    private static int calculateNumberOfRows(int i, int i2, int i3) {
        int i4 = (((i + 1) + i2) / i3) + 1;
        return i3 * i4 >= ((i + 1) + i2) + i3 ? i4 - 1 : i4;
    }
    ...
    private int[] determineDimensions(int i, int i2) throws WriterException {
        ...
        for (int i3 = this.minCols; i3 <= this.maxCols; i3++) {
            ...
            if (calculateNumberOfRows <= this.maxRows) {
                float f2 = (((float) ((17 * i3) + 69)) * DEFAULT_MODULE_WIDTH) / (((float) calculateNumberOfRows) * 2.0f);
    ...
    private void encodeLowLevel(CharSequence charSequence, int i, int i2, int i3, BarcodeMatrix barcodeMatrix2) {
        ...
        for (int i9 = 0; i9 < i7; i9++) {
            ...
            if (i10 == 0) {
                ...
                i4 = ((i9 / 3) * 30) + (i3 * 3) + ((i7 - 1) % 3);
                i5 = (30 * (i9 / 3)) + ((i7 - 1) / 3);
            } else {
                i4 = ((i9 / 3) * 30) + (i6 - 1);
                i5 = (30 * (i9 / 3)) + (i3 * 3) + ((i7 - 1) % 3);
            }
            encodeChar(CODEWORD_TABLE[i10][i4], 17, barcodeMatrix2.getCurrentRow());
            for (int i11 = 0; i11 < i6; i11++) {
                encodeChar(CODEWORD_TABLE[i10][charSequence.charAt(i8)], 17, barcodeMatrix2.getCurrentRow());
                i8++;
            }
            if (this.compact) {
                encodeChar(STOP_PATTERN, 1, barcodeMatrix2.getCurrentRow());
            } else {
                encodeChar(CODEWORD_TABLE[i10][i5], 17, barcodeMatrix2.getCurrentRow());
    ...
    public void generateBarcodeLogic(String str, int i) throws WriterException {
        ...
        int[] determineDimensions = pdf417.determineDimensions(length, errorCorrectionCodewordCount);
        ...
        if (length + errorCorrectionCodewordCount + 1 <= 929) {
            ...
            pdf417.barcodeMatrix = new BarcodeMatrix(i3, i2);
            BarcodeMatrix barcodeMatrix2 = pdf417.barcodeMatrix;
            String str2 = generateErrorCorrection;
            String str3 = sb2;
            StringBuilder sb5 = sb;
            pdf417.encodeLowLevel(sb4, i2, i3, i, barcodeMatrix2);
            return;
        }
        StringBuilder sb6 = new StringBuilder("Encoded message contains to many code words, message to big (");
