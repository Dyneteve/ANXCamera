                ...
                switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(information2, 1, 5)) {
                    ...
                    default:
                        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(information2, 1, 7)) {
                            case 56:
                                return new AI013x0x1xDecoder(information2, "310", ComponentRunningShine.SHINE_LIVE_BEAUTY);
                            case 57:
                                return new AI013x0x1xDecoder(information2, "320", ComponentRunningShine.SHINE_LIVE_BEAUTY);
                            case 58:
