...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            add(new int[]{540, NotifyMessage.MSG_MEDIA_RECORDER_ERROR_ENCODER_AUDIO_RELEASE}, "BE/LU");
            add(new int[]{560}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{MediaPlayer2.MEDIA_INFO_BAD_INTERLEAVING, 839}, "IT");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{MediaPlayer2.MEDIA_INFO_TIMED_TEXT_ERROR, 919}, "AT");
