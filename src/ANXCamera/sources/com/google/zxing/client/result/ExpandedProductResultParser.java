    ...
    public ExpandedProductParsedResult parse(Result result) {
        ...
        while (i < rawText.length()) {
            ...
            if (ai == "00") {
                ...
                lotNumber = value;
            } else if (ai == ComponentRunningShine.SHINE_LIVE_BEAUTY) {
        ...
        int i4 = i;
        ExpandedProductParsedResult expandedProductParsedResult = new ExpandedProductParsedResult(rawText, productID, sscc, lotNumber, productionDate, packagingDate, bestBeforeDate, expirationDate, weight, weightType, weightIncrement, price, priceIncrement, priceCurrency, hashMap);
