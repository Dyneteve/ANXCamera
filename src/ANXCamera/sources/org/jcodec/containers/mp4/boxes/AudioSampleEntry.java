...
public class AudioSampleEntry extends SampleEntry {
    ...
    public static void _setLabels(TrakBox trakBox, Label[] labelArr) {
        ChannelBox channelBox = (ChannelBox) findFirstPath(trakBox, ChannelBox.class, new String[]{"mdia", "minf", "stbl", "stsd", null, "chan"});
        if (channelBox == null) {
            channelBox = ChannelBox.createChannelBox();
            ((SampleEntry) findFirstPath(trakBox, SampleEntry.class, new String[]{"mdia", "minf", "stbl", "stsd", null})).add(channelBox);
        }
    ...
    public static Label[] getLabelsFromSampleEntry(AudioSampleEntry audioSampleEntry) {
        ChannelBox channelBox = (ChannelBox) findFirst(audioSampleEntry, ChannelBox.class, "chan");
        if (channelBox != null) {
    ...
    public ByteOrder getEndian() {
        EndianBox endianBox = (EndianBox) findFirstPath(this, EndianBox.class, new String[]{WaveExtension.fourcc(), EndianBox.fourcc()});
        if (endianBox != null) {
    ...
    public ChannelLabel[] getLabels() {
        ChannelBox channelBox = (ChannelBox) findFirst(this, ChannelBox.class, "chan");
        if (channelBox != null) {
