...
public class TrakBox extends NodeBox {
    ...
    public void fixMediaTimescale(int i) {
        MediaHeaderBox mediaHeaderBox = (MediaHeaderBox) NodeBox.findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd"));
        ...
        TimeToSampleEntry[] entries = ((TimeToSampleBox) NodeBox.findFirstPath(this, TimeToSampleBox.class, path("mdia.minf.stbl.stts"))).getEntries();
    ...
    public ChunkOffsets64Box getCo64() {
        return (ChunkOffsets64Box) NodeBox.findFirstPath(this, ChunkOffsets64Box.class, path("mdia.minf.stbl.co64"));
    }

    public CompositionOffsetsBox getCtts() {
        return (CompositionOffsetsBox) NodeBox.findFirstPath(this, CompositionOffsetsBox.class, path("mdia.minf.stbl.ctts"));
    }
    ...
    public List<Edit> getEdits() {
        EditListBox editListBox = (EditListBox) NodeBox.findFirstPath(this, EditListBox.class, path("edts.elst"));
        if (editListBox == null) {
            return null;
        }
    ...
    public int getFrameCount() {
        SampleSizesBox sampleSizesBox = (SampleSizesBox) NodeBox.findFirstPath(this, SampleSizesBox.class, path("mdia.minf.stbl.stsz"));
        return sampleSizesBox.getDefaultSize() != 0 ? sampleSizesBox.getCount() : sampleSizesBox.getSizes().length;
    }

    public String getHandlerType() {
        HandlerBox handlerBox = (HandlerBox) NodeBox.findFirstPath(this, HandlerBox.class, path("mdia.hdlr"));
        if (handlerBox == null) {
            return null;
        }
    ...
    public long getMediaDuration() {
        return ((MediaHeaderBox) NodeBox.findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd"))).getDuration();
    }

    public String getName() {
        NameBox nameBox = (NameBox) NodeBox.findFirstPath(this, NameBox.class, path("udta.name"));
        if (nameBox == null) {
            return null;
        }
    ...
    public ChunkOffsetsBox getStco() {
        return (ChunkOffsetsBox) NodeBox.findFirstPath(this, ChunkOffsetsBox.class, path("mdia.minf.stbl.stco"));
    }

    public SampleToChunkBox getStsc() {
        return (SampleToChunkBox) NodeBox.findFirstPath(this, SampleToChunkBox.class, path("mdia.minf.stbl.stsc"));
    }

    public SampleDescriptionBox getStsd() {
        return (SampleDescriptionBox) NodeBox.findFirstPath(this, SampleDescriptionBox.class, path("mdia.minf.stbl.stsd"));
    }

    public SyncSamplesBox getStss() {
        return (SyncSamplesBox) NodeBox.findFirstPath(this, SyncSamplesBox.class, path("mdia.minf.stbl.stss"));
    }

    public SampleSizesBox getStsz() {
        return (SampleSizesBox) NodeBox.findFirstPath(this, SampleSizesBox.class, path("mdia.minf.stbl.stsz"));
    }

    public TimeToSampleBox getStts() {
        return (TimeToSampleBox) NodeBox.findFirstPath(this, TimeToSampleBox.class, path("mdia.minf.stbl.stts"));
    }

    public int getTimescale() {
        return ((MediaHeaderBox) NodeBox.findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd"))).getTimescale();
    }
    ...
    public void setTimescale(int i) {
        ((MediaHeaderBox) NodeBox.findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd"))).setTimescale(i);
    }
}
