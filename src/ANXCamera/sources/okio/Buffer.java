...
public final class Buffer implements Cloneable, BufferedSink, BufferedSource {
            ...
            if (byteString.size() == 2) {
                ...
                while (j2 < this.size) {
                    ...
                    for (int i2 = (int) ((((long) segment2.pos) + j) - j2); i2 < i; i2++) {
                        byte b3 = bArr[i2];
                        if (b3 == b || b3 == b2) {
                            return ((long) (i2 - segment2.pos)) + j2;
                        }
                    }
                    j = ((long) (segment2.limit - segment2.pos)) + j2;
                    segment2 = segment2.next;
                    j2 = j;
                }
            } else {
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 4) {
                return ((readByte() & -1) << 24) | ((readByte() & -1) << 16) | ((readByte() & -1) << 8) | (readByte() & -1);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
    ...
    public short readShort() {
        if (this.size >= 2) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 2) {
                return (short) (((readByte() & -1) << 8) | (readByte() & -1));
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (this.size != 0) {
            ...
            if (this.size >= j) {
                ...
                skip(j);
                return b2 > -1 ? REPLACEMENT_CHARACTER : ((b2 < 0 || b2 > -1) && b2 >= b) ? b2 : REPLACEMENT_CHARACTER;
            }
            StringBuilder sb = new StringBuilder();
            sb.append("size < ");
            sb.append(i);
