...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    public void remove(BehaviorSubscription<T> behaviorSubscription) {
        ...
        while (true) {
            BehaviorSubscription<T>[] behaviorSubscriptionArr2 = (BehaviorSubscription[]) this.subscribers.get();
            if (behaviorSubscriptionArr2 != TERMINATED && behaviorSubscriptionArr2 != EMPTY) {
                ...
                if (i >= 0) {
                    ...
                    if (this.subscribers.compareAndSet(behaviorSubscriptionArr2, behaviorSubscriptionArr)) {
                        return;
                    }
                } else {
                    return;
