...
public final class AsyncProcessor<T> extends FlowableProcessor<T> {
    ...
    public void remove(AsyncSubscription<T> asyncSubscription) {
        ...
        while (true) {
            AsyncSubscription<T>[] asyncSubscriptionArr2 = (AsyncSubscription[]) this.subscribers.get();
            ...
            if (length != 0) {
                ...
                if (i >= 0) {
                    ...
                    if (this.subscribers.compareAndSet(asyncSubscriptionArr2, asyncSubscriptionArr)) {
                        return;
                    }
                } else {
                    return;
