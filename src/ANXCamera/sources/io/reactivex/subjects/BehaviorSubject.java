...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public void remove(BehaviorDisposable<T> behaviorDisposable) {
        ...
        while (true) {
            BehaviorDisposable<T>[] behaviorDisposableArr2 = (BehaviorDisposable[]) this.subscribers.get();
            if (behaviorDisposableArr2 != TERMINATED && behaviorDisposableArr2 != EMPTY) {
                ...
                if (i >= 0) {
                    ...
                    if (this.subscribers.compareAndSet(behaviorDisposableArr2, behaviorDisposableArr)) {
                        return;
                    }
                } else {
                    return;
