...
public final class CompletableCache extends Completable implements CompletableObserver {
    ...
    public void remove(InnerCompletableCache innerCompletableCache) {
        InnerCompletableCache[] innerCompletableCacheArr;
        while (true) {
            InnerCompletableCache[] innerCompletableCacheArr2 = (InnerCompletableCache[]) this.observers.get();
            ...
            if (length != 0) {
                ...
                if (i >= 0) {
                    if (length == 1) {
                        innerCompletableCacheArr = EMPTY;
                    } else {
                    ...
                    if (this.observers.compareAndSet(innerCompletableCacheArr2, innerCompletableCacheArr)) {
                        return;
                    }
                } else {
                    return;
