...
public final class ObservableInternalHelper {
    ...
    static final class ObservableMapper<T, R> implements Function<T, Observable<R>> {
        ...
        public Observable<R> apply(T t) throws Exception {
            return RxJavaPlugins.onAssembly((Observable<T>) new SingleToObservable<T>((SingleSource) ObjectHelper.requireNonNull(this.mapper.apply(t), "The mapper returned a null SingleSource")));
        }
    }
