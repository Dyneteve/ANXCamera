...
public class FeatureParser {
  ...
  PHI: (r1v3 'inputStream' java.io.InputStream) = (r1v0 'inputStream' java.io.InputStream), (r1v0 'inputStream' java.io.InputStream), (r1v5 'inputStream' java.io.InputStream), (r1v0 'inputStream' java.io.InputStream), (r1v0 'inputStream' java.io.InputStream) binds: [B:1:0x0005, B:12:0x003d, B:29:0x00bb, B:17:0x005f, B:13:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:12:0x003d] */
  ...
  PHI: (r1v2 'inputStream' java.io.InputStream) = (r1v0 'inputStream' java.io.InputStream), (r1v0 'inputStream' java.io.InputStream), (r1v5 'inputStream' java.io.InputStream), (r1v0 'inputStream' java.io.InputStream), (r1v0 'inputStream' java.io.InputStream) binds: [B:1:0x0005, B:12:0x003d, B:29:0x00bb, B:17:0x005f, B:13:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:1:0x0005] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void read() {
        ArrayList arrayList = null;
        boolean inputStream = null;
        String fileName = null;
        try {
            inputStream = "cancro".equals(Build.DEVICE);
            if (!inputStream) {
                                        ...
                                        if (!TAG_FLOAT.equals(tagName)) {
                                            if (TAG_ITEM.equals(tagName)) {
                                                if (arrayList2 == null) {
                                                    ...
                                                    arrayList2.add(Integer.valueOf(parser.nextText()));
                                                    break;
                                                }
                                            }
                                        } else {
                ...
                case 3:
                    ...
                    if (!TAG_INTEGER_ARRAY.equals(end_tag_name)) {
                        if (TAG_STRING_ARRAY.equals(end_tag_name)) {
                            sStrArrMap.put(keyName, arrayList);
                            arrayList = null;
                            break;
                        }
                    } else {
                        sIntArrMap.put(keyName, arrayList2);
                        arrayList2 = null;
                        break;
                    }
                    break;
