...
public class ReflectionUtils {
        ...
        synchronized (constructorCache) {
            ...
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (ClassUtils.isAssignable(parameterTypes, constructor4.getParameterTypes(), true) && (constructor3 == null || MemberUtils.compareParameterTypes(constructor4.getParameterTypes(), constructor3.getParameterTypes(), parameterTypes) < 0)) {
                ...
                if (constructor3 != null) {
                    ...
                    synchronized (constructorCache) {
                        constructorCache.put(fullConstructorName, constructor3);
                        return constructor3;
                    }
                }
    ...
    public static <T> T callStaticMethod(Class<?> clazz, String methodName, Class<T> returnValueClazz, Object... args) throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
            return checkMethodReturnValue(findMethodBestMatch(clazz, methodName, args).invoke(null, args), returnValueClazz);
        } catch (NullPointerException ex) {
            Log.w(TAG, "", ex);
            throw new IllegalArgumentException(ex);
        }
