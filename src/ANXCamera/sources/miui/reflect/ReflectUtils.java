...
public class ReflectUtils {
    private static final String Fd = "this$0";
    private static Class<?>[] Fe = {Boolean.TYPE, Byte.TYPE, Character.TYPE, Short.TYPE, Integer.TYPE, Long.TYPE, Float.TYPE, Double.TYPE, Void.TYPE};
    private static String[] Ff = {Field.BOOLEAN_SIGNATURE_PRIMITIVE, Field.BYTE_SIGNATURE_PRIMITIVE, Field.CHAR_SIGNATURE_PRIMITIVE, "S", Field.INT_SIGNATURE_PRIMITIVE, Field.LONG_SIGNATURE_PRIMITIVE, Field.FLOAT_SIGNATURE_PRIMITIVE, Field.DOUBLE_SIGNATURE_PRIMITIVE, "V"};
    private static final WeakHashMap<Object, HashMap<String, Object>> Fg = new WeakHashMap<>();
    ...
    public static Object getSurroundingThis(Object obj) {
        return Field.of(obj.getClass(), Fd, getSignature(obj.getClass())).get(obj);
    }
    ...
    public static Object getAdditionalField(Object obj, String str) {
        ...
        if (obj == null) {
            ...
            synchronized (Fg) {
                HashMap hashMap = (HashMap) Fg.get(obj);
                if (hashMap == null) {
                    return null;
                }
                synchronized (hashMap) {
