...
REM ..\ANXMiuiPortTools\hub.exe release create -a .\out\ANXCameraMagisk_%anxversion%.zip -m oosberyllium.%anxversion% %anxversioncode%.oosberyllium
..\ANXMiuiPortTools\hub.exe release create -a .\out\ANXCameraUnity_%anxversion%.zip -m oosberyllium.%anxversion% %anxversioncode%.oosberyllium
